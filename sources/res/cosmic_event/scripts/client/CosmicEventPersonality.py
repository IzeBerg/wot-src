...
from cosmic_account_settings import ACCOUNT_DEFAULT_SETTINGS
from cosmic_constants import COSMIC_BANNER_ENTRY_POINT, getPrebattleConditionIcon
from cosmic_event.gui import gui_constants
from cosmic_event.gui.battle_control.arena_info.arena_descrs import CosmicArenaDescription
...
from cosmic_event_common.cosmic_constants import ARENA_GUI_TYPE, ARENA_BONUS_TYPE
...
from gui.shared.system_factory import registerAwardControllerHandler, registerPrebattleConditionIconGetter
...
class ClientCosmicEventBattleMode(cosmic_constants.CosmicEventBattleMode):
    ...
    def _client_gameControllers(self):
        ...
        from cosmic_event.gui.game_control.announcer_controller import AnnouncerController
        from cosmic_event.skeletons.cosmic_fading_controller import ICosmicFadingController
        from cosmic_event.gui.game_control.cosmic_fading_controller import CosmicFadingController
        return [
         (
         ...
         (
          IAnnouncerController, AnnouncerController, False),
         (
          ICosmicFadingController, CosmicFadingController, False)]
    ...
    def _client_bannerEntryPointLUIRule(self):
        ...
        return LuiRules.COSMIC_ENTRY_POINT
    ...
    def _client_messengerClientFormatters(self):
        ...
        return {gui_constants.SCH_CLIENT_MSG_TYPE.COSMIC_DAILY: formatters.CosmicDailyMessageFormatter(), 
           ...
           gui_constants.SCH_CLIENT_MSG_TYPE.COSMIC_COMPLETED: formatters.CosmicCompletionMessageFormatter()}
    ...
    def _client_notificationActionHandlers(self):
        ...
        return (handlers.ProgressionDetailsActionHandler,
         ...
         handlers.ArtifactResearchActionHandler)
...
def preInit():
    ...
    schemaManager.registerClientServerSchema(cosmicBattleConfigSchema)
    ...
    from cosmic_event.cosmic_control_mode import CosmicControlMode, CosmicArcadeMapCaseControlMode, CosmicPostmortemControlMode
    OVERWRITE_CTRLS_DESC_MAP[cosmic_constants.ARENA_BONUS_TYPE.COSMIC_EVENT] = {CTRL_MODE_NAME.ARCADE: (
       ...
       CTRL_MODE_NAME.MAP_CASE_ARCADE: (
                                      CosmicArcadeMapCaseControlMode, 'cosmicMode', 0), 
       CTRL_MODE_NAME.POSTMORTEM: (
                                 CosmicPostmortemControlMode, 'cosmicMode', 0), 
       CTRL_MODE_NAME.KILL_CAM: (
                               CosmicPostmortemControlMode, 'cosmicMode', 0), 
       CTRL_MODE_NAME.DEATH_FREE_CAM: (
                                     CosmicPostmortemControlMode, 'cosmicMode', 0)}
    registerPrebattleConditionIconGetter(ARENA_BONUS_TYPE.COSMIC_EVENT, getPrebattleConditionIcon)

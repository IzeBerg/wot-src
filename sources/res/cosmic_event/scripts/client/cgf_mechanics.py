...
class CosmicEffectComponentManager(CGF.ComponentManager):
    ...
    @classmethod
    def toggleCurrentVehicleBasicShot(cls):
        cls._RGB = cls._BASIC_RGB

    @classmethod
    def toggleCurrentVehicleAdvancedShot(cls):
        cls._RGB = cls._ADVANCED_RGB
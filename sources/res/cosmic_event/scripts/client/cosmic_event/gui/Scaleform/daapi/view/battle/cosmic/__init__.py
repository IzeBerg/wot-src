...
def getViewSettings():
    ...
    from cosmic_event.gui.Scaleform.daapi.view.battle.cosmic.ingame_menu import CosmicIngameMenu
    return (
     ViewSettings(VIEW_ALIAS.COSMIC_BATTLE_PAGE, CosmicPage, 'cosmicBattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.INGAME_MENU, CosmicIngameMenu, 'ingameMenu.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canClose=False, canDrag=False),

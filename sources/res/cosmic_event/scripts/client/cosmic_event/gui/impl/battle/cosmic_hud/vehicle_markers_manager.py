...
class VehicleMarkersManager(plugins.IMarkersManager):
    ...
    def __init__(self, markersArray):
        self._plugins = []
    ...
    def stop(self):
        ...
        self._plugins = []
        markers = self.guiLoader.markers
        for markerModel in self._markers:
            markers.removeMarker(markerModel.proxy)
    ...
    def setMarkerMatrix(self, markerID, matrix):
        ...
        self.guiLoader.markers.addMarkerDynamic(self._markers[markerID].proxy, matrix)

...
@dependency.replace_none_kwargs(cosmicCtrl=ICosmicEventBattleController, itemsCache=IItemsCache)
def isCosmicBannerEntryPointAvailable(cosmicCtrl=None, itemsCache=None):
    return cosmicCtrl.isEnabled and itemsCache.items.getAccountDossier().getTotalStats().getBattlesCount() > 0

...
STORY_MODE_SOUND_SPACE = CommonSoundSpaceSettings(name=COMMON_SOUND_SPACE, entranceStates={GAMEMODE_GROUP: GAMEMODE_STATE, HANGAR_GROUP: HANGAR_STATE}, exitStates={GAMEMODE_GROUP: GAMEMODE_DEFAULT}, persistentSounds=(), stoppableSounds=(), priorities=(), autoStart=True, enterEvent='', exitEvent='')

...
class BattleTypeSelectorView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.battle_royale.lobby.tooltips.TabTooltipView():
            return TabTooltipView(event.getArgument('tabId'))
        return super(BattleTypeSelectorView, self).createToolTipContent(event, contentID)

...
class _RacesBattlesItem(_SelectorItem):
    ...
    def getFightButtonLabel(self, state, playerInfo):
        if self.__racesCtrl.isRacesMode():
            return backport.text(R.strings.races.headerButtons.battle())
        return super(_RacesBattlesItem, self).getFightButtonLabel(state, playerInfo)

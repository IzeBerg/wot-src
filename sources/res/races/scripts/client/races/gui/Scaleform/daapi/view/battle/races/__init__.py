...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.RACES_BATTLE_PAGE, RacesPage, 'racesBattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
...
class _RacesPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        ...
        listeners = (
         (
          VIEW_ALIAS.RACES_BATTLE_PAGE, self.loadViewBySharedEvent),)

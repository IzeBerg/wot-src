...
def showRacesBattleResult(arenaUniqueID, notificationsMgr=None):
    notificationsMgr.append(EventNotificationCommand(NotificationEvent(method=showRacesBattleResultView, arenaUniqueID=arenaUniqueID)))


@dependency.replace_none_kwargs(uiLoader=IGuiLoader)
def showRacesBattleResultView(arenaUniqueID, uiLoader=None):

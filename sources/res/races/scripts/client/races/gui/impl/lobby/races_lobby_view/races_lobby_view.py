import copy, logging, typing, adisp
...
class RacesLobbyView(ViewImpl, LobbyHeaderVisibility):
    ...
    _COMMON_SOUND_SPACE = CommonSoundSpaceSettings(name='racesLobbyView', entranceStates={_SOUND_STATE_PLACE: _SOUND_STATE_PLACE_GARAGE, StatesGroup.HANGAR_FILTERED: States.HANGAR_FILTERED_OFF}, exitStates={}, persistentSounds=(), stoppableSounds=(), priorities=(), autoStart=True, enterEvent='', exitEvent='')

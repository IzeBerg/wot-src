...
class RacesHudView(ViewImpl):
    __slots__ = ('__callbackDelayer', '_vehMarkersMan', '_currentGoal', '_shootingAbilityCD',
                 '_markersCtrl', '_period', '_minimapComponent', '_messages', '_playerListComponent',
                 '_inShooting', '__baseReloadTime')
    ...
    def _getListeners(self):
        listeners = [
         (
          RacesEvent.ON_OPEN_F1_HELP, self._onDisableF1HelperHint, EVENT_BUS_SCOPE.BATTLE),
         (
          RacesEvent.ON_RACE_FINISHED, self._onRaceFinished, EVENT_BUS_SCOPE.BATTLE)]
        return listeners

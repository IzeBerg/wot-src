...
class RacesBannerView(ViewImpl, Notifiable):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.races.lobby.tooltips.RacesBannerInactiveTooltipView():
            return RacesBannerInactiveTooltip()
        return super(RacesBannerView, self).createToolTipContent(event, contentID)
    ...
    def _getEvents(self):
        return (
         (
          self.viewModel.onOpenRacesLobby, self.__onOpenRacesLobby),
         (

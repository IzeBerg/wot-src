...
class RacePlayerRecord(namedtuple('RacePlayerRecord', ['name', 'clanAbbrev', 'isReady', 'vehicleGuiName', 'weight'])):
...
class PlayerListComponent(object):
    ...
    def __getVehicleDistanceToFinish(self, vehicleID):
        ...
        if raceVehicle:
            return raceVehicle.currentDistanceToFinish
        else:
            return self.__getProjByArenaPosition(vehicleID)

...
class ClientRacesBattleMode(races_constants.RacesBattleMode):
    ...
    def _client_gameControllers(self):
        ...
        return (
         [
          IRacesProgressionController, RacesProgressionController, False],
         [
          IRacesBattleController, RacesBattleController, False],
         [
          IRacesVisibilityLayerController, RacesVisibilityLayerController, False])
    ...
    def _client_notificationActionHandlers(self):
        ...
        return (
         handlers.RacesOpenHandler,
         handlers.RacesLootBoxesAccrualHandler)

    @property
    def _client_tokenQuestsSubFormatters(self):
        import races.messenger.formatters.service_channel as formatters
        return (
         formatters.RacesProgressionMessageFormatter(),)
...
def preInit():
    ...
    OVERWRITE_CTRLS_DESC_MAP[races_constants.ARENA_BONUS_TYPE.RACES] = {CTRL_MODE_NAME.ARCADE: (
                             RacesControlMode, 'racesMode', 0)}
...
def init():
    ...
    registerScaleformBattlePackages(races_constants.ARENA_GUI_TYPE.RACES, ('races.gui.Scaleform.daapi.view.battle.races',
                                                                           'races.gui.Scaleform.daapi.view.battle.shared',

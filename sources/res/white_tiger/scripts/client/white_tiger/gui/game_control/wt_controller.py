...
WT_VIDEOS = ('boss_portal_idle.usm', 'boss_portal_open.usm', 'boss_tank_portal_idle.usm',
             'boss_tank_portal_show.usm', 'hunter_portal_idle.usm', 'hunter_portal_open.usm',
             'main_tank_portal_idle.usm', 'main_tank_portal_show.usm', 'primary_tank_portal_idle.usm',
             'primary_tank_portal_show.usm', 'secondary_tank_portal_idle.usm', 'secondary_tank_portal_show.usm',
             'wt_intro.usm', 'wt_outro.usm')

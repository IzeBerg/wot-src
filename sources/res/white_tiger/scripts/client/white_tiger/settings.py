...
class WhiteTigerConfig(namedtuple('WhiteTigerConfig', ('isEnabled', 'peripheryIDs', 'primeTimes', 'seasons',
                                'cycleTimes', 'progression', 'specialVehicles', 'mainVehiclePrize',
                                'bossMainVehicle', 'stampsPerProgressionStage', 'stamp',
                                'mainPrizeDiscountToken', 'mainPrizeDiscountPerToken',

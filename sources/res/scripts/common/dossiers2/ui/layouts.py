...
PERSONAL_MISSIONS_GROUP = [
 ...
 _single('mapboxSeason1'), _single('mapboxSeason2'), _single('mapboxSeason3')]
...
_CUSTOM_ACHIEVES = defaultdict(tuple, {DOSSIER_TYPE.ACCOUNT: (
                        achievements.WHITE_TIGER_RECORD, achievements.RARE_STORAGE_RECORD)})

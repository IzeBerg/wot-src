...
class ARENA_GUI_TYPE:
    ...
    RANGE = (
     ...
     MAPS_TRAINING, RTS, RTS_TRAINING, RTS_BOOTCAMP, FUN_RANDOM, COMP7, WINBACK, VERSUS_AI)
    RANDOM_RANGE = (
     RANDOM, EPIC_RANDOM)
    FALLOUT_RANGE = (
...
class ARENA_BONUS_TYPE:
    ...
    RANGE = (
     ...
     MAPBOX, WEEKEND_BRAWL, MAPS_TRAINING, RTS, RTS_1x1, RTS_BOOTCAMP, FUN_RANDOM, COMP7, WINBACK, VERSUS_AI)
    RANDOM_RANGE = (
     REGULAR, EPIC_RANDOM)

...
class ARENA_BONUS_TYPE:
    ...
    RANGE = (
     ...
     TOURNAMENT_COMP7, RANDOM_NP2, TRAINING_COMP7, STORY_MODE_ONBOARDING, STORY_MODE_REGULAR)
    RANDOM_RANGE = (
...
BATTLE_FEEDBACK_REASONS_AFTER_DEATH = frozenset((
 ATTACK_REASON.SHOT, ATTACK_REASON.FIRE, ATTACK_REASON.RAM, ATTACK_REASON.WORLD_COLLISION,
 ATTACK_REASON.DROWNING, ATTACK_REASON.OVERTURN))
...
DAMAGE_INFO_CODES = ('DEVICE_CRITICAL', 'DEVICE_DESTROYED', 'TANKMAN_HIT', 'DEVICE_CRITICAL_AT_SHOT',
                     ...
                     'DEATH_FROM_STATIC_DEATH_ZONE', 'DEATH_FROM_MINEFIELD_ZONE',
...
class QUEUE_TYPE:
    ...
    ALL = (
     ...
     RANDOM_NP2, STORY_MODE)
    REMOVED = (
     COMPANIES,)
    BASE_ON_DEQUEUE = (
     RANDOMS, EVENT_BATTLES, UNITS, EPIC, BATTLE_ROYALE, MAPBOX, FUN_RANDOM, COMP7, RANDOM_NP2)
...
class USER_SERVER_SETTINGS:
    ...
    _ALL = (
     ...
     ADVANCED_ACHIEVEMENTS_STORAGE, WOT_ANNIVERSARY)

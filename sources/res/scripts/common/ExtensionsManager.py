import BigWorld, ResMgr, importlib
...
class ExtensionsManager(object):
    ...
    def _readExtension(self, root):
        ...
        if not section:
            ...
            return Extension(root + '/', section.readString('FeatureName'), section.readBool('IsEnabled'), root.split('/')[(-1)], section.readString('Personality'))

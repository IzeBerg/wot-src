...
class SmokeConfigReader(object):
    _SMOKE_SLOTS = ('minDelay', 'deltaDelayRange', 'smokeModelName', 'startRadius',
                    ...
                    'noOwner', 'smokeEffectName', 'shotSoundPreDelay', 'wwsoundShot',
                    'orthogonalDir', 'randomizeDuration', 'vignetteColor', 'vignetteIntensity')
...
class ReconConfigReader(PlaneConfigReader):
    _RECON_SLOTS = PlaneConfigReader._PLANE_SLOTS + ('areaRadius', 'scanPointsAmount',
                                                     'spottingDuration', 'antepositions',

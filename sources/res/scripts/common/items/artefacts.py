...
class Equipment(Artefact):
    __slots__ = ('equipmentType', 'reuseCount', 'cooldownSeconds', 'soundNotification',
                 ...
                 'consumeSeconds', 'deploySeconds', 'rechargeSeconds', 'soundPressedReady',
                 'soundPressedNotReady')
...
class ConsumableSpawnBot(Equipment, TooltipConfigReader, CountableConsumableConfigReader, MarkerConfigReader, ArcadeEquipmentConfigReader):
    __slots__ = TooltipConfigReader._SHARED_TOOLTIPS_CONSUMABLE_SLOTS + CountableConsumableConfigReader._CONSUMABLE_SLOTS + ArcadeEquipmentConfigReader._SHARED_ARCADE_SLOTS + MarkerConfigReader._MARKER_SLOTS_ + ('botType',
                                                                                                                                                                                                                    'botVehCompDescr',
                                                                                                                                                                                                                    'botLifeTime',
                                                                                                                                                                                                                    'botSpawnPointOffset',
                                                                                                                                                                                                                    'botXRayFactor',

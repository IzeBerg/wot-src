...
class Artefact(BasicItem):
    __slots__ = ('name', 'id', 'compactDescr', 'tags', 'i18n', 'icon', 'removable',
                 ...
                 '_exportParams', '__archetype', '__vehicleFilter', '__artefactFilter',
...
class Equipment(Artefact):
    __slots__ = ('equipmentType', 'reuseCount', 'cooldownSeconds', 'soundNotification',
                 ...
                 'playerMessagesKey', 'code', 'consumeSeconds', 'deploySeconds',
                 'rechargeSeconds', 'soundPressedReady', 'soundPressedNotReady',
                 'soundPressedCancel')
...
class Comp7JuggernautEquipment(VisualScriptEquipment):
    __slots__ = ('duration', 'enginePowerFactor', 'dmgAbsorb', 'fwMaxSpeedBonus', 'bkMaxSpeedBonus',
                 'rammingDamageBonus', 'vehicleRotationSpeedFactor')

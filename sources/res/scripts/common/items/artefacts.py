...
class Artefact(BasicItem):
    __slots__ = ('name', 'id', 'compactDescr', 'tags', 'i18n', 'icon', 'removable',
                 'price', 'showInShop', '_vehWeightFraction', '_weight', '_maxWeightChange',
                 '__vehicleFilter', '__artefactFilter', 'isImproved', 'kpi', 'iconName',
                 '_groupName', '__weakref__')
    ...
    def weightOnVehicle(self, vehicleDescr):
        return (
         self._vehWeightFraction, self._weight, 0.0)
...
class Equipment(Artefact):
    __slots__ = ('equipmentType', 'reuseCount', 'cooldownSeconds', 'soundNotification',
                 ...
                 'activationWWSoundFeedback', 'deactivationWWSoundFeedback')
...
class InfluenceZone(object):
    __slots__ = ('radius', 'height', 'depth', 'timer', 'terrainResistance', 'debuffFactors',
                 'dotParams', 'hotParams', 'influenceType')
...
class MarkerConfigReader(object):
    _MARKER_SLOTS_ = ('areaVisual', 'areaColor', 'areaMarker', 'areaRadius', 'areaLength',
                      'areaWidth')
...
class ArtilleryConfigReader(MarkerConfigReader):
    _ARTILLERY_SLOTS = MarkerConfigReader._MARKER_SLOTS_ + ('delay', 'duration', 'shotsNumber',
                                                            'areaRadius', 'shellCompactDescr',
                                                            'piercingPower', 'noOwner',
                                                            'shotSoundPreDelay',
...
class SmokeConfigReader(object):
    _SMOKE_SLOTS = ('minDelay', 'deltaDelayRange', 'smokeModelName', 'startRadius',
                    ...
                    'expansionDuration', 'dispersionRadius', 'totalDuration', 'smokeOpacity',
                    'visionRadiusFactor', 'dotParams', 'areaLength', 'areaWidth',
                    'projectilesNumber', 'shellCompactDescr', 'areaVisual', 'areaMarker',
                    'noOwner', 'smokeEffectNameAlly', 'smokeEffectNameEnemy', 'shotSoundPreDelay',
...
class SixthSenseBattleBooster(Equipment):
    ...
    def updateCrewSkill(self, idxInCrew, level, levelIncrease, isActive, isFire, skillConfig):
        ...
        return (idxInCrew, level, levelIncrease, isActive, isFire, skillConfig)
...
class DamageNearestEnemy(EventEquipment):
    __slots__ = ('radius', 'enemies', 'damage', 'selfBuff', 'selfDuration', 'enemyBuff',
                 'enemyDuration')
...
class ApplyBuffInRadiusEquipment(EventEquipment):
    __slots__ = ('buff', 'buffDuration', 'selfBuff', 'selfBuffDuration', 'radius',
                 'team', 'maxVehicles')
...
class DrainHpInRadiusEquipment(EventEquipment):
    __slots__ = ('buff', 'buffDuration', 'selfBuff', 'selfBuffDuration', 'damage',
                 'healCoeff', 'radius', 'team', 'maxVehicles')
...
class AreaOfEffectEquipment(Equipment, TooltipConfigReader, SharedCooldownConsumableConfigReader, ArcadeEquipmentConfigReader):
    __slots__ = ('delay', 'duration', 'lifetime', 'shotsNumber', 'areaRadius', 'areaLength',
                 ...
                 'effects', 'actionsConfig', 'explodeDestructible') + TooltipConfigReader._SHARED_TOOLTIPS_CONSUMABLE_SLOTS + SharedCooldownConsumableConfigReader._SHARED_COOLDOWN_CONSUMABLE_SLOTS + ArcadeEquipmentConfigReader._SHARED_ARCADE_SLOTS
...
class MineParams(object):
    __slots__ = ('triggerRadius', 'triggerHeight', 'triggerDepth', 'influenceType',
                 'lifetime', 'damage', 'shell', 'shellLowDamage', 'destroyMyMinesOverlappingAlliedMines',
                 'resistAllyDamage', 'directDetectionTypes')
...
class BattleRoyaleMinefield(Equipment, TooltipConfigReader, SharedCooldownConsumableConfigReader, ArcadeEquipmentConfigReader, CountableConsumableConfigReader, CooldownConsumableConfigReader):
    __slots__ = ('bombsPattern', 'mineParams', 'noOwner', 'areaLength', 'areaWidth',
                 'areaVisual', 'areaColor', 'areaMarker')
...
class ConsumableSpawnKamikaze(Equipment, TooltipConfigReader, CountableConsumableConfigReader, MarkerConfigReader, CooldownConsumableConfigReader, ArcadeEquipmentConfigReader):
    __slots__ = TooltipConfigReader._SHARED_TOOLTIPS_CONSUMABLE_SLOTS + CountableConsumableConfigReader._CONSUMABLE_SLOTS + CooldownConsumableConfigReader._CONSUMABLE_SLOTS + ArcadeEquipmentConfigReader._SHARED_ARCADE_SLOTS + MarkerConfigReader._MARKER_SLOTS_ + ('botType',
                                                                                                                                                                                                                                                                       'botVehCompDescr',
                                                                                                                                                                                                                                                                       'botLifeTime',
                                                                                                                                                                                                                                                                       'botSpawnPointOffset',
                                                                                                                                                                                                                                                                       'botXRayFactor',
...
class OPT_DEV_TYPE_TAG(object):
    ...
    DELUXE = 'deluxe'
    ALL = {
     TROPHY_BASIC, TROPHY_UPGRADED, DELUXE}

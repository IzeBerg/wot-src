...
class ToyTypes(object):
    ...
    USUAL_TYPES = (
     TOP, GARLAND_FIR, BALL, FLOOR,
     PAVILION, KITCHEN, GARLAND_FAIR, ATTRACTION,
...
TOY_TYPES_BY_OBJECT_WITHOUT_MEGA = {CustomizationObjects.FIR: (
   ...
   CustomizationObjects.INSTALLATION: (
                                     ...
                                     ToyTypes.PYRO,
                                     ToyTypes.KIOSK)}
TOY_TYPES_BY_OBJECT = dict(TOY_TYPES_BY_OBJECT_WITHOUT_MEGA, **{CustomizationObjects.MEGAZONE: (
...
class YEARS(object):
    ...
    YEAR22 = 22
    ALL = (
     YEAR18, YEAR19, YEAR20, YEAR21, YEAR22)

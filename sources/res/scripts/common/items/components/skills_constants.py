SKILL_NAMES = ('reserved', 'commander', 'radioman', 'driver', 'gunner', 'loader', 'repair',
               ...
               'commander_enemyShotPredictor', 'commander_practical', 'reserved',
               'reserved', 'reserved', 'reserved', 'reserved', 'driver_virtuoso',
               'driver_smoothDriving', 'driver_badRoadsKing', 'driver_rammingMaster',
               'driver_tidyPerson', 'driver_motorExpert', 'reserved', 'reserved',
               'reserved', 'gunner_gunsmith', 'gunner_sniper', 'gunner_smoothTurret',
               'gunner_rancorous', 'gunner_focus', 'gunner_quickAiming', 'reserved',
               'reserved', 'reserved', 'loader_pedant', 'loader_desperado', 'loader_intuition',
               'loader_ambushMaster', 'loader_ammunitionImprove', 'loader_melee',
               'reserved', 'radioman_inventor', 'radioman_finder', 'radioman_retransmitter',
               'radioman_lastEffort', 'radioman_interference', 'reserved', 'reserved',
               'reserved')
...
COMMANDER_SKILLS = ('commander_eagleEye', 'commander_universalist', 'commander_tutor',
                    'commander_expert', 'commander_sixthSense', 'commander_enemyShotPredictor')
COMMON_ROLE = 'common'
SKILLS_BY_ROLES_ORDERED = {'commander': COMMON_SKILLS_ORDERED + COMMANDER_SKILLS, 
   'driver': COMMON_SKILLS_ORDERED + ('driver_virtuoso', 'driver_smoothDriving', 'driver_badRoadsKing',
                         'driver_tidyPerson', 'driver_rammingMaster'), 
   'gunner': COMMON_SKILLS_ORDERED + ('gunner_smoothTurret', 'gunner_sniper', 'gunner_rancorous',
                         'gunner_gunsmith'), 
   'loader': COMMON_SKILLS_ORDERED + ('loader_desperado', 'loader_pedant', 'loader_intuition'), 
   'radioman': COMMON_SKILLS_ORDERED + ('radioman_finder', 'radioman_retransmitter', 'radioman_lastEffort',
                         'radioman_inventor')}
SKILLS_BY_ROLES = {}

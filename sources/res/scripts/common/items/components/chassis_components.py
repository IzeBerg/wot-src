...
__all__ = ('Wheel', 'WheelGroup', 'TrackNode', 'TrackBasicParams', 'GroundNode', 'GroundNodeGroup',
...
TrackBasicParams = reflectedNamedTuple('TrackBasicParams', ('lodDist', 'leftMaterial',
                                                            'rightMaterial', 'textureScale',
                                                            'pairsCount'))
...
LeveredSuspensionConfig = reflectedNamedTuple('LeveredSuspensionConfig', ('levers',
                                                                          ...
                                                                          'lodSettings',
                                                                          'activePostmortem'))
SuspensionLever = reflectedNamedTuple('SuspensionLever', ('startNodeName', 'jointNodeName',
...
class SplineConfig(object):
    ...
    __slots__ = ('__segmentModelSets', '__leftDesc', '__rightDesc', '__lodDist', '__atlasUTiles',
                 '__atlasVTiles')

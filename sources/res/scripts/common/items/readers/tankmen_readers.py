...
def _readTankmenGroup(xmlCtx, groupName, subsection, firstNames, lastNames, icons, optimizationCache=None):
    ...
    return tankmen_components.NationGroup(_xml.readNonNegativeInt(xmlCtx, subsection, 'groupID'), groupName, 'female' == _xml.readNonEmptyString(xmlCtx, subsection, 'sex'), subsection.readBool('notInShop', False), _readIDs((
     xmlCtx, 'firstNames'), _xml.getChildren(xmlCtx, subsection, 'firstNames'), firstNames, parseName, optimizationNeeded=hasLocalizedName, optimizationCache=optimizationCache), _readIDs((
     xmlCtx, 'lastNames'), _xml.getChildren(xmlCtx, subsection, 'lastNames'), lastNames, parseName, optimizationNeeded=hasLocalizedName, optimizationCache=optimizationCache), _readIDs((

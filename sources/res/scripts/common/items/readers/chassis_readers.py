...
def readSplineConfig(xmlCtx, section, cache):
    if not section.has_key('splineDesc'):
        ...
        if multipleTracks is not None:
            ...
            leftTuple = [
             _xml.readStringOrNone(xmlCtx, section, 'splineDesc/left'), 0, length, offset, offset2]
            rightTuple = [_xml.readStringOrNone(xmlCtx, section, 'splineDesc/right'), 0, length, offset, offset2]

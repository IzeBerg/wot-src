...
class ActivationController(object):
    ...
    eventStartTimeRange = ComponentProperty(type=CGFMetaTypes.VECTOR2, editorName='ActivationStartRange', value=(0.0,
                                                                                                                 5.0))
    ...
    def getTimedActivators(go):
        ...
        if hr:
            return hr.findComponentsInHierarchy(go, TimedActivation)
        return []
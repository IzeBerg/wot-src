...
class ConfigDialog(Toplevel):
    ...
    def CreatePageHighlight(self):
        ...
        self.textHighlightSample = Text(frameCustom, relief=SOLID, borderwidth=1, font=('courier',
                                                                                        12,
                                                                                        ''), cursor='hand2', width=21, height=11, takefocus=FALSE, highlightthickness=0, wrap=NONE)
    ...
    def LoadFontCfg(self):
        ...
        self.optMenuFontSize.SetMenu(('7', '8', '9', '10', '11', '12', '13', '14',
                                      '16', '18', '20', '22', '25', '29', '34', '40'), fontSize)
    ...
    def load_extensions(self):
        ...
        for ext_name in self.extensions:
            ...
            for opt_name in opt_list:
                ...
                var = StringVar(self)
                var.set(str(value))
                self.extensions[ext_name].append({'name': opt_name, 'type': opt_type, 
                   'default': def_str, 
                   'value': value, 
                   'var': var})
    ...
    def create_extension_frame(self, ext_name):
        ...
        for row, opt in enumerate(self.extensions[ext_name]):
            ...
            if opt['type'] == 'bool':
                ...
                Entry(entry_area, textvariable=var, validate='key', validatecommand=(
                 self.is_int, '%P')).grid(row=row, column=1, sticky=NSEW, padx=7)
            else:

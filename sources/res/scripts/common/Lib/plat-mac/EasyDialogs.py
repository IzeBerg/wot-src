...
import Nav, MacOS, string
from Carbon.ControlAccessor import *
import Carbon.File, macresource, os, sys
__all__ = [
...
def _process_Nav_args(dftflags, **args):
    import Carbon.AppleEvents, Carbon.AE, Carbon.File
    for k in args.keys():
        if args[k] is None:
            del args[k]

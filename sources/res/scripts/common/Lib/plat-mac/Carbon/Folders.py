...
kTextEncodingsFolderType = FOUR_CHAR_CODE(b'\xc4tex')
...
kOpenDocEditorsFolderType = FOUR_CHAR_CODE(b'\xc4odf')
kOpenDocLibrariesFolderType = FOUR_CHAR_CODE('odlb')
kGenEditorsFolderType = FOUR_CHAR_CODE(b'\xc4edi')
kHelpFolderType = FOUR_CHAR_CODE(b'\xc4hlp')
kInternetPlugInFolderType = FOUR_CHAR_CODE(b'\xc4net')
kModemScriptsFolderType = FOUR_CHAR_CODE(b'\xc4mod')
kPrinterDescriptionFolderType = FOUR_CHAR_CODE('ppdf')
kPrinterDriverFolderType = FOUR_CHAR_CODE(b'\xc4prd')
kScriptingAdditionsFolderType = FOUR_CHAR_CODE(b'\xc4scr')
kSharedLibrariesFolderType = FOUR_CHAR_CODE(b'\xc4lib')
kVoicesFolderType = FOUR_CHAR_CODE('fvoc')
kControlStripModulesFolderType = FOUR_CHAR_CODE('sdev')
kAssistantsFolderType = FOUR_CHAR_CODE(b'ast\xc4')
kUtilitiesFolderType = FOUR_CHAR_CODE(b'uti\xc4')
kAppleExtrasFolderType = FOUR_CHAR_CODE(b'aex\xc4')
kContextualMenuItemsFolderType = FOUR_CHAR_CODE('cmnu')
kMacOSReadMesFolderType = FOUR_CHAR_CODE(b'mor\xc4')
...
kInternetFolderType = FOUR_CHAR_CODE(b'int\xc4')
kAppearanceFolderType = FOUR_CHAR_CODE('appr')
kSoundSetsFolderType = FOUR_CHAR_CODE('snds')
kDesktopPicturesFolderType = FOUR_CHAR_CODE(b'dtp\xc4')
...
kScriptsFolderType = FOUR_CHAR_CODE(b'scr\xc4')
...
kMusicDocumentsFolderType = FOUR_CHAR_CODE(b'\xb5doc')
...
kLocalesFolderType = FOUR_CHAR_CODE(b'\xc4loc')
...
kAppleshareAutomountServerAliasesFolderType = FOUR_CHAR_CODE(b'srv\xc4')
kPreMacOS91ApplicationsFolderType = FOUR_CHAR_CODE(b'\x8cpps')
kPreMacOS91InstallerLogsFolderType = FOUR_CHAR_CODE(b'\x94lgf')
kPreMacOS91AssistantsFolderType = FOUR_CHAR_CODE(b'\x8cst\xc4')
kPreMacOS91UtilitiesFolderType = FOUR_CHAR_CODE(b'\x9fti\xc4')
kPreMacOS91AppleExtrasFolderType = FOUR_CHAR_CODE(b'\x8cex\xc4')
kPreMacOS91MacOSReadMesFolderType = FOUR_CHAR_CODE(b'\xb5or\xc4')
kPreMacOS91InternetFolderType = FOUR_CHAR_CODE(b'\x94nt\xc4')
kPreMacOS91AutomountedServersFolderType = FOUR_CHAR_CODE(b'\xa7rv\xc4')
kPreMacOS91StationeryFolderType = FOUR_CHAR_CODE(b'\xbfdst')

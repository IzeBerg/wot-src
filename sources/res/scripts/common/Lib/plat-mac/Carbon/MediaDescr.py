...
SampleDescription = _MediaDescriptionCodec(1, 16, ('descSize', 'dataFormat', 'resvd1',
                                                   'resvd2', 'dataRefIndex'), 'l4slhh')
SoundDescription = _MediaDescriptionCodec(1, 36, (
 'descSize', 'dataFormat', 'resvd1', 'resvd2', 'dataRefIndex',
 'version', 'revlevel', 'vendor', 'numChannels', 'sampleSize',
 'compressionID', 'packetSize', ('sampleRate', _tofixed, _fromfixed)), 'l4slhhhh4shhhhl')
SoundDescriptionV1 = _MediaDescriptionCodec(1, 52, (
 'descSize', 'dataFormat', 'resvd1', 'resvd2', 'dataRefIndex',
 'version', 'revlevel', 'vendor', 'numChannels', 'sampleSize',
 'compressionID', 'packetSize', ('sampleRate', _tofixed, _fromfixed), 'samplesPerPacket',
 'bytesPerPacket', 'bytesPerFrame', 'bytesPerSample'), 'l4slhhhh4shhhhlllll')
ImageDescription = _MediaDescriptionCodec(1, 86, (
 ...
 'depth', 'clutID'), 'l4slhhhh4sllhhlllh32shh')
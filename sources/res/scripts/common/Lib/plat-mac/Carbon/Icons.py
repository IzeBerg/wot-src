...
kAppleExtrasFolderIcon = FOUR_CHAR_CODE(b'aex\xc4')
...
kAssistantsFolderIcon = FOUR_CHAR_CODE(b'ast\xc4')
...
kControlStripModulesFolderIcon = FOUR_CHAR_CODE(b'sdv\xc4')
...
kHelpFolderIcon = FOUR_CHAR_CODE(b'\xc4hlp')
kInternetFolderIcon = FOUR_CHAR_CODE(b'int\xc4')
kInternetPlugInFolderIcon = FOUR_CHAR_CODE(b'\xc4net')
kInternetSearchSitesFolderIcon = FOUR_CHAR_CODE('issf')
kLocalesFolderIcon = FOUR_CHAR_CODE(b'\xc4loc')
kMacOSReadMeFolderIcon = FOUR_CHAR_CODE(b'mor\xc4')
kPublicFolderIcon = FOUR_CHAR_CODE('pubf')
kPreferencesFolderIcon = FOUR_CHAR_CODE(b'prf\xc4')
kPrinterDescriptionFolderIcon = FOUR_CHAR_CODE('ppdf')
kPrinterDriverFolderIcon = FOUR_CHAR_CODE(b'\xc4prd')
...
kScriptingAdditionsFolderIcon = FOUR_CHAR_CODE(b'\xc4scr')
kSharedLibrariesFolderIcon = FOUR_CHAR_CODE(b'\xc4lib')
kScriptsFolderIcon = FOUR_CHAR_CODE(b'scr\xc4')
...
kTextEncodingsFolderIcon = FOUR_CHAR_CODE(b'\xc4tex')
kUsersFolderIcon = FOUR_CHAR_CODE(b'usr\xc4')
kUtilitiesFolderIcon = FOUR_CHAR_CODE(b'uti\xc4')

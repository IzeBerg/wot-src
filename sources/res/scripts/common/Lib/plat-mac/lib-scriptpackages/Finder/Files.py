...
application_file._superclassnames = [
 'file']
...
document_file._superclassnames = [
 'file']
...
file._privelemdict = {}
internet_location_file._superclassnames = [
 'file']

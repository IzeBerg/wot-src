...
import aetools
Error = aetools.Error
import Text_Suite, AppleScript_Suite, Standard_Suite, Macintosh_Connectivity_Clas, QuickDraw_Graphics_Suite, QuickDraw_Graphics_Suppleme, Required_Suite, Table_Suite, Type_Names_Suite

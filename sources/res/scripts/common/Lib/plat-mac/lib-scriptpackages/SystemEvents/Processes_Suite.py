...
import Disk_Folder_File_Suite, Standard_Suite, Folder_Actions_Suite, Login_Items_Suite
...
application_process._superclassnames = [
 'process']
...
desk_accessory_process._superclassnames = [
 'process']

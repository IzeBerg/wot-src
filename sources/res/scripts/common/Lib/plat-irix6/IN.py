...
def IN_CLASSA(i):
    return __int32_t(i) & 2147483648 == 0
...
def IN_CLASSB(i):
    return __int32_t(i) & 3221225472 == 2147483648
...
def IN_CLASSC(i):
    return __int32_t(i) & 3758096384 == 3221225472
...
def IN_CLASSD(i):
    return __int32_t(i) & 4026531840 == 3758096384
...
def IN_EXPERIMENTAL(i):
    return __int32_t(i) & 4026531840 == 4026531840
...
IPV6_FLOWINFO_FLOWLABEL = 4294967040
IPV6_FLOWINFO_PRIORITY = 15
IPV6_FLOWINFO_PRIFLOW = 4294967055

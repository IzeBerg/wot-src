...
class PerkContext(VScriptContext):
    ...
    @vse_func_call(None, (
     SLOT_TYPE.STR, SLOT_TYPE.FLOAT), display_name='AddAuraModifier', description='Adds a modifier to aura scope', display_group='Aura')
    ...
    @vse_func_call(None, (
     SLOT_TYPE.INT, SLOT_TYPE.FLOAT, SLOT_TYPE.FLOAT), display_name='StartAura', descrption='Starts aura loop', display_group='Aura')
    def startAura(self, targetTeam, startRadius, interval):
        self._aspectImpl.startAura(targetTeam, startRadius, interval)

    @vse_func_call(None, (
     SLOT_TYPE.FLOAT,), display_name='SetAuraRange', description='Set range for aura', display_group='Aura')

...
BattleChatCommand = namedtuple('BattleChatCommand', ('id', 'name', 'cooldownPeriod',
                                                     'msgText', 'vehMarker', 'senderVehMarker',
                                                     'soundNotification', 'msgOnMarker',
...
ChatCommandBlockedData = namedtuple('ChatCommandBlockedData', ('reqID', 'cmdID', 'cooldownType',
                                                               'cooldownEnd', 'targetID'))

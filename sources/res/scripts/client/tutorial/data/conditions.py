...
class CONDITION_STATE(object):
    ...
    RANGE = (
     ...
     MONEY_ENOUGH, LEVEL, MAY_INSTALL, INSTALLED, CREW_HAS_SKILL, HAS_REGULAR_CONSUMABLES, HAS_OPTIONAL_DEVICES)
    ...
    GAME_ITEM_RELATE_STATE = (
     XP_ENOUGH, LEVEL, MAY_INSTALL, INSTALLED, CREW_HAS_SKILL)

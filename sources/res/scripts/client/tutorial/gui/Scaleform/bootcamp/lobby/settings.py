...
BOOTCAMP_LOBBY_VIEW_SETTINGS = (
 ...
 GroupedViewSettings(VIEW_ALIAS.BOOTCAMP_NATIONS_WINDOW, BCNationsWindow, 'BCNationsWindow.swf', WindowLayer.WINDOW, '', None, ScopeTemplates.WINDOW_SCOPE, canClose=False))

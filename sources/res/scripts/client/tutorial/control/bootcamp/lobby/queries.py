...
class MessageDialogContentQuery(ContentQuery):
    ...
    def _makeMessageData(self, msgContent):
        ...
        voiceover = {'voiceover': data['voiceover'], 'subtitle': data['subtitle']}
        if showBottomData:
...
class SubtitleDialogContentQuery(MessageDialogContentQuery):
    ...
    def _makeMessageData(self, msgContent):
        data = msgContent['data']
        voiceover = {'voiceover': data['voiceover'], 'subtitle': i18n.makeString(data['subtitle']), 'keypoint': ''}
        return (
         data, voiceover)
...
class VideoDialogContentQuery(MessageDialogContentQuery):
    ...
    def _makeMessageData(self, msgContent):
        data = msgContent['data']
        voiceover = {'voiceover': '', 'subtitle': data['subtitle']}
        return (
         data, voiceover)
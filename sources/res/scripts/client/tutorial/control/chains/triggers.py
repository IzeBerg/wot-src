...
__all__ = ('SimpleDialogTrigger', 'BuyNextLevelVehicleTrigger', 'CurrentVehicleRequiredLevelTrigger',
           'RentedVehicleTrigger', 'CurrentVehicleMaintenanceStateTrigger', 'CurrentVehicleLockedTrigger',
           'TankmanPriceDiscountTrigger', 'QueueTrigger', 'FightButtonDisabledTrigger',
           'CurrentVehicleNeedChangeTrigger', 'IsInSandBoxPreQueueTrigger')
...
class SimpleDialogTrigger(Trigger):
    ...
    def run(self):
        if self.isSubscribed:
            return
        self.__pointcutIdx = g_tutorialWeaver.weave(pointcut=aspects.SimpleDialogClosePointcut, aspects=(
         aspects.SimpleDialogResultAspect(self),))
...
class CurrentVehicleNeedChangeTrigger(_CurrentVehicleViewStateTrigger):
    ...
    def isOn(self):
        return game_vars.getCurrentVehicleState() in (

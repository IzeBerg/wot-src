...
class GLOBAL_FLAG(object):
    ...
    ALL = (
     ...
     ALL_BONUSES_RECEIVED, MAY_PAWN_PERSONAL_MISSION,
     HAVE_NEW_BADGE, HAVE_NEW_SUFFIX_BADGE, BADGE_PAGE_HAS_NEW_SUFFIX_BADGE, CREW_BOOKS_ENABLED,
     COLLECTIBLE_VEHICLE_PREVIEW_ENABLED, DOGTAGS_ENABLED, WOTPLUS_ENABLED, BATTLE_MATTERS_ENTRY_POINT,
     PERSONAL_RESERVES_AVAILABLE, NY_NAVIGATION_DISABLED)

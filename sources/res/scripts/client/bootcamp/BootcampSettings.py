...
class BattleSettings(object):
    ...
    HINTS_PARAMS = {HINT_TYPE.HINT_NO_MOVE: {'seconds': _HintParamType.FLOAT}, HINT_TYPE.HINT_NO_MOVE_TURRET: {'seconds': _HintParamType.FLOAT}, HINT_TYPE.HINT_AIM: {'aimFactor': _HintParamType.FLOAT, 'shootCount': _HintParamType.INT}, HINT_TYPE.HINT_SECONDARY_SNIPER: {'distance': _HintParamType.FLOAT, 'angle': _HintParamType.FLOAT}, HINT_TYPE.HINT_WAIT_RELOAD: {'maxShootErrorsCount': _HintParamType.INT}, HINT_TYPE.HINT_EXIT_GAME_AREA: {'distanceToBorder': _HintParamType.FLOAT}, HINT_TYPE.HINT_MOVE_TO_MARKER: {'maxDistance': _HintParamType.FLOAT}, HINT_TYPE.HINT_LOW_HP: {'first_percent': _HintParamType.FLOAT, 'second_percent': _HintParamType.FLOAT}, HINT_TYPE.HINT_SHOT_WHILE_MOVING: {'maxShootErrorsCount': _HintParamType.INT}}

    def __init__(self):
        super(BattleSettings, self).__init__()
        self.__defaults = {'hints': {}, 'ribbons': [], 'panels': [], 'lessonPages': {}, 'prebattleHints': set()}
        self.__config = {}
        try:
            self.__loadDefaults()
            self.__loadConfig()

...
class Bootcamp(EventSystemEntity):
    ...
    def __getLessonStatus(self, lesson):
        return [
         BootcampStatuses.RECEIVED if g_bootcamp.getLessonNum() >= lesson or not self.bootcampController.needAwarding() and lesson > g_bootcamp.getContextIntParameter('lastLessonNum') else BootcampStatuses.WAIT, lesson]
    ...
    def fillProgressBar(self, viewModel, tooltipData, iconSize=ICON_SIZE.SMALL):
        ...
        progressBarItems = [
         self._getProgressBarItem([
          self._getProgressBarIcon(bootcampIcons.bcTank2_48() if iconSize == ICON_SIZE.SMALL else bootcampIcons.bcTank2_80(), [
           BOOTCAMP.TOOLTIP_PROGRESSION_LABEL_VEHICLE_SECOND_LEVEL,
           BOOTCAMP.TOOLTIP_PROGRESSION_DESCRIPTION_VEHICLE,
           RES_ICONS.MAPS_ICONS_BOOTCAMP_REWARDS_TOOLTIPS_BCAWARDOPTIONS], 2)], [
         ...
         self._getProgressBarItem([
          self._getProgressBarIcon(bootcampIcons.bcTank3_48() if iconSize == ICON_SIZE.SMALL else bootcampIcons.bcTank3_80(), [
           BOOTCAMP.TOOLTIP_PROGRESSION_LABEL_VEHICLE_THIRD_LEVEL,
           BOOTCAMP.TOOLTIP_PROGRESSION_DESCRIPTION_VEHICLE,
           RES_ICONS.MAPS_ICONS_BOOTCAMP_REWARDS_TOOLTIPS_BCAWARDOPTIONS], 4)], [
         ...
         self._getProgressBarItem([
          ...
          self._getProgressBarIcon(bootcampIcons.bcBootcampMedal_48() if iconSize == ICON_SIZE.SMALL else bootcampIcons.bcBootcampMedal_80(), [
           ...
           RES_ICONS.MAPS_ICONS_BOOTCAMP_REWARDS_TOOLTIPS_BCACHIEVEMENT], 6)], [

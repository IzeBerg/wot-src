...
class PointcutBattleSelectorHintText(aop.Pointcut):
    ...
    def __init__(self):
        super(PointcutBattleSelectorHintText, self).__init__('gui.Scaleform.daapi.view.lobby.header.battle_selector_items', '_BattleSelectorItems', 'update', aspects=(
...
class _PointcutBrowserControllerDisable(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutBrowserControllerDisable, self).__init__('gui.game_control.BrowserController', 'BrowserController', 'load', aspects=(
         common.AspectAvoidAsync(),))


class _PointcutPrbDisableEntitySelect(aop.Pointcut):

    def __init__(self):
        super(_PointcutPrbDisableEntitySelect, self).__init__('gui.prb_control.entities.bootcamp.pre_queue.entity', 'BootcampEntity', 'doSelectAction', aspects=(
...
class _PointcutPrbDisableAcceptButton(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutPrbDisableAcceptButton, self).__init__('gui.prb_control.invites', 'InvitesManager', 'canAcceptInvite', aspects=(
...
class _PointcutPrbInvitationText(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutPrbInvitationText, self).__init__('gui.prb_control.formatters.invites', 'PrbInviteHtmlTextFormatter', 'getNote', aspects=(
...
class _PointcutOnOptionalDeviceSelectPopoverGetTabData(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutOnOptionalDeviceSelectPopoverGetTabData, self).__init__('gui.Scaleform.daapi.view.lobby.shared.fitting_select_popover', 'OptionalDeviceSelectPopover', '_getTabsData', aspects=(
...
class _PointcutOnOptionalDeviceSelectPopoverGetInitialTabIndex(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutOnOptionalDeviceSelectPopoverGetInitialTabIndex, self).__init__('gui.Scaleform.daapi.view.lobby.shared.fitting_select_popover', 'OptionalDeviceSelectPopover', '_getInitialTabIndex', aspects=(
...
class _PointcutOnOptionalDeviceSelectPopoverPreventCloseAfterMessage(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutOnOptionalDeviceSelectPopoverPreventCloseAfterMessage, self).__init__('gui.Scaleform.daapi.view.lobby.shared.fitting_select_popover', 'OptionalDeviceSelectPopover', 'destroy', aspects=(
...
class _PointcutDisableModuleClickSound(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutDisableModuleClickSound, self).__init__('gui.sounds.SoundManager', 'SoundManager', 'playControlSound', aspects=(
         common.AspectDisableControlSound(('press', 'over'), ('ammunitionModule', )),))
...
class _PointcutUnreadMessages(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutUnreadMessages, self).__init__('messenger.proto.bw.ServiceChannelManager', 'ServiceChannelManager', '^_handleUnreadMessage$', aspects=(
...
class _PointcutOverrideAOGASMessageTimeout(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutOverrideAOGASMessageTimeout, self).__init__('messenger.proto.bw.ServiceChannelManager', 'ServiceChannelManager', 'pushClientMessage', aspects=(
...
class _PointcutOverrideKoreaParentalControl(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutOverrideKoreaParentalControl, self).__init__('messenger.proto.bw.ServiceChannelManager', 'ServiceChannelManager', 'pushClientMessage', aspects=(
...
class _PointcutDisableRankedBattleEvents(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutDisableRankedBattleEvents, self).__init__('gui.game_control.ranked_battles_controller', 'RankedBattlesController', 'isAvailable', aspects=(
         common.AspectAvoidWithConstantRet(False),))
    ...
    def atCall(self, cd):
        ...
        if not isinstance(auxData, SessionControlAuxData):
            ...
            return cd.changeArgs((
             3, 'auxData', SessionControlAuxData(auxData.type, newTimeout)))

...
class _PointcutHideMinimapNames(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutHideMinimapNames, self).__init__('gui.Scaleform.daapi.view.battle.shared.minimap.common', 'SimplePlugin', '_invoke', aspects=(
...
class _PointcutLimitNotificationPopUpsCount(aop.Pointcut):
    ...
    def __init__(self):
        super(_PointcutLimitNotificationPopUpsCount, self).__init__('notification.NotificationPopUpViewer', 'NotificationPopUpViewer', '_getSettings', aspects=(

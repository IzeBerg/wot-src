...
import BattleReplay
BOOTCAMP_REPLAY_EVENTS = ('bootcampMarkers_onTriggerActivated', 'bootcampMarkers_onTriggerDeactivated',
                          'bootcampMarkers_showMarker', 'bootcampMarkers_hideMarker',
                          'bootcampHint_show', 'bootcampHint_hide', 'bootcampHint_complete',
                          'bootcampHint_close', 'bootcampHint_onHided')

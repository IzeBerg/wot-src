...
class _BwShop(namedtuple('_BwShop', (
 'hostUrl', 'backendHostUrl', 'isStorageEnabled'))):
...
class RankedBattlesConfig(namedtuple('RankedBattlesConfig', ('isEnabled', 'peripheryIDs', 'winnerRankChanges', 'loserRankChanges', 'minXP',
 ...
 'introPageUrl', 'seasonGapPageUrl', 'shopPageUrl'))):
    __slots__ = ()
...
class _EventProgressionConfig(namedtuple('_EventProgressionConfig', (
 'isEnabled',
 'isFrontLine',
 'isSteelHunter',
 'url',
...
_EventProgressionConfig.__new__.__defaults__ = (
 False, False, False, '', '', {}, [], [], '', '', 0)

class _EpicMetaGameConfig(namedtuple('_EpicMetaGameConfig', ['maxCombatReserveLevel', 'seasonData', 'metaLevel', 'rewards', 'defaultSlots'])):
...
class EpicGameConfig(namedtuple('EpicGameConfig', ('isEnabled', 'validVehicleLevels', 'seasons', 'cycleTimes',
 'peripheryIDs', 'primeTimes', 'reservesAvailableInFLMenu'))):
    __slots__ = ()

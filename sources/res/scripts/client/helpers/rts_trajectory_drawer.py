...
class _RTSTrajectoryDrawer(CallbackDelayer):
    ...
    def __getBotShotParams(self, targetPoint, vehicle):
        ...
        if descr.turret.gunPosition is None:
            ...
            shotTurretYaw, shotGunPitch = getShotAngles(descr, vehicle.matrix, (0,
                                                                                0), targetPoint, overrideGunPosition=descr.turret.gunPosition)
            ...
            return (
             startPos, startVelocity, isOutOfPitchLimits)
...
class _RTSTrajectoryDrawerRecorder(_RTSTrajectoryDrawer):
    ...
    def _setVisibility(self, visible):
        BattleReplay.g_replayCtrl.serializeCallbackData(CallbackDataNames.SET_TRAJECTORY_DRAWERS_VISIBILITY, (
         visible,))

...
class _ShotSoundEffectDesc(_BaseSoundEvent):
    ...
    def __init__(self, dataSection):
        ...
        if soundLoopSection is not None:
            ...
            self._stopSoundName = (
             (
              intern(soundLoopSection.readString('wwsoundStopPC', '')),),
             (
              intern(soundLoopSection.readString('wwsoundStopNPC', '')),))
...
class _SoundEffectDesc(_EffectDesc):
    __slots__ = ('_soundName', '_soundNames', '_switch_impact_surface', '_switch_shell_type',
                 '_dynamic', '_stopSyncVisual', '_impactNames', '_stopSoundNames',
                 '_soundLoop')
    ...
    def __init__(self, dataSection):
        ...
        if soundLoopSection is not None:
            ...
            self._stopSoundNames = (
             (
              intern(soundLoopSection.readString('wwsoundStopPC', stopSoundName)),),
             (
              intern(soundLoopSection.readString('wwsoundStopNPC', stopSoundName)),))
            duration = soundLoopSection.readFloat('duration')
            self._soundLoop = _DurationSoundLoop(duration)
        return

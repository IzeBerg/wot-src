...
DEFAULT_VALUES = {KEY_FILTERS: {STORE_TAB: 0, 
                 ...
                 BARRACKS_FILTER: {'nation': -1, 'role': 'None', 'tankType': 'None', 'location': 3, 'nationID': None}, ORDERS_FILTER: {'isSelected': False}, GUI_START_BEHAVIOR: {GuiSettingsBehavior.FREE_XP_INFO_DIALOG_SHOWED: False, GuiSettingsBehavior.RANKED_WELCOME_VIEW_SHOWED: False, 

        ...
        if currVersion != AccountSettings.version:
            ...
            if currVersion < 69:
                for key, section in _filterAccountSection(ads):
                    ...
                    if NY_OLD_COLLECTIONS_BY_YEAR_VISITED in keySettings.keys():
                        collections = {YEARS.YEAR18: False, YEARS.YEAR19: False, 
                           YEARS.YEAR20: False, 
                           YEARS.YEAR21: False}
            ...
            if currVersion < 70:
                for key, section in _filterAccountSection(ads):
                    ...
                    elif ADVENT_CALENDAR_POST_EVENT_NOTIFICATION_SHOWED in keySettings.keys():
                        keySettings.write(ADVENT_CALENDAR_POST_EVENT_NOTIFICATION_SHOWED, _pack(False))
                    elif ADVENT_CALENDAR_LAST_DAY_POPUP_SEEN in keySettings.keys():
                        keySettings.write(ADVENT_CALENDAR_LAST_DAY_POPUP_SEEN, _pack(0))
                    elif ADVENT_CALENDAR_V2_ANIMATION_LAST_SHOWN_DOOR in keySettings.keys():

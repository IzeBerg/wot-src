...
_CAN_APPLY_COIN_STATES = (
 MachineState.IDLE, MachineState.REWARD, MachineState.SPECIALREWARD, MachineState.ERROR)
...
class GiftMachineController(IGiftMachineController):
    ...
    def __canBuy(self):
        return self.__nyController.isEnabled() and NewYearAtmospherePresenter.isMaxLevel() and self.__celebrityController.isGuestQuestsCompletedFully((
         GuestsQuestsTokens.GUEST_A,
         GuestsQuestsTokens.GUEST_M))

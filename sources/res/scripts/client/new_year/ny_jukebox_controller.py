...
import typing, SoundGroups, math_utils
...
JUKEBOX_MUSIC = {_JukeboxConstants.PLAYLIST_A: [ ('hangar_newyear_music_jukebox_playlist_a_song_{:02d}').format(n) for n in xrange(1, 9) ], _JukeboxConstants.PLAYLIST_B: [ ('hangar_newyear_music_jukebox_playlist_b_song_{:02d}').format(n) for n in xrange(1, 9) ], _JukeboxConstants.PLAYLIST_C: [ ('hangar_newyear_music_jukebox_playlist_c_song_{:02d}').format(n) for n in xrange(1, 6) ]}

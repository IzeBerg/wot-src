...
class NewYear24ToyInfo(_NewYearBackportToyInfo):
    ...
    def getEmptyPassepartout(self):
        if self.isMega():
            return R.images.gui.maps.icons.newYear.albums.c_2024.passepartout.mega_empty()
        return R.images.gui.maps.icons.newYear.albums.c_2024.passepartout.empty()

    def getPassepartout(self):
        passepartout = random.choice(_PASSEPARTOUTS)
        if self.isMega():
            megaPassepartout = _getMegaPassepartoutName(passepartout)
            return R.images.gui.maps.icons.newYear.albums.c_2024.passepartout.dyn(megaPassepartout)()
        return R.images.gui.maps.icons.newYear.albums.c_2024.passepartout.dyn(passepartout)()

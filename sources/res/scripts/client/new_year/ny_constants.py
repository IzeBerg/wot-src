...
class AdditionalCameraObject(CONST_CONTAINER):
    ...
    CELEBRITY_GROUP = (
     CHALLENGE, CELEBRITY_A, CELEBRITY_M, CELEBRITY_CAT, CELEBRITY, CELEBRITY_D)
...
UPGRADABLE_OBJECTS = (
 CustomizationObjects.FIR, CustomizationObjects.FAIR, CustomizationObjects.INSTALLATION)
GLADE_OBJECTS = (
...
class NyWidgetTopMenu(object):
    ...
    ALL_PLAYER_HANGAR = (
     GLADE, FRIENDS, CHALLENGE, MARKETPLACE, GIFT_MACHINE, REWARDS, INFO)
...
class NyTabBarMainView(object):
    ...
    ALL = (
     TOWN, FIR, FAIR, INSTALLATION, RESOURCES)
...
class NyTabBarMarketplaceView(object):
    ...
    ALL = (
     NY18_CATEGORY, NY19_CATEGORY, NY20_CATEGORY, NY21_CATEGORY, NY22_CATEGORY)
...
class NyTabBarChallengeView(object):
    ...
    ALL = (
     TOURNAMENT, GUEST_A, GUEST_M, GUEST_CAT, HEADQUARTERS, GUEST_D)

...
class FriendListDataKeys(object):
    BEST_FRIENDS_MAX_COUNT = 'best_friends_max_count'


class BestFriendsDataKeys(object):
    SPA_ID = 'spa_id'
    RESOURCES_COOLDOWN = 'resources_gather_cooldown'
    IS_REMOVED = 'removed'
...
class FriendsDataKeys(object):
    SPA_ID = 'spa_id'
    NAME = 'name'
    ATM_POINTS = 'atmosphere_points'
    ATM_LEVEL = 'atmosphere_level'
    HANGAR_NAME = 'hangar_id'
    HANGAR_VISITS = 'hangar_visits'
    HANGAR_VISITS_BY_FRIEND = 'hangar_visits_by_friend'
    RESOURCES_GATHERED_BY_FRIEND = 'resources_gathered_by_friend'
    HIS_BEST_FRIEND = 'his_best'
...
class FriendHangarDataKeys(object):
    ...
    ATM_LEVEL = 'atmosphere_level'
    RESOURCES = 'resources'
    RESOURCES_COOLDOWN = 'resources_cooldown'
    TOKENS = 'tokens'
...
class FriendServiceController(IFriendServiceController, IGlobalListener):
    ...
    def getFriendState(self):
        if not self.__friendHangarSpaId:
            ...
            return copy(self.__friendHangarState)
    ...
    def getFriendTokens(self):
        if not self.__friendHangarSpaId:
            return {}
        return self.__friendHangarState.get(FriendHangarDataKeys.TOKENS, {})

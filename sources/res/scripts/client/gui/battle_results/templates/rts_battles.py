...
RTS_TANKMAN_VEHICLE_STATS_BLOCK_VO_META = base.PropertyMeta((
 ('shots', 0, 'shots'),
 (
...
RTS1x7_TANKMAN_VEHICLE_STATS_BLOCK_VO_META = base.PropertyMeta((
 (
  'shotsByTanksSupplies', style.SlashedValuesBlock('shotsByTanksSupplies'), 'shotsByTanksSupplies'),
 (
 ...
 (
  'damageDealtByTanksSupplies', style.SlashedValuesBlock('damageDealtByTanksSupplies'),
  'damageDealtByTanksSupplies'),
 (
 ...
 ('explosionHitsReceived', 0, 'explosionHitsReceived'),
 (
  'damageBlockedByTanksSupplies', style.SlashedValuesBlock('damageBlockedByTanksSupplies'),
  'damageBlockedByTanksSupplies'),
 (
  'teamHitsDamage', style.RedSlashedValuesBlock('teamHitsDamage'), 'teamHitsDamage'),
 ('spottedStrategistItems', 0, 'spotted'),
 (
...
RTS1x1_VEHICLE_STATS_BLOCK_VO_META = base.PropertyMeta((
 (
  'shotsByTanksSupplies', style.SlashedValuesBlock('shotsByTanksSupplies'), 'shotsByTanksSupplies'),
 (
  'hitsByTanks', style.SlashedValuesBlock('hitsByTanks'), 'hitsByTanks'),
...
RTS_COMMANDER_ALL_VEHICLES_STATS_BLOCK_VO_META = base.PropertyMeta((
 ('shots', 0, 'shots'),
 (
  'hits', style.SlashedValuesBlock('hits'), 'hits'),
 ('explosionHits', 0, 'explosionHits'),
...
RTS_SUPPLY_STATS_BLOCK_VO_META = base.PropertyMeta((
 ('shotsBySupplies', 0, 'shotsBySupplies'),
 (
  'hits', style.SlashedValuesBlock('hits'), 'hits'),
 ...
 (
  'damagedKilledTanksBySupplies', style.SlashedValuesBlock('damagedKilledTanksBySupplies'),
  'damagedKilledTanksBySupplies')))
RTS_SUPPLY_STATS_BLOCK_VO_META.bind(rts_battles.RTSSupplyStatValuesBlock)
RTS_BARRICADES_SUPPLY_STATS_BLOCK_VO_META = base.PropertyMeta((
 ('totalDamagedByBarricades', 0, 'totalDamagedByBarricades'),
 ('killedTanksByBarricades', 0, 'killedTanksByBarricades')))
RTS_BARRICADES_SUPPLY_STATS_BLOCK_VO_META.bind(rts_battles.RTSBarricadesSupplyStatValuesBlock)
RTS_WATCHTOWER_SUPPLY_STATS_BLOCK_VO_META = base.PropertyMeta((
 ('spottedEnemiesByWatchtowers', 0, 'spottedEnemiesByWatchtowers'),
 ('damagedByWatchtowers', 0, 'damagedByWatchtowers')))
RTS_WATCHTOWER_SUPPLY_STATS_BLOCK_VO_META.bind(rts_battles.RTSWatchTowerSupplyStatValuesBlock)
RTS_VEHICLE_TEAM_ITEM_VO_META = regular.TEAM_ITEM_VO_META.replace((
 'statValues', rts_battles.AllTankmansVehicleStatValuesBlock(base.ListMeta(), 'statValues'), 'statValues'))
RTS_VEHICLE_TEAM_ITEM_VO_META.bind(rts_battles.RTSVehicleStatsBlock)
RTS_SUPPLY_TEAM_ITEM_VO_META = regular.TEAM_ITEM_VO_META.replace((
 'statValues', rts_battles.RTSAllSupplyStatValuesBlock(base.ListMeta(), 'statValues'), 'statValues'))

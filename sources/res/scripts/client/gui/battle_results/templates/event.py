...
EVENT_TOTAL_VO_META = base.DictMeta({'common': {}, 'captureStatus': '', 
   'tankType': '', 
   'tankName': '', 
   'players': [], 'matterTooltip': {}, 'damageTooltip': {}, 'killsTooltip': {}, 'blockedTooltip': {}, 'keysTooltip': {}, 'medalsTooltip': {}, 'platoonTooltip': {}, 'tankTooltip': {}, 'nameTooltip': {}, 'background': '', 
   'time': '', 
   'hw21Rewards': {}, 'teamCombinedStats': {}, 'tankIcon': '', 
   'isWin': False, 
   'difficultyString': '', 
   'difficultyIcon': '', 
   'playerName': '', 
...
_EVENT_PLAYER_INFO_VO_META_TUPLE = regular.TEAM_ITEM_VO_META_TUPLE + (
 ('matter', 0, 'matter'),

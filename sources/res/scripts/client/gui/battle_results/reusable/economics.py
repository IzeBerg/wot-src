...
class _EconomicsRecordsChains(object):
    __slots__ = ('_baseCredits', '_premiumCredits', '_premiumPlusCredits', '_goldRecords',
                 '_additionalRecords', '_baseXP', '_premiumXP', '_premiumPlusXP',
                 '_baseXPAdd', '_premiumXPAdd', '_premiumPlusXPAdd', '_baseFreeXP',
                 '_premiumFreeXP', '_premiumPlusFreeXP', '_baseFreeXPAdd', '_premiumFreeXPAdd',
                 '_premiumPlusFreeXPAdd', '_crystal', '_crystalDetails')
...
class EconomicsInfo(shared.UnpackedInfo):
    __slots__ = ('__isAddXPBonusApplied', '__premiumMask', '__premiumState', '__premiumPlusState',
                 '_economicsRecords')
    ...
    def canUpgradeToPremium(self, arenaBonusType):
        return self.__premiumState & PremiumState.BUY_ENABLED > 0 and self.__premiumState & PremiumState.HAS_ALREADY == 0 and not self.isPostBattlePremium and arenaBonusType in (ARENA_BONUS_TYPE.REGULAR, ARENA_BONUS_TYPE.EPIC_RANDOM,
         ARENA_BONUS_TYPE.EPIC_BATTLE)

    def canUpgradeToPremiumPlus(self, arenaBonusType):
        return self.__premiumPlusState & PremiumState.BUY_ENABLED > 0 and self.__premiumPlusState & PremiumState.HAS_ALREADY == 0 and not self.isPostBattlePremiumPlus and arenaBonusType in (ARENA_BONUS_TYPE.REGULAR, ARENA_BONUS_TYPE.EPIC_RANDOM,
         ARENA_BONUS_TYPE.EPIC_BATTLE)

...
def _getCreditsData(getter, reusable):
    ...
    fields = (
     getter.credits.getEarnedCredits(),
...
def _getCrystalsData(getter, reusable):
    ...
    if crystalsRecords is None:
        ...
        fields = (
         getter.crystals.getEarnedCrystals(),
        ...
        return (
         fields, strIDs, crystalRecords)


def _getXPData(getter, reusable):
    xpRecords = getXpRecords(reusable)
    fields = (
     getter.xp.getEarnedXP(xpRecords.main.xp.getRecord('isHighScope')),

...
class EfficiencyGetter(object):
    ...
    def _getAssistBaseValues(cls, playerResult):
        ...
        if damageAssisted > 0:
            ...
            return (
             damageAssistedValues, damageAssistedNames, damageAssisted)
        else:
            return (
             None, None, damageAssisted)
    ...
    def _getStunLabels(cls):
        return (R.strings.battle_results.common.tooltip.stun.part1(),
         R.strings.battle_results.common.tooltip.stun.part2(),
         R.strings.battle_results.common.tooltip.stun.part3())

    @classmethod
    def _getAssistLabels(cls):
        return (R.strings.battle_results.common.tooltip.assist.part1(),
    ...
    def _getArmorLabels(cls):
        return (R.strings.battle_results.common.tooltip.armor.part1(),
    ...
    def _getDamageLabels(cls):
        return (R.strings.battle_results.common.tooltip.damage.part1(),
...
class TotalEfficiencyGetter(EfficiencyGetter):
    ...
    @classmethod
    def _getStunLabels(cls):
        return (R.strings.postbattle_screen.tooltip.stun.totalDamage(),
         R.strings.postbattle_screen.tooltip.stun.totalCount(),
...
def _getCaptureBaseValues(result):
    ...
    if capturePoints > 0:
        ...
        return (
         captureValues, captureNames, capturePoints)
    else:
        return (
         None, None, capturePoints)
...
def _getDefenceBaseValues(result):
    ...
    if defencePoints > 0:
        ...
        return (
         defenceValues, defenceNames, defencePoints)
    else:
        return (
         None, None, defencePoints)
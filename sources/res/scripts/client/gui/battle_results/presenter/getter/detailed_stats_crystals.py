...
DetailedStatsCrystalFields = namedtuple('crystalFields', ('earned', 'expenses', 'earnings',
                                                          'total'))
...
def _getEarnedCrystal():
    return CrystalsField(blockIdx=_CrystalBlockIndexes.EARNED, stringID=_CRYSTAL_STRINGS.earned(), tooltipString=_CRYSTAL_STRINGS.earned.descr(), tags=(
     DetailsRecordModel.EARNED,), recordItems=('originalCrystal', ), isShown=True)
...
def _getTotalCrystalExpenses():
    return CrystalsField(blockIdx=_CrystalExpensesBlockIndexes.TOTAL_EXPENSES, stringID=_CRYSTAL_STRINGS.expenses.total(), tooltipString=_CRYSTAL_STRINGS.expenses.total.descr(), tags=(
     DetailsRecordModel.SUBGROUP_TOTAL,), recordItems=('autoBoostersCrystal', ), isShown=True)
...
def _getTotalCrystalEarnings():
    return CrystalsField(blockIdx=_CrystalEarningsBlockIndexes.TOTAL_EARNED, stringID=_CRYSTAL_STRINGS.totalEarnings(), tooltipString=_CRYSTAL_STRINGS.totalEarnings.descr(), tags=(
     DetailsRecordModel.SUBGROUP_TOTAL,), recordItems=('crystal', ), isShown=True)


def _getTotalCrystal():
    return CrystalsTotalField(blockIdx=_CrystalBlockIndexes.TOTAL, stringID=_CRYSTAL_STRINGS.total(), tooltipString=_CRYSTAL_STRINGS.total.descr(), tags=(
     DetailsRecordModel.TOTAL,), recordItems=('crystal', ), recordSubtractItems=('autoBoostersCrystal', ), isShown=True)
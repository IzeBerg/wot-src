...
DetailedStatsXPFields = namedtuple('xpFields', ('earned', 'earnings', 'bonusesTotal',
...
DetailedStatsXPBonuses = namedtuple('xpBonuses', ('achievementXP', 'premiumXP', 'igrXP',
                                                  'squadXP', 'dailyXP', 'additionalXP',
                                                  'referralXP', 'premiumVehicleXP',
                                                  'orderXP', 'boosterXP', 'orderFreeXP',
                                                  'rankXP', 'eventsXP'))
DetailedStatsXPFines = namedtuple('xpFines', ('aogasXPFactor', 'deserterXPPenalty',
                                              'suicideXPPenalty', 'afkXPPenalty',
                                              'friendlyFireXPPenalty', 'friendlyFireSPGXPPenalty'))
...
def _getEarnedXP():
    return DetailedStatsEarnedXP(earned=XPEarnedField(blockIdx=_XPBlockIndexes.EARNED, stringID=_XP_STRINGS.earned(), tooltipString=_XP_STRINGS.earned.descr(), tags=(
     DetailsRecordModel.EARNED,), xpRecordItems=('originalXP', ), freeXPRecordItems=('originalFreeXP', ), xpSubtractItems=('achievementXP', ), freeXPSubtractItems=('achievementFreeXP', ), isShown=True), earnedRecord=XPEarnedField(blockIdx=_XPBlockIndexes.EARNED, stringID=_XP_STRINGS.earned(), tooltipString=_XP_STRINGS.earned.descr(), tags=(
     DetailsRecordModel.EARNED_RECORD, DetailsRecordModel.EARNED), xpRecordItems=('originalXP', ), freeXPRecordItems=('originalFreeXP', ), xpSubtractItems=('achievementXP', ), freeXPSubtractItems=('achievementFreeXP', ), isShown=True))


def _getXPTotal():
    return XPEarningsField(blockIdx=_XPBlockIndexes.TOTAL, stringID=_XP_STRINGS.total(), tooltipString=_XP_STRINGS.total.descr(), tags=(
     DetailsRecordModel.TOTAL,), xpRecordItems=('xp', ), freeXPRecordItems=('freeXP', ), isShown=True)


def _getXPBonusesTotal():
    return XPEarnedField(blockIdx=_XPBlockIndexes.BONUSES, stringID=_XP_TOOLTIP_STRING.bonuses(), tags=(
     DetailsRecordModel.EARNED_RECORD,), xpRecordItems=('xp', 'achievementXP'), freeXPRecordItems=('freeXP',
                                                                                                   'achievementFreeXP'), xpSubtractItems=('originalXP', ), freeXPSubtractItems=('originalFreeXP', ), isShown=True)
...
def _getAlternativeTotalXP():
    return XPEarningsField(blockIdx=_XPBlockIndexes.ALTERNATIVE, stringID=_XP_TOOLTIP_STRING.alternativeTotal.xp(), tags=(
     DetailsRecordModel.ALTERNATIVE_TOTAL,), xpRecordItems=('xp', ), freeXPRecordItems=('freeXP', ), isShown=True)
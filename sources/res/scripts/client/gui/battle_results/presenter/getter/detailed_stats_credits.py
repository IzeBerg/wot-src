...
DetailedStatsCreditFields = namedtuple('creditFields', ('earned', 'expenses', 'earnings',
                                                        'total', 'piggyBank', 'alternativeTotal'))
DetailedStatsCreditExpenses = namedtuple('creditFields', ('autoRepair', 'autoLoad',
                                                          'autoEquip', 'autoBoosters'))
DetailedStatsCreditEarnings = namedtuple('creditEarnings', ('bonuses', 'totalBonuses',
                                                            'fines'))
DetailedStatsCreditBonuses = namedtuple('creditBonuses', ('achievementCredits', 'eventCredits',
                                                          'contributionCredits',
                                                          'premiumCredits', 'squadCredits',
                                                          'orderCredits', 'referralCredits',
                                                          'boosterCredits'))
DetailedStatsCreditFines = namedtuple('creditFines', ('aogasCreditsFactor', 'deserterCreditsPenalty',
                                                      'suicideCreditsPenalty', 'afkCreditsPenalty',
                                                      'friendlyFireCreditsPenalty',
                                                      'friendlyFireSPGCreditsPenalty'))
...
def _getEarnedCredits():
    return CreditsEarnedField(blockIdx=_CreditIndexes.EARNED, stringID=_CREDIT_STRINGS.earned(), tooltipString=_CREDIT_STRINGS.earned.descr(), tags=(
     DetailsRecordModel.EARNED,), recordItems=('originalCredits', 'originalCreditsToDraw'), recordSubtractItems=('achievementCredits', ), isShown=True)
...
def _getTotalCreditExpenses():
    return CreditEarningsField(blockIdx=_CreditExpensesBlockIndexes.TOTAL_EXPENSES, stringID=_CREDIT_STRINGS.expenses.total(), tooltipString=_CREDIT_STRINGS.expenses.total.descr(), tags=(
     DetailsRecordModel.SUBGROUP_TOTAL,), recordItems=('autoRepairCost', 'autoLoadCredits',
                                                       'autoEquipCredits', 'autoBoostersCredits'), isShown=True)
...
def _getCreditFines():
    return DetailedStatsCreditFines(aogasCreditsFactor=CreditEarningsField(blockIdx=_CreditEarningsBlockIndexes.FINES, stringID=_CREDIT_STRINGS.fines.aogasFactor(), tooltipString=_CREDIT_STRINGS.fines.aogasFactor.descr(), recordItems=('aogasFactor10', )), deserterCreditsPenalty=CreditEarningsField(blockIdx=_CreditEarningsBlockIndexes.FINES, stringID=_CREDIT_STRINGS.fines.deserter(), tooltipString=_CREDIT_STRINGS.fines.deserter.descr(), recordItems=('fairplayFactor10', )), suicideCreditsPenalty=CreditEarningsField(blockIdx=_CreditEarningsBlockIndexes.FINES, stringID=_CREDIT_STRINGS.fines.suicide(), tooltipString=_CREDIT_STRINGS.fines.suicide.descr(), recordItems=('fairplayFactor10', )), afkCreditsPenalty=CreditEarningsField(blockIdx=_CreditEarningsBlockIndexes.FINES, stringID=_CREDIT_STRINGS.fines.afk(), tooltipString=_CREDIT_STRINGS.fines.afk.descr(), recordItems=('fairplayFactor10', )), friendlyFireCreditsPenalty=CreditEarningsField(blockIdx=_CreditEarningsBlockIndexes.FINES, stringID=_CREDIT_STRINGS.fines.friendlyFirePenalty(), tooltipString=_CREDIT_STRINGS.fines.friendlyFirePenalty.descr(), recordItems=('originalCreditsPenalty',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    'originalCreditsContributionOutSquad')), friendlyFireSPGCreditsPenalty=CreditEarningsField(blockIdx=_CreditEarningsBlockIndexes.FINES, stringID=_CREDIT_STRINGS.fines.friendlyFireSPGPenalty(), tooltipString=_CREDIT_STRINGS.fines.friendlyFireSPGPenalty.descr(), recordItems=('originalCreditsPenalty',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     'originalCreditsContributionOut',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     'originalCreditsPenaltySquad',
...
def _getTotalCreditEarnings():
    return CreditEarningsField(blockIdx=_CreditEarningsBlockIndexes.TOTAL_EARNED, stringID=_CREDIT_STRINGS.totalEarnings(), tooltipString=_CREDIT_STRINGS.totalEarnings.descr(), tags=(
     DetailsRecordModel.SUBGROUP_TOTAL,), recordItems=('credits', 'originalCreditsToDraw',
                                                       'originalCreditsToDrawSquad'), isShown=True)


def _getCreditsBonusesTotal():
    return CreditsEarnedField(blockIdx=_CreditEarningsBlockIndexes.TOTAL_EARNED, stringID=_CREDIT_TOOLTIP_STRING.bonuses(), recordItems=('credits',
                                                                                                                                         'achievementCredits'), recordSubtractItems=('originalCredits',
                                                                                                                                                                                     'originalCreditsToDraw'), isShown=True)


def _getTotalCredits():
    return CreditsTotalField(blockIdx=_CreditIndexes.TOTAL, stringID=_CREDIT_STRINGS.total(), tooltipString=_CREDIT_STRINGS.total.descr(), tags=(
     DetailsRecordModel.TOTAL,), recordItems=('credits', 'originalCreditsToDraw', 'originalCreditsToDrawSquad'), additionalRecordItems=('autoRepairCost',
                                                                                                                                        'autoLoadCredits',
                                                                                                                                        'autoEquipCredits',
                                                                                                                                        'autoBoostersCredits'), isShown=True)
...
def _getAlternativeTotalCredits():
    return CreditsTotalField(blockIdx=_CreditIndexes.ALTERNATIVE, stringID=_CREDIT_TOOLTIP_STRING.alternativeTotal.credits(), tags=(
     DetailsRecordModel.ALTERNATIVE_TOTAL,), recordItems=('credits', 'originalCreditsToDraw',
                                                          'originalCreditsToDrawSquad'), additionalRecordItems=('autoRepairCost',
                                                                                                                'autoLoadCredits',
                                                                                                                'autoEquipCredits',
                                                                                                                'autoBoostersCredits'))
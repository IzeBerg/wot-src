...
class _CreditsGetter(object):
    ...
    def getCreditEarnings(self, reusable):
        creditEarningsFields = self.__detailedStatsCredits.earnings.detailed.bonuses + _processFinesFields(reusable, *self.__detailedStatsCredits.earnings.detailed.fines) + (
...
class _XPGetter(object):
    ...
    def getXP(self, reusable, isRecord):
        ...
        xpFields = (
         earned,) + self.__detailedStatsXP.earnings.bonuses + _processFinesFields(reusable, *self.__detailedStatsXP.earnings.fines) + (
...
class PostbattleFieldsGetter(object):
    __slots__ = ('__detailedStatsCredits', '__detailedStatsCrystals', '__detailedStatsXP',
                 '__teamStats', '__premiumBenefits')

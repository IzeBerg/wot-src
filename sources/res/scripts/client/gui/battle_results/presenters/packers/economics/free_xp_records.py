...
IGR_BONUS_FREE_XP = CurrencyRecord(recordNames=('igrXPFactor10', ), subtractRecords=(), valueExtractor=getIncreasingMainFactor, capsToBeChecked=None, label=_STR_PATH.igrBonus.simpleLabel, modifiers=(
 ValueModifiers.MUL,), showZeroValue=False, currencyType=CurrenciesConstants.FREE_XP)
DAILY_BONUS_FREE_XP = CurrencyRecord(recordNames=('dailyXPFactor10', ), subtractRecords=(), valueExtractor=getIncreasingMainFactor, capsToBeChecked={
 _CAPS.DAILY_MULTIPLIED_XP}, label=_STR_PATH.firstWin, modifiers=(
 ValueModifiers.MUL,), showZeroValue=False, currencyType=CurrenciesConstants.MULTY_FREE_XP)
ADDITIONAL_BONUS_FREE_XP = CurrencyRecord(recordNames=('additionalXPFactor10', ), subtractRecords=(), valueExtractor=getIncreasingMainFactor, capsToBeChecked={

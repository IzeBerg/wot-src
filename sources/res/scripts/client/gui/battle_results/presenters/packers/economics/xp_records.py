...
IGR_BONUS_XP = CurrencyRecord(recordNames=('igrXPFactor10', ), subtractRecords=(), valueExtractor=getIncreasingMainFactor, capsToBeChecked=None, label=_STR_PATH.igrBonus.simpleLabel, modifiers=(
 ValueModifiers.MUL,), showZeroValue=False, currencyType=CurrenciesConstants.XP_COST)
DAILY_BONUS_XP = CurrencyRecord(recordNames=('dailyXPFactor10', ), subtractRecords=(), valueExtractor=getIncreasingMainFactor, capsToBeChecked={
 _CAPS.DAILY_MULTIPLIED_XP}, label=_STR_PATH.firstWin, modifiers=(
 ValueModifiers.MUL,), showZeroValue=False, currencyType=CurrenciesConstants.MULTY_XP)
ADDITIONAL_BONUS_XP = CurrencyRecord(recordNames=('additionalXPFactor10', ), subtractRecords=(), valueExtractor=getIncreasingMainFactor, capsToBeChecked={
 _CAPS.ADDITIONAL_XP_POSTBATTLE}, label=_STR_PATH.additionalBonus, modifiers=(
 ValueModifiers.MUL,), showZeroValue=False, currencyType=CurrenciesConstants.XP_COST)
...
PREMIUM_VEHICLE_XP = CurrencyRecord(recordNames=('premiumVehicleXPFactor100', ), subtractRecords=(), valueExtractor=getMainValue, capsToBeChecked={
 _CAPS.PREM_VEHICLE}, label=_STR_PATH.premiumVehicleXP, modifiers=(), showZeroValue=False, currencyType=CurrenciesConstants.XP_COST)
SQUAD_BONUS_XP = CurrencyRecord(recordNames=('squadXPFactor100', ), subtractRecords=(), valueExtractor=getSquadXp, capsToBeChecked={
 _CAPS.SQUAD_XP}, label=_STR_PATH.squadXP, modifiers=(), showZeroValue=False, currencyType=CurrenciesConstants.XP_COST)
SQUAD_PENALTY_XP = CurrencyRecord(recordNames=('squadXPFactor100', ), subtractRecords=(), valueExtractor=getSquadXpPenalty, capsToBeChecked={
 _CAPS.SQUAD_XP}, label=_STR_PATH.squadXPPenalty, modifiers=(), showZeroValue=False, currencyType=CurrenciesConstants.XP_COST)

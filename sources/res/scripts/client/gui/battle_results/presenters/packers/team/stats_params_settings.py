...
_Parameter = namedtuple('_Parameter', ('stringId', 'fields', 'valueType', 'conditions',
                                       'extractor', 'details'))
_STR_PATH = R.strings.battle_results.team.stats.parameter
REGULAR_PARAMETERS = {RegularParamType.SHOTS: _Parameter(stringId=_STR_PATH.shots, fields=('shots', ), valueType=ValueType.INTEGER, conditions=None, extractor=getStatsParamValue, details=(
   ...
   RegularParamType.DAMAGEDEALT: _Parameter(stringId=_STR_PATH.damageDealt, fields=('damageDealt', ), valueType=ValueType.INTEGER, conditions=None, extractor=getStatsParamValue, details=(
   ...
   RegularParamType.DIRECTHITSRECEIVED: _Parameter(stringId=_STR_PATH.directHitsReceived, fields=('directHitsReceived', ), valueType=ValueType.INTEGER, conditions=None, extractor=getStatsParamValue, details=(
   ...
   RegularParamType.DAMAGEASSISTED: _Parameter(stringId=_STR_PATH.damageAssisted, fields=('damageAssisted', ), valueType=ValueType.INTEGER, conditions=(
                                   isNotPersonalBattleResult,), extractor=getStatsParamValue, details=()), 
   RegularParamType.DAMAGEASSISTEDSELF: _Parameter(stringId=_STR_PATH.damageAssistedSelf, fields=('damageAssisted', ), valueType=ValueType.INTEGER, conditions=(
                                       isPersonalBattleResult,), extractor=getStatsParamValue, details=()), 
   RegularParamType.STUNDURATION: _Parameter(stringId=_STR_PATH.stunDuration, fields=('stunDuration', ), valueType=ValueType.FLOAT, conditions=(
                                 hasStunEfficiency,), extractor=getStatsParamValue, details=()), 
   RegularParamType.DAMAGEASSISTEDSTUN: _Parameter(stringId=_STR_PATH.damageAssistedStun, fields=('damageAssistedStun', ), valueType=ValueType.INTEGER, conditions=(
                                       hasStunEfficiency, isNotPersonalBattleResult), extractor=getStatsParamValue, details=()), 
   RegularParamType.DAMAGEASSISTEDSTUNSELF: _Parameter(stringId=_STR_PATH.damageAssistedStunSelf, fields=('damageAssistedStun', ), valueType=ValueType.INTEGER, conditions=(
                                           hasStunEfficiency, isPersonalBattleResult), extractor=getStatsParamValue, details=()), 
   RegularParamType.STUNNUM: _Parameter(stringId=_STR_PATH.stunNum, fields=('stunNum', ), valueType=ValueType.INTEGER, conditions=(
                            hasStunEfficiency,), extractor=getStatsParamValue, details=()), 

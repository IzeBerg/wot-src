...
class DamageDetailsBlock(_DetailsBlock):
    ...
    def setRecord(self, result, reusable):
        ...
        if damageDealt > 0:
            self._isEmpty = False
            labels = (
             R.strings.battle_results.common.tooltip.damage.part1(),
...
class AssistDetailsBlock(_DetailsBlock):
    ...
    def setRecord(self, result, reusable):
        ...
        if damageAssisted > 0:
            self._isEmpty = False
            self.damageAssistedValues, self.damageAssistedNames = getAssistBlockDetails(damageAssistedRadio, damageAssistedTrack, damageAssisted, (
    ...
    def setRecord(self, result, _):
        ...
        if count > 0 or assisted > 0 or duration > 0:
            ...
            self.stunValues, self.stunNames = getStunBlockDetails(assisted, count, duration, (
             R.strings.battle_results.common.tooltip.stun.part1(),

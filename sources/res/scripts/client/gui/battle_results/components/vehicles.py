...
class RegularVehicleStatsBlock(base.StatsBlock):
    __slots__ = ('_isObserver', 'achievements', 'achievementsCount', 'vehicleState',
                 ...
                 'realKills', 'xp', 'rtsPoints', 'damageDealt', 'vehicles', 'vehicleType',
                 'playerID', 'player', 'statValues', 'fortResource', 'squadIndex',
                 'isPersonalSquad', 'xpSort', 'intCD', 'rank', 'rankIcon', 'suffixBadgeIcon',
                 'isKilledByTeamKiller', 'playerRank', 'respawns', 'badge', 'hasSelectedBadge',
                 'suffixBadgeStripIcon', '_team')
...
class EpicVehicleStatValuesBlock(base.StatsBlock):
    __slots__ = ('_team', '_isPersonal', '_filters', 'shots', 'hits', 'explosionHits',
                 'damageDealt', 'sniperDamageDealt', 'destructiblesDamageDealt',

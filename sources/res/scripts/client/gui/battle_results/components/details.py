...
class _GainResourceInBattleItem(base.StatsItem):
    ...
    def _convert(self, value, reusable):
        ...
        baseRecords, premiumRecords = first(operator.methodcaller(self.__method)(economics), default=(None,
                                                                                                      None))[:2]
        resource = 0
...
class PremiumBonusDetailsBlock(base.StatsBlock):
    __slots__ = ('description', 'bonusLeft', 'xpValue', 'statusBonusLabel', 'statusBonusTooltip',
                 ...
                 '__xpFactor', '__vehicleCD', '__isActivePremiumPlus', '__applyAdditionalXPCount')

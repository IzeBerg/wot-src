import httplib, logging, json, urllib
from functools import partial
import BigWorld, adisp, async
...
class Request(object):
    __slots__ = ('isCanceled', 'requestId', 'url', 'headers', 'method', 'queryParams',
                 'postData', 'auth', 'proofOfWorkURL')

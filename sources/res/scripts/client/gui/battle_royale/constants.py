...
BR_EQUIPMENTS_WITH_MESSAGES = frozenset([
 SteelHunterEquipmentNames.TRAP_POINT, SteelHunterEquipmentNames.AFTER_BURNING,
 SteelHunterEquipmentNames.REGENERATION_KIT, SteelHunterEquipmentNames.SELF_BUFF,
 SteelHunterEquipmentNames.HEAL_POINT, SteelHunterEquipmentNames.LARGE_REPAIRKIT,
 SteelHunterEquipmentNames.BERSERKER, SteelHunterEquipmentNames.MINE_FIELD,
 SteelHunterEquipmentNames.REPAIR_POINT, SteelHunterEquipmentNames.BOMBER,
 SteelHunterEquipmentNames.KAMIKAZE, SteelHunterEquipmentNames.SMOKE,
 SteelHunterEquipmentNames.SMOKE_WITH_DAMAGE, SteelHunterEquipmentNames.ARCADE_SMOKE])

    ...
    def _initVehiclSettings(self):
        ...
        if vehiclesSettings:
            for vehicle in vehiclesSettings.values():
                ...
                self._vehiclesSettings[cd] = {'markerHeightFactor': vehicle['markerHeightFactor'].asFloat, 'markerStyleId': vehicle['markerStyleId'].asInt, 
                   ...
                   'id': cd}
                self._map[vehicle['vehicleTypeID'].asInt] = [vehicle['questId'].asString,
                 vehicle['commanderId'].asString]

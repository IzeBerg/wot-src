...
class VEHICLE_VIEW_STATE(object):
    ...
    WT_BOMB_CAPTURE = 4503599627370496
    WT_BOMB_CARRY = 9007199254740992
    WT_BOMB_DEPLOY = 18014398509481984
    WT_BOMB_ABSORB = 36028797018963968
    CLIENT_ONLY = (
...
MARKER_CRITICAL_HIT_STATES = {
 FEEDBACK_EVENT_ID.VEHICLE_CRITICAL_HIT, FEEDBACK_EVENT_ID.VEHICLE_CRITICAL_HIT_DAMAGE,
 FEEDBACK_EVENT_ID.VEHICLE_CRITICAL_HIT_CHASSIS,
 FEEDBACK_EVENT_ID.VEHICLE_CRITICAL_HIT_CHASSIS_PIERCED}

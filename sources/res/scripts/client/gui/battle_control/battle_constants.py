...
class VEHICLE_VIEW_STATE(object):
    ...
    WT_BOMB_CAPTURE = 35184372088832
    WT_BOMB_CARRY = 70368744177664
    WT_BOMB_DEPLOY = 140737488355328
    WT_BOMB_ABSORB = 281474976710656
    CLIENT_ONLY = (
     AUTO_ROTATION, CRUISE_MODE)


VEHICLE_DEVICES = ('engine', 'ammoBay', 'gun', 'turretRotator', 'leftTrack', 'rightTrack',

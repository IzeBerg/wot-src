...
class VEHICLE_VIEW_STATE(object):
    ...
    FIRE_WITH_MESSAGE = 35184372088832
    LOSE_SOULS_IN_AURA = 70368744177664
    CAN_BE_DAMAGED = 140737488355328
    COLLECTOR_STATUS = 281474976710656
    CLIENT_ONLY = (
...
MARKER_HIT_STATE = {FEEDBACK_EVENT_ID.VEHICLE_HIT: (
   ...
   FEEDBACK_EVENT_ID.VEHICLE_INVULNERABLE: (
                                          'hit_invulnerable', 'hit_blocked', R.strings.ingame_gui.hitMarker.boss())}

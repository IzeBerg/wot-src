...
_PLAYER_FULL_NAME_FORMATS = {_FORMAT_MASK.VEHICLE: '{2:>s}', 
   _FORMAT_MASK.NAME_VEHICLE: '{0:>s} ({2:>s})', 
   _FORMAT_MASK.NAME_CLAN: '{0:>s}[{1:>s}]', 
   _FORMAT_MASK.NAME_VEH_CLAN: '{0:>s}[{1:>s}] ({2:>s})', 
   _FORMAT_MASK.NAME_REGION: '{0:>s} {3:>s}', 
   _FORMAT_MASK.NAME_VEH_REGION: '{0:>s} {3:>s} ({2:>s})', 
   _FORMAT_MASK.NAME_REG_CLAN: '{0:>s}[{1:>s}] {3:>s}', 

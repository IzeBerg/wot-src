...
import BattleReplay, BigWorld, SoundGroups, Event
...
class BattleTeamsBasesController(ITeamsBasesController, ViewComponentsController):
    ...
    __slots__ = ('__battleCtx', '__arenaVisitor', '__clientIDs', '__points', '__sounds',
                 '__callbackIDs', '__snap', '__captured', '__teamBases', 'onTeamBasePointsUpdated',
                 'onBaseTeamChanged', 'onBaseCapturingStopped')

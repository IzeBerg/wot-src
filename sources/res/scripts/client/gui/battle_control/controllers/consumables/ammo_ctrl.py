...
class _GunSettings(namedtuple('_GunSettings', (
 ...
 'autoReload', 'autoShoot', 'isDualGun', 'twinGunFactor', 'shellChangeFactor'))):
...
class AmmoController(MethodsRules, ViewComponentsController):
    __slots__ = ('__eManager', 'onShellsAdded', 'onShellsUpdated', 'onNextShellChanged',
                 ...
                 '__dualGunQuickChangeReady', '__quickChangerInProcess', '__infinity')
    ...
    def __getPredictedLoadShells(self, isBattlePeriod, isLastCurrShells, shotsAmount):
        if isBattlePeriod:
            return self.__getPredictedNextShells(isLastCurrShells, shotsAmount)
        return (

...
class _GunSettings(namedtuple('_GunSettings', 'clip burst shots reloadEffect autoReload isDualGun')):
    ...
    def make(cls, gun):
        ...
        for shotIdx, shotDescr in enumerate(gun.shots):
            ...
            shots[intCD] = (
             shotIdx, shotDescr.piercingPower[0], shotDescr.speed)
...
class AmmoController(MethodsRules, IBattleController):
    __slots__ = ('__eManager', 'onShellsAdded', 'onShellsUpdated', 'onNextShellChanged',
                 ...
                 '__ammo', '_order', '__currShellCD', '__nextShellCD', '__gunSettings',
                 '_reloadingState', '_autoReloadingState', '__autoShoots', '__weakref__',
                 'onDebuffStarted', '__quickChangerActive', 'onQuickShellChangerUpdated',

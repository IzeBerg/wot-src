...
class SpawnEntity(ISpawnEntity):
    ...
    def __repr__(self):
        return 'SpawnEntity(vehicleID=%r, vehicleType=%r, chosenPointData=%r, isSupply=%r)' % (
         self.__vehicleID,
         self.__vehicleType,
...
class SupplyContainerEntity(ISupplyContainerEntity):
    ...
    def __repr__(self):
        return 'SupplyContainerEntity(supplyType=%r, supplies=%r)' % (
         self.__supplyType,
         self.__supplies)
    ...
    def chosenPointData(self):
        supplies = self.__supplies
        if supplies:
            return supplies[(-1)].chosenPointData
        else:
            return

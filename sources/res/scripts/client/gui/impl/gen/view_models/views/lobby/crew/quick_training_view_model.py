...
class QuickTrainingViewModel(BaseCrewViewModel):
    __slots__ = ('onLearn', 'onCancel', 'onBuyBook', 'onTipClose', 'onCardMouseLeave',
                 'onFreeXpMouseEnter', 'onFreeXpSelected', 'onFreeXpUpdated', 'onFreeXpManualInput',
                 'onBookMouseEnter', 'onBookSelected', 'onPostProgression')

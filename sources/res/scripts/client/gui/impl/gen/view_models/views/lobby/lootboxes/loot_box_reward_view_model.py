...
class LootBoxRewardViewModel(ViewModel):
    __slots__ = ('onCloseBtnClick', 'onNextBtnClick', 'onVideoChangeClick', 'onCloseEvent',
                 'onDestroyEvent', 'onReadyToRestart', 'showSpecialReward', 'onBuyBoxBtnClick',
                 'onSpecialActionBtnClick')

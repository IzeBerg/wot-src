...
class BattlePassProgressionsViewModel(CommonViewModel):
    __slots__ = ('onClose', 'onAboutClick', 'onBuyClick', 'onTakeClick', 'onTakeAllClick',
                 'onOpenShopClick', 'onPointsInfoClick', 'onFinishedAnimation', 'onLevelsAnimationFinished',
                 'onGoToChapter', 'onViewLoaded')

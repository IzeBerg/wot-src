...
class RosterViewModel(ViewModel):
    __slots__ = ('onAcceptClicked', 'onCancelClicked', 'onClose', 'onItemClicked',
                 'onFilterTextChanged', 'onFilterClearClicked', 'onClearVehicleSlotClicked',
                 'onClearSupplySlotClicked', 'onClosingAnimationEnded', 'onMannerClicked')

...
class NyGiftMachineViewModel(NySceneRotatableView):
    __slots__ = ('onGoToBuyTokens', 'onGoToIdle', 'onSkipAnimation', 'onBuyTokens',
                 'onGoToGlade', 'onGoToChallengeGuestA', 'onGoToChallengeGuestM',
                 'onGoToChallenge', 'onCloseInfoBlock', 'onBackFromVehiclePreview',
                 'onGoToHangar')

...
class NewYearChallengeModel(ViewModel):
    __slots__ = ('onLeaveIntroScreen', 'onOpenIntroScreen', 'onChangeAllQuestsVisibility',
                 'onExit', 'onStylePreviewShow', 'onUpdateTimeTill', 'onSimplify',
                 'onVisited', 'onSimplificationAnimationEnd', 'onCompletedAnimationShown')

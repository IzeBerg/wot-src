...
class EpicBattleSetupSubView(BaseEquipmentSetupSubView):
    ...
    __slots__ = ('__tooltipMgr', '__uiEpicBattleLogger', '__pendingPurchaseSkillIds',
                 '__pendingPurchaseItemIntCDs', '__totalPurchasePrice', '__selectedSlotId',
                 '__itemDetailsLevelMap', '__isCurrentlyActiveSubView')

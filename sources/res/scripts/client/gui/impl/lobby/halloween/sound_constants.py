...
EVENT_HANGAR_SOUND_SPACE = CommonSoundSpaceSettings(name=EventHangarSound.HANGAR, entranceStates={EventHangarSound.SOUND_STATE_PLACE: EventHangarSound.SOUND_STATE_PLACE_GARAGE, StatesGroup.HANGAR_FILTERED: States.HANGAR_FILTERED_OFF}, exitStates={}, persistentSounds=(), stoppableSounds=(), priorities=(), autoStart=True, enterEvent='', exitEvent='')
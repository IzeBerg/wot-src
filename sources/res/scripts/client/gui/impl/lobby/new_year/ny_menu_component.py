...
_NAVIGATION_ALIAS_VIEWS = {NyWidgetTopMenu.GLADE: ViewAliases.GLADE_VIEW, NyWidgetTopMenu.DECORATIONS: ViewAliases.CRAFT_VIEW, 
...
class NYMainMenu(HistorySubModelPresenter, GiftEventHubWatcher):
    ...
    def _getListeners(self):
        return (
         (
          events.NewYearEvent.ON_SWITCH_VIEW, self.__onSwitchViewEvent, EVENT_BUS_SCOPE.LOBBY),)
    ...
    def __onAccountDataUpdated(self, key, _):
        if key in (NY_CELEBRITY_QUESTS_VISITED_MASK, NY_OLD_COLLECTIONS_BY_YEAR_VISITED,

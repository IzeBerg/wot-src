...
class WidgetLevelProgressHelper(object):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.lobby.new_year.tooltips.NyMainWidgetTooltip():
            ...
            if contentID == R.views.lobby.new_year.tooltips.NyFriendsTooltips():
...
class NyMainWidget(ViewImpl):
    ...
    def __tryToDestroyWidgetTooltip(self):
        tooltipIDs = (
         R.views.lobby.new_year.tooltips.NyMainWidgetTooltip(),
         R.views.lobby.new_year.tooltips.NyWidgetBonusTooltip())

...
class NyGiftSystemView(HistorySubModelPresenter, GiftEventHubWatcher):
    __slots__ = ('_tooltips', '_eventHub', '__notifier', '__forcedSending', '__messageID',
                 '__targetSpaID')
    ...
    def __getSubmissionState(self):
        ...
        if self.__forcedSending:
            ...
            resultState = (user.isAnySub() or SubmissionState).NO_LONGER_FRIEND if 1 else resultState
        return resultState

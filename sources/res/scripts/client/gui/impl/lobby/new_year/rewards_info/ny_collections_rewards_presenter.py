...
class NyCollectionsRewardsPresenter(RewardsSubModelPresenter):
    __slots__ = ('__tooltips', '__currentStyle', '__yearName', '__collectionName',
                 '__confirmationWindow')
    ...
    def __onGoToCollectionButton(self, *_):
        self.parentView.goToAlbumView(saveHistory=True, tabName=self.__yearName, state=(
         NewYearTabCache.PAGE_STATE, {'collectionType': self.__collectionName}))

...
_BONUSES_ORDER_GF = (
 Ny23CoinToken.TYPE, 'vehicles', NyATMReward.DOG, 'tmanToken', 'customizations_style', NyATMReward.MARKETPLACE, CREW_BOOK_RARITY.PERSONAL, 'playerBadges', 'singleAchievements') + CREEBOOK_NATION_ORDER + (CREW_BOOK_RARITY.CREW_RARE, CREW_BOOK_RARITY.UNIVERSAL, 'crewBooks', 'booster_credits', 'booster_xp', 'booster_crew_xp', 'slots') + BLUEPRINT_NATION_ORDER + ('BlueprintNationFragmentCongrats',
...
class LevelRewardPresenter(object):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.lobby.tooltips.AdditionalRewardsTooltip():
            ...
            if event.contentID == R.views.lobby.new_year.tooltips.NyGuestDogTokenTooltip():

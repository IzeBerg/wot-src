...
_CHANGE_LAYERS_VISIBILITY = (
 WindowLayer.VIEW, WindowLayer.WINDOW, WindowLayer.TOP_WINDOW, WindowLayer.OVERLAY)
_GUEST_BONUSES_ORDER = ({'getName': 'customizations', 'getIcon': 'inscription'}, {'getName': 'customizations', 'getIcon': 'emblem'}, {'getName': 'customizations', 'getIcon': 'projectionDecal'}, {'getName': 'customizations', 'getIcon': 'style'})

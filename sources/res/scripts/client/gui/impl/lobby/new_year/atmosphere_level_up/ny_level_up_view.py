...
_BONUSES_ORDER = (
 NyATMReward.DOG, NyATMReward.MARKETPLACE, 'tmanToken', 'customizations_style', 'vehicles', 'playerBadges', 'singleAchievements') + CREEBOOK_NATION_ORDER + ('crewBooks', 'booster_credits', 'booster_xp') + BLUEPRINT_NATION_ORDER + (

import typing, BigWorld, AnimationSequence, WebBrowser
...
def _bonusesSortOrder(bonus):
    if not _BONUSES_ORDER:
        _BONUSES_ORDER.extend((
         NyATMReward.DOG, NyATMReward.MARKETPLACE, 'tmanToken', 'customizations_style', 'vehicles', 'playerBadges', 'singleAchievements') + CREEBOOK_NATION_ORDER + ('crewBooks',
                                                                                                                                                                     'booster_credits',
                                                                                                                                                                     'booster_xp') + BLUEPRINT_NATION_ORDER + (
...
class NyAtmosphereLevelUpView(ViewImpl):
    ...
    def createToolTipContent(self, event, ctID):
        ...
        if ctID == R.views.lobby.new_year.tooltips.NyGiftMachineTokenTooltip():

...
class NewYearChallengeGuest(NyHistoryPresenter):
    __slots__ = ('_tooltips', '__guestName', '__questIndex', '__questIdToIdx', '__lastAvailableQuestID',
                 '__blur')
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return super(NewYearChallengeGuest, self).createToolTipContent(event, contentID)

...
_REWARD_ORDER = (
 Type.VEHICLES, Type.CUSTOMIZATIONS, Type.PREMIUMPLUS, Type.GOLD, Type.CREDITS, Type.TOYS, Type.SHARDS)
...
class NyLootBoxStatisticsPopover(PopOverViewImpl):
    ...
    def __getRewardModel(rewardType, rewardData):
        if rewardData is None:
            ...
            if rewardType in (Type.SHARDS, Type.GOLD, Type.CREDITS, Type.PREMIUMPLUS):
                count = rewardData
            else:
                if rewardType == Type.TOYS:

...
class NyMarketplaceView(SceneRotatableView, NyHistoryPresenter):
    __slots__ = ('_tooltips', '__settings', '__needToResetAppearance', '__needResetBloor',
                 '__cameraCallbackId', '__blur', '__tabName', '__currentPreviewVehicle',
                 '__currentPreviewStyle')
    ...
    def initialize(self, *args, **kwargs):
        ...
        self.__settings.setResource(max([ (r, self._nyController.currencies.getResouceBalance(r.value)) for r in RESOURCES_ORDER
                                        ], key=itemgetter(1))[0])

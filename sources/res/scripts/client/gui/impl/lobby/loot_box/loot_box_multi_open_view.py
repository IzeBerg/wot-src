...
class LootBoxMultiOpenView(LootBoxHideableView):
    ...
    def __getGroupsLayout():
        ...
        layout = (
         RewardsGroup(name=groupNamesRes.shardsAndBigToys(), bonusTypes=(
          CurrentNYConstants.TOYS, CurrentNYConstants.TOY_FRAGMENTS), bonuses={}, filterFuncs=None),
         RewardsGroup(name=groupNamesRes.consumables(), bonusTypes=('items', ), bonuses={}, filterFuncs=(
          getItemsFilter((isConsumable,)),)),
         RewardsGroup(name=groupNamesRes.crewBooksAndBattleBoosters(), bonusTypes=('items', ), bonuses={}, filterFuncs=(
          getItemsFilter((isBattleBooster, isCrewBook)),)),

...
import typing, BigWorld, ScaleformFileLoader
...
class LootBoxHideableView(ViewImpl):
    ...
    def __init__(self, settings):
        ...
        self._holdByViews = (
         lobbyViews.new_year.views.NyLootBoxSpecialReward(),
...
def getTooltipContent(event, storedTooltipData):
    ...
    if tooltipContent is not None:
        ...
        if event.contentID == tooltipContentRes.NyMegaDecorationTooltip():
            toyID = event.getArgument('toyID')

...
class NYToyBonusUIPacker(BaseBonusUIPacker):
    ...
    def _getToolTip(cls, bonus):
        ...
        tooltipData = backport.createTooltipData(tooltip={R.views.lobby.new_year.tooltips.NyDecorationTooltip(): NyDecorationTooltip}, specialArgs=(
         toyId,))
        return [
         tooltipData]
...
class NYBoxWithToysBonusUIPacker(BaseBonusUIPacker):
    ...
    def _getToolTip(cls, bonus):
        ...
        tooltipData = backport.createTooltipData(tooltip={R.views.lobby.new_year.tooltips.NyBoxWithToysTooltip(): NyBoxWithToysTooltip}, specialArgs=(
         toys,))
        return [
         tooltipData]

...
_BONUSES_ORDER = (
 ...
 'finalBlueprints', 'customizations', 'vehicles', 'slots', 'modernizedEquipment', CurrentNYConstants.TOYS)
NEWYEAR_BONUS_ORDER = (
...
_GROUPED_SORT_C11N_INDEX = ('style_3d', 'style', 'projectionDecal', 'decal', 'emblem',
                            'inscription', 'insignia', 'personalNumber', 'paint')
...
class NyBattleTokensPacker(SimpleBonusUIPacker):
    ...
    def _getContentId(cls, bonus):
        return [
         R.views.lobby.new_year.tooltips.NyRewardKitGuestCTooltip()]

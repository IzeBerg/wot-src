...
_BONUSES_ORDER = (
 ...
 'finalBlueprints', 'customizations', 'vehicles', 'slots', 'modernizedEquipment')
NEWYEAR_BONUS_ORDER = (
...
_GROUPED_SORT_C11N_INDEX = ('style_3d', 'style', 'paint', 'decal', 'emblem', 'inscription',
                            'projectionDecal', 'insignia', 'personalNumber')

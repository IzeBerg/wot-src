...
class CrewPerksTooltip(ViewImpl):
    ...
    __slots__ = ('_skillName', '_tankman', '_tankmanVehicle', '_skill', '_descrArgs',
                 '_skillLevel', '_skillBooster', '_showAdditionalInfo', '_isTmanTrainedVeh',
                 '_isFakeSkill', '_isFakeSkillLvl', '_isCmpSkill', '_skillLevelWithoutEff',
                 '_isBonus', '_isIrrelevant', '_isUntrained')

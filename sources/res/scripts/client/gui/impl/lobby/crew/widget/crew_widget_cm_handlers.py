...
class CrewContextMenuHandler(AbstractContextMenuHandler, EventSystemEntity):
    ...
    def _generateOptions(self, ctx=None):
        ...
        return [
         ...
         self._makeItem(CREW.SEND_TO_BARRACKS, MENU.contextmenu('crewWidgetSendToToBarracks'), {'visible': isNotInQuickTraining, 'enabled': self._vehicle and isNotLocked}),
         self._makeItem(CREW.DISMISS, MENU.contextmenu('crewWidgetDismiss'), {'visible': isNotInQuickTraining, 'enabled': isNotLocked})]

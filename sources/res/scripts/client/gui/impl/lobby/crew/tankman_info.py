...
class TankmanInfo(BaseCrewSoundView):
    __slots__ = ('_tankman', '_tankmanCurrentVehicle', '_voiceoverParams', '_retrainPrice',
                 '_toolTipMgr', '_uiLogger', '__sound', '__parentViewKey')
    ...
    def createToolTip(self, event):
        if event.contentID == R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent():
            ...
            if tooltipId == TooltipConstants.SKILL:
                args = [
                 str(event.getArgument('skillName')), self._tankman.invID, event.getArgument('level', None),
                 False, True]

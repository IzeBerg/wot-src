...
_SubviewDescriptor = namedtuple('SubviewDescriptor', ('name', 'resId', 'viewClass',
                                                      'hasNotification'))
_TABS = (
 _SubviewDescriptor(name=Tabs.COLLECTION, resId=R.views.lobby.rts.CollectionView(), viewClass=RTSCollectionView, hasNotification=True),
...
def getMemberContextMenuData(event):
    ...
    if spaId == getPlayerDatabaseID():
        ...
        context = {'dbID': spaId, 
           'userName': userName, 
           'customItems': [], 'excludedItems': [], 'customItemsAfterEnd': []}

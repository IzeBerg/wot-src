...
class RtsSupplyParams(VehicleParams):
    SUPPLY_PARAMETERS_BY_TYPE = {RTSSupply.BARRICADES: ('supply_barricadesDamage', ), 
       RTSSupply.BUNKER: ('supply_avgDamage', 'supply_avgPiercingPower', 'supply_bunkerClipFireRate', 'supply_reloadTimeSecs',
 'supply_shotDispersionAngle', 'supply_maxHealth', 'supply_armor', 'supply_circularVisionRadius'), 
       RTSSupply.AT_GUN: ('supply_avgDamage', 'supply_avgPiercingPower', 'supply_reloadTimeSecs', 'supply_shotDispersionAngle',
 'supply_maxHealth', 'supply_circularVisionRadius'), 
       RTSSupply.PILLBOX: ('supply_avgDamage', 'supply_avgPiercingPower', 'supply_pillboxClipFireRate', 'supply_shotDispersionAngle',
 'supply_maxHealth', 'supply_armor', 'supply_circularVisionRadius'), 
       RTSSupply.WATCH_TOWER: ('supply_maxHealth', 'supply_circularVisionRadius'), 
       RTSSupply.MORTAR: ('supply_avgDamage', 'supply_avgPiercingPower', 'supply_mortarClipFireRate', 'supply_shotDispersionAngle',
 'supply_stunDuration', 'supply_maxHealth', 'supply_circularVisionRadius'), 
       RTSSupply.FLAMER: ('supply_flamethrowerDamage', 'supply_flamethrowerClipFireRate', 'supply_maxHealth',
 'supply_armor', 'supply_circularVisionRadius')}
    ...
    def supply_stunDuration(self):
        ...
        if maxStunDuration:
            ...
            return (
             minStunDuration, maxStunDuration)
        else:
            return
    ...
    def supply_flamethrowerClipFireRate(self):
        ...
        return (
         duration, jetsPerMagazine, reloadTime)

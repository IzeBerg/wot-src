...
_YEARLY_REWARDS_BONUSES_ORDER = (
 BonusTypes.STYLE_PROGRESS, BonusTypes.RENT_VEHICLE, BonusTypes.BADGE_SUFFIX, BonusTypes.BADGE,
 BonusTypes.STYLE, BonusTypes.ACHIEVEMENT)
...
class Comp7TokenUIPacker(TokenBonusUIPacker):
    ...
    def _getTokenBonusType(cls, tokenID, complexToken):
        if tokenID.startswith(OFFER_TOKEN_PREFIX):
            return cls._OFFER_TOKEN
        return super(Comp7TokenUIPacker, cls)._getTokenBonusType(tokenID, complexToken)

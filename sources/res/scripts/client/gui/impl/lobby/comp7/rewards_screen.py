...
_YEARLY_MAIN_REWARDS = ('dossier_badge', 'dossier_achievement', 'styleProgress', 'deluxe_gift',
                        'crystal')
...
class YearlyRewardsView(_BaseRewardsView):
    ...
    def _packBonuses(self, *args, **kwargs):
        ...
        if self.__hasYearlyVehicle:
            return packYearlyRewardCrew(bonus=vehicleBonus)
        else:

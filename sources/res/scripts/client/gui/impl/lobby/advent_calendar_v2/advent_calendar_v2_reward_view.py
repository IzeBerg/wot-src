...
EXCLUDET_CLASSES = (
 BattleTokensBonus,)
_BONUSES_ORDER = ({'getIcon': 'nyCoin'}, {'getName': 'tmanToken'}, {'getName': 'newYear_premium'}, {'getName': 'premium_plus'}, {'getName': 'customizations'}, {'getName': 'crewSkin'}, {'getName': 'goodies', 'getIcon': 'booster_credits'}, {'getName': 'goodies', 'getIcon': 'booster_xp'}, {'getName': 'goodies', 'getIcon': 'booster_free_xp_and_crew_xp'}, {'getName': 'crewBooks'}, {'getName': 'goodies', 'getIcon': 'recertificationForm'}, {'getName': BATTLE_BONUS_X5_TOKEN}, {'getName': 'items', 'getIcon': 'modernizedExtraHealthReserveAntifragmentationLining'}, {'getName': 'items', 'getIcon': 'modernizedTurbochargerRotationMechanism'}, {'getName': 'items', 'getIcon': 'modernizedAimDrivesAimingStabilizer'}, {'getName': 'equipCoin'}, {'getName': 'credits'})

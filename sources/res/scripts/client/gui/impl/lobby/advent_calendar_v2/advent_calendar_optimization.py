import logging, BigWorld, AnimationSequence, WebBrowser
...
AdventWindowOptimizationSettings = namedtuple('AdventWindowOptimizationSettings', ('disableWindowsVisibility',
                                                                                   'disableExternalCacheDownloading',
                                                                                   'disableAnimationSequenceUpdate',
                                                                                   'disable3dSceneDrawing',
                                                                                   'windowOptimizationProcessorSettings'))

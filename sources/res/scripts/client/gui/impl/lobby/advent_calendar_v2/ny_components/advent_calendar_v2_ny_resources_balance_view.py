...
class AdventCalendarNYResourceBalance(SubModelPresenter):
    ...
    def createPopOverContent(self, event):
        if event.contentID == R.views.lobby.new_year.popovers.NyResourcesConvertPopover() and self.__isConvertPopoverAvailable():
            return AdventCalendarNyResourcesConvertPopover(self.__closeClb, self.parentView.getParentWindow())
        return super(AdventCalendarNYResourceBalance, self).createPopOverContent(event)

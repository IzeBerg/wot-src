...
class PostbattleScreenView(ViewImpl):
    __slots__ = ('__arenaUniqueID', '__tooltipParametersCreator', '__tooltipContentCreator',
                 '__eventPlugin', '__questBnsTooltipData')
    ...
    def __getEfficiencyTooltipParameters(self, event):
        ...
        args = [
         self.__battleResults.presenter.getEfficiencyTooltipData(self.__arenaUniqueID, parameterName, enemyVehicleID=enemyVehicleID)]
    ...
    def __getTotalEfficiencyTooltipParameters(self, event):
        args = [
         self.__battleResults.presenter.getTotalEfficiencyTooltipData(self.__arenaUniqueID, event.getArgument('type'))]

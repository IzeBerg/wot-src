...
class BattleMattersVehicleSelectionView(ViewImpl):
    ...
    def createPopOverContent(self, event):
        if event.contentID == R.views.lobby.battle_matters.popovers.BattleMattersFilterPopoverView():
            return BattleMattersFilterPopoverView(self.__filters, self.onUpdateFilter)
    ...
    def onShowVehicle(self, event):
        ...
        showOfferGiftVehiclePreview(self._selectableBonusManager.getBonusOffer(self.__selectableBonus).id, giftID, self.onConfirm, VEHICLE_PREVIEW.HEADER_BACKBTN_DESCRLABEL_BATTLEMATTERS, customCallbacks={'previewBackCb': showDelayedReward, 'offerEndedCb': lambda : None})

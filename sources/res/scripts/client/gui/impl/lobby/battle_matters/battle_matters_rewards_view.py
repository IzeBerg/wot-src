...
_CUSTOM_SORT = {'vehicles': _vehiclesCmp, 'customizations': _customizationsCmp, 'items': _itemsCmp}
...
class BattleMattersRewardsView(ViewImpl):
    __slots__ = ('__cds', '__questOrder', '__isPairQuest', '__isWithDelayed', '__delayedReward',
                 ...
                 '__regularRewards', '__tooltipData')
    ...
    def __init__(self, ctx):
        ...
        for qID in questIDs:
            ...
            elif self.__battleMattersController.isRegularBattleMattersQuestID(qID):

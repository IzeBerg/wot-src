...
class SquadMembersView(ViewImpl, CallbackDelayer):
    ...
    def _getTitle(self):
        title = ('').join((
         ...
         i18n.makeString(backport.text(R.strings.platoon.members.header.randomBattle()))))
        return title
...
class EpicMembersView(SquadMembersView):
    ...
    def _getTitle(self):
        title = ('').join((
         i18n.makeString(backport.text(R.strings.platoon.squad())),
         i18n.makeString(backport.text(R.strings.platoon.members.header.epic()))))
        return title
...
class BattleRoyalMembersView(SquadMembersView):
    ...
    def _getTitle(self):
        title = ('').join((
         i18n.makeString(backport.text(R.strings.platoon.squad())),
         i18n.makeString(backport.text(R.strings.platoon.members.header.battleRoyale()))))
        return title
...
class MapboxMembersView(SquadMembersView):
    ...
    def _getTitle(self):
        title = ('').join((
         i18n.makeString(backport.text(R.strings.platoon.squad())),
         i18n.makeString(backport.text(R.strings.platoon.members.header.mapbox()))))
        return title
...
class FunRandomMembersView(SquadMembersView):
    ...
    def _getTitle(self):
        title = ('').join((
         i18n.makeString(backport.text(R.strings.platoon.squad())),
         i18n.makeString(backport.text(R.strings.platoon.members.header.funRandom()))))
        return title

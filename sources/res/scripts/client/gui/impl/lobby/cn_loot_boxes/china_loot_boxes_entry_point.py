...
class ChinaLootBoxesEntryPointWidget(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.lobby.cn_loot_boxes.tooltips.ChinaLootBoxesEntryPointTooltipView():
            return ChinaLootBoxesEntryPointTooltipView()
    ...
    def _getEvents(self):
        return (
         ...
         (
          self.__cnLootBoxes.onStatusChange, self.__updateTime),
         (

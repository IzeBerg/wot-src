...
def _packBlueprints(rewards, model):
    ...
    for blueprint in _mergeNationalBlueprints(blueprints):
        ...
        bonusModel.setLabel((isinstance(blueprint, LootBoxRandomNationalBonus) or blueprint.getBlueprintTooltipName)() if 1 else backport.text(R.strings.tooltips.blueprint.BlueprintFragmentTooltip.fragmentHeader()))

...
class SingleBoxRewards(SubViewImpl):
    __slots__ = ('__isReopen', '__category', '__openCount', '__bonuses', '__extraBonuses',
                 '__tooltipItems', '__isVideoPlaying')
    ...
    def __reopen(self):
        hideItemPreview()
        Views.load(ViewID.MAIN, SubViewID.SINGLE_BOX_REWARDS, isReopen=True, count=self.__openCount, category=self.__category, bonuses=[
         self.__bonuses + self.__extraBonuses])

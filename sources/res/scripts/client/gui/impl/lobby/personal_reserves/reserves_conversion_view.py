...
class ReservesConversionView(ReservesViewMonitor):
    ...
    BOOSTER_TYPE_TO_MODEL_DICT = {'booster_crew_xp': (
                         lambda model: model.crewXPConverted, lambda model: model.crewXPConverted), 
       'booster_credits': (
                         lambda model: model.creditsConverted, lambda model: model.creditsConverted), 
       'booster_free_xp': (
                         None, lambda model: model.freeXPConverted), 
       'booster_xp': (
                    lambda model: model.battleXPConverted, lambda model: model.battleXPConverted)}

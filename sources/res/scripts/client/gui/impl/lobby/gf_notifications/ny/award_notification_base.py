...
BONUSES_ORDER = (
 NyATMReward.DOG, NyATMReward.MARKETPLACE, 'tmanToken', 'customizations_style', 'vehicles', 'playerBadges', 'singleAchievements', 'nyCoin') + CREEBOOK_NATION_ORDER + ('crewBooks',
                                                                                                                                                                       'booster_credits',

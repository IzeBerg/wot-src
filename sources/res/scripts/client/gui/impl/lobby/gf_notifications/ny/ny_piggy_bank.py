...
class NyPiggyBankSingleReward(AwardNotificationBase):
    ...
    def _canNavigate(self):
        ...
        if self._hasBonusStyle(bonuses):
            return super(NyPiggyBankSingleReward, self)._canNavigate() and self._canShowStyle()
        return super(NyPiggyBankSingleReward, self)._canNavigate() and self.__friendsService.isServiceEnabled and self._nyController.isEnabled()

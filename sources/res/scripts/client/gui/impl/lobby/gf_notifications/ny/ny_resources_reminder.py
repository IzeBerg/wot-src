...
class NyResourcesReminder(NyNotification):
    ...
    def _canNavigate(self):
        ...
        if viewType == reminderType.FRIENDS or viewType == reminderType.FINDFRIENDS:
            return super(NyResourcesReminder, self)._canNavigate() and self.__friendsService.isServiceEnabled and self._nyController.isEnabled()
        return super(NyResourcesReminder, self)._canNavigate() and self._nyController.isEnabled()

...
NOTIFICATION_PRESENTERS = {'NyDogReminder': (
   ...
   'AdventCalendarV2DoorsAvailableFirstEntry': (
                                              R.views.lobby.new_year.notifications.AdventCalendarV2DoorsAvailable(),
                                              AdventCalendarV2DoorsAvailable), 
   'AdventCalendarV2DoorsAvailable': (
                                    R.views.lobby.new_year.notifications.AdventCalendarV2DoorsAvailable(), AdventCalendarV2DoorsAvailable), 
   'AdventCalendarV2DoorsAvailablePostEvent': (
                                             R.views.lobby.new_year.notifications.AdventCalendarV2DoorsAvailable(),
                                             AdventCalendarV2DoorsAvailable), 
   'ReceivingAwards': (

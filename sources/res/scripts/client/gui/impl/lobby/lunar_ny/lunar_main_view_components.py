...
class MainViewComponents(object):
    ...
    def createToolTipContent(self, event, contentID):
        if self.__fillEnvelopeView.getIsActive():
            return self.__fillEnvelopeView.createToolTipContent(event, contentID)
        return self.__views[self.__currentTab].createToolTipContent(event, contentID)

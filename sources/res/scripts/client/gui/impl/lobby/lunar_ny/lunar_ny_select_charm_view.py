...
class LunarNYSelectCharmView(ViewImpl[SelectCharmViewModel]):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.lobby.lunar_ny.CharmTooltip():
            return CharmTooltip(charmID=event.getArgument('charmID'))
        return super(LunarNYSelectCharmView, self).createToolTipContent(event, contentID)

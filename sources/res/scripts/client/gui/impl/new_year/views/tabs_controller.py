...
class ChallengeTabsController(NyTabsController):
    ...
    def getSettingKeysForUpdate(self):
        return {
         ...
         NY_CELEBRITY_ADD_QUESTS_VISITED_MASK}
    ...
    def _tabActive(self, tabName):
        ...
        if tabName == NyTabBarChallengeView.GUEST_D:
            return self.__isDogTabEnable()
        return super(ChallengeTabsController, self)._tabActive(tabName)

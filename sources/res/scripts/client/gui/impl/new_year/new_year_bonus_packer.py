...
class NYCelebrityTokenBonusUIPacker(NewYearTokenBonusUIPacker):
    ...
    def __getTooltipId(cls, tokenType):
        if tokenType == Ny23CoinToken.ID:
            ...
            if tokenType == GUEST_ECONOMIC_BONUS_ID:
                return str(R.views.lobby.new_year.tooltips.NyEconomicBonusTooltip())
            return
    ...
    def __packNYCelebrityActionToolTipData(cls, tokenId, *args):
        ...
        return [
         TooltipData(tooltip=None, isSpecial=True, specialAlias=TOOLTIPS_CONSTANTS.NY23_ACTION_TOKEN, specialArgs=(
          actionType, level))]
    ...
    def __packNYLootboxCoinToolTipData(cls, tokenId, *args):
        ...
        if lootbox is None:
            ...
            return createTooltipData(makeTooltip(header=lootbox.getUserName(), body=backport.text(R.strings.ny.quests.bonuses.ny23Coin.body())))
...
_GUEST_BONUSES_ORDER = ({'getName': 'customizations', 'getIcon': 'projectionDecal'}, {'getName': 'customizations', 'getIcon': 'style'}, {'getName': 'premium_plus'}, {'getName': 'battleToken', 'getIconName': 'ny23Coin'}, {'getName': 'addcEconomicBonuses'}, {'getName': 'questTokenAnim'}, {'getName': 'questTokenStory'}, {'getName': 'questTokenDecoration'})

...
class EntitlementsCache(object):
    ...
    __COMP7_ENTITLEMENTS_NAMES = [
     eliteRankEntNameBySeasonNumber(1), eliteRankEntNameBySeasonNumber(2), eliteRankEntNameBySeasonNumber(3),
     ratingEntNameBySeasonNumber(1), ratingEntNameBySeasonNumber(2), ratingEntNameBySeasonNumber(3),
     seasonPointsCodeBySeasonNumber(1), seasonPointsCodeBySeasonNumber(2), seasonPointsCodeBySeasonNumber(3)]

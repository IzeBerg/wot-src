...
class HangarConfig(object):
    __slots__ = [
     'cfg', 'vStartAngles', 'vStartPos', 'camDistConstPlatoon', 'camStartDistPlatoon', 'camStartAngles',
     'camStartAnglesPlatoon', 'camStartTargetPos', 'camStartDist', 'camDistConstr',
     'camMinDistVehicleHullLengthK', 'camPitchConstr', 'camYawConstr', 'camSens', 'camDistSens',
     'camPivotPos', 'camFluency', 'emblemsAlphaDamaged', 'emblemsAlphaUndamaged', 'shadowLightDir',
     'shadowModelName', 'shadowForwardYOffset', 'shadowDeferredYOffset', 'shadowDefaultTextureName',
     'shadowEmptyTextureName', 'camCapsuleScale', 'camCapsuleGunScale', 'camIdlePitchConstr',
     'camIdleDistConstr', 'camIdleYawPeriod', 'camIdlePitchPeriod', 'camIdleDistPeriod',
     'camIdleEasingInTime', 'camParallaxDistance', 'camParallaxAngles', 'camParallaxSmoothing',
     'vehicleGunPitch', 'vehicleTurretYaw']
    ...
    def loadConfig(self, xml, defaultCfg=None):
        ...
        defaultIdleCfg = {'cam_idle_pitch_constr': Math.Vector2(0.0, 0.0), 'cam_idle_dist_constr': Math.Vector2(10.0, 10.0), 
        ...
        defaultParallaxCfg = {'cam_parallax_distance': Math.Vector2(0.0, 0.0), 'cam_parallax_angles': Math.Vector2(0.0, 0.0), 

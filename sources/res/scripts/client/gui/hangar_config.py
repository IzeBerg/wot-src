...
class HangarConfig(object):
    __slots__ = [
     'cfg', 'vStartAngles', 'vStartPos', 'camDistConstrPlatoon', 'camStartDistPlatoon',
     'camPitchConstrPlatoon', 'camStartAngles', 'camStartAnglesPlatoon', 'camStartTargetPos',
     'camStartDist', 'camDistConstr', 'camMinDistVehicleHullLengthK', 'camPitchConstr', 'camYawConstr',
     'camSens', 'camDistSens', 'camPivotPos', 'camFluency', 'emblemsAlphaDamaged', 'emblemsAlphaUndamaged',
     'shadowLightDir', 'shadowModelName', 'shadowForwardYOffset', 'shadowDeferredYOffset',
     'shadowDefaultTextureName', 'shadowEmptyTextureName', 'camCapsuleScale', 'camCapsuleGunScale',
     'camIdlePitchConstr', 'camIdleDistConstr', 'camIdleYawPeriod', 'camIdlePitchPeriod',
     'camIdleDistPeriod', 'camIdleEasingInTime', 'camParallaxDistance', 'camParallaxAngles',
     'camParallaxSmoothing', 'vehicleGunPitch', 'vehicleTurretYaw']

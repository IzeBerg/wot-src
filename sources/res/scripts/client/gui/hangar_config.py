...
class HangarConfig(object):
    NY_SLOTS = [
     'camDistConstrPlatoon', 'camStartDistPlatoon', 'camPitchConstrPlatoon', 'camStartAngles',
     'camStartAnglesPlatoon', 'camStartTargetPos', 'camStartDist', 'camDistConstr', 'camPitchConstr',
     'camYawConstr', 'camSens', 'camDistSens', 'camPivotPos', 'camFluency', 'camIdlePitchConstr',
    ...
    __slots__ = [
     ...
     'camMinDistVehicleHullLengthK', 'camCapsuleScale', 'camCapsuleGunScale'] + NY_SLOTS
    ...
    def loadConfig(self, xml, defaultCfg=None):
        ...
        defaultIdleCfg = {'cam_idle_pitch_constr': Vector2(0.0, 0.0), 'cam_idle_dist_constr': Vector2(10.0, 10.0), 
        ...
        defaultParallaxCfg = {'cam_parallax_distance': Vector2(0.0, 0.0), 'cam_parallax_angles': Vector2(0.0, 0.0), 

...
_DORMANT_EVENTS_NAMES = [
 R4_SOUND.R4_ALLY_DETECTED, R4_SOUND.R4_ENEMY_DETECTED]
...
_COOLDOWN_TYPES = {
 _COOLDOWN_TYPE_VEHICLE_ID,
 _COOLDOWN_TYPE_VEHICLE_CLASS}
...
class IngameSoundNotifications(CallbackDelayer, TimeDeltaMeter):
    ...
    def getEventInfo(self, eventName, parameter):
        ...
        if eventName in self._events and parameter in self._events[eventName]:
            return self._events[eventName][parameter]
        return ''

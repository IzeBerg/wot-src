...
_ARENA_BONUS_TYPE_BY_QUEUE_TYPE = {QUEUE_TYPE.BATTLE_ROYALE: (
                            ARENA_BONUS_TYPE.BATTLE_ROYALE_SOLO, ARENA_BONUS_TYPE.BATTLE_ROYALE_SQUAD), 
   QUEUE_TYPE.RANDOMS: (
                      ARENA_BONUS_TYPE.REGULAR, ARENA_BONUS_TYPE.REGULAR), 
   QUEUE_TYPE.RANKED: (
                     ARENA_BONUS_TYPE.RANKED, ARENA_BONUS_TYPE.RANKED), 
   QUEUE_TYPE.MAPBOX: (
                     ARENA_BONUS_TYPE.MAPBOX, ARENA_BONUS_TYPE.MAPBOX), 
   QUEUE_TYPE.EPIC: (
                   ARENA_BONUS_TYPE.EPIC_BATTLE, ARENA_BONUS_TYPE.EPIC_BATTLE), 
   QUEUE_TYPE.RTS: (
                  ARENA_BONUS_TYPE.RTS, ARENA_BONUS_TYPE.RTS), 
   QUEUE_TYPE.RTS_1x1: (
                      ARENA_BONUS_TYPE.RTS_1x1, ARENA_BONUS_TYPE.RTS_1x1)}

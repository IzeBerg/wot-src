...
class EventBattleSquadEntity(SquadEntity):
    ...
    def canPlayerDoAction(self):
        ...
        if selectedDifficultyLevel not in self.gameEventController.getDifficultyLevels():
            ...
            if not self.gameEventController.hasDifficultyLevelToken(selectedDifficultyLevel):
            ...
            if not self.gameEventController.hasDifficultyLevelToken(squadDifficultyLevel):
                return ValidationResult(False, UNIT_RESTRICTION.EVENT_UNIT_SQUAD_DIFFICULTY_LEVEL_NOT_ENABLE, None)

...
class AlertData(object):
    ...
    __slots__ = ('alertIcon', 'buttonIcon', 'buttonLabel', 'buttonVisible', 'buttonTooltip',
                 'statusText', 'popoverAlias', 'bgVisible', 'shadowFilterVisible',
                 'tooltip', 'isSimpleTooltip', 'isWulfTooltip')

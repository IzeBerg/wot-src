...
TANK_TYPE_TO_SWITCH = OrderedDict((
 ('heavyTank', 'SWITCH_ext_r4_tank_type_tt'),
...
class R4_SOUND(object):
    ...
    KEYS_TO_MANNER_UI_SOUND = [
     MappedKeys.getKey(MappedKeys.KEY_HOLD_MANNER),
    ...
    R4_ALLY_DAMAGE_EVENTS = (
     R4_ALLY_GET_FIRST_DAMAGE, R4_ALLY_GET_MEDIUM_DAMAGE, R4_ALLY_GET_BIG_DAMAGE)
    ...
    R4_ENEMY_DESTROYED_COUNTER_EVENTS = (
     None, R4_ENEMY_DESTROYED_COUNTER_1,
    ...
    R4_ENEMY_DESTROYED_REMAIN_EVENTS = (
     R4_ENEMY_DESTROYED_LAST,
    ...
    R4_ORDER_EVENTS = (
     ...
     R4_ORDER_RETREAT, R4_ORDER_CANCEL)
    ...
    R4_MUTED_SOUNDS = ('vehicle_destroyed', 'crew_deactivated', 'ally_killed_by_player',
                       'ally_killed_by_enemy ', 'track_damaged')

...
class BCNationsWindow(BCNationsWindowMeta):
    nations = {'NA': (
            [
             'usa', 'ussr', 'germany'], ['uk', 'france', 'czech', 'japan', 'china', 'poland', 'sweden', 'italy']), 
       'RU': (
            [
             'ussr', 'germany', 'usa'], ['france', 'uk', 'czech', 'china', 'japan', 'poland', 'sweden', 'italy']), 
       'EU': (
            [
             'germany', 'ussr', 'usa'], ['france', 'uk', 'china', 'japan', 'czech', 'poland', 'sweden', 'italy']), 
       'ASIA': (
              [
               'germany', 'ussr', 'usa'], ['japan', 'china', 'uk', 'france', 'czech', 'poland', 'italy', 'sweden']), 
       'CN': (
            [
             'china', 'ussr', 'usa'], ['germany', 'sweden', 'france', 'italy', 'uk', 'czech', 'poland', 'japan']), 
       'DEFAULT': (
                 [
                  'germany', 'ussr', 'usa'], ['france', 'uk', 'czech', 'china', 'japan', 'poland', 'sweden', 'italy'])}

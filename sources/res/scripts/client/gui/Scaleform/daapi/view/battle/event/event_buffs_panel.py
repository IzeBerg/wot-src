...
class EventBuffsPanel(EventBuffsPanelMeta):
    ...
    def __handleBuffApply(self, event):
        ...
        header = makeHtmlString('html_templates:lobby/tooltips', 'tooltip_buff_header', {'iconName': tooltipTextTag, 'header': tooltipTitleText})
        body = makeHtmlString('html_templates:lobby/tooltips', 'tooltip_buff_body', {'anomaly': anomalyText, 'body': tooltipDescText})

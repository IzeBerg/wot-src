...
class _RentVehiclesDataProvider(StorageCarouselDataProvider):
    ...
    def __init__(self, carouselFilter, itemsCache):
        ...
        self._baseCriteria = REQ_CRITERIA.VEHICLE.RENT ^ REQ_CRITERIA.VEHICLE.WOT_PLUS_VEHICLE ^ REQ_CRITERIA.VEHICLE.TELECOM_RENT | REQ_CRITERIA.INVENTORY | ~REQ_CRITERIA.VEHICLE.TELECOM

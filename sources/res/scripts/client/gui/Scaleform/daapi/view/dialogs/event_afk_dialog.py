...
class EventAFKDialogMetaData(I18nDialogMeta):
    ...
    def getImagePath(self):
        if self._key == self.BAN_MESSAGE:
            return '../maps/icons/event/afkMessageDialog/ban.png'
        return '../maps/icons/event/afkMessageDialog/warning.png'
    ...
    def __getButtons(self, key):
        if key == self.AFTER_BATTLE_WARNING:
            return I18nInfoDialogButtons(key)
        return I18nConfirmDialogButtons(key, DIALOG_BUTTON_ID.CLOSE)

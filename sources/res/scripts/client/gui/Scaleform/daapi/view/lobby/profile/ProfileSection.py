...
class ProfileSection(ProfileSectionMeta):
    ...
    def __initHandlers(self):
        self.__battleTypeHandlers = {PROFILE_DROPDOWN_KEYS.ALL: (
                                     True, '_getTotalStatsBlock'), 
           PROFILE_DROPDOWN_KEYS.TEAM: (
                                      False, 'getTeam7x7Stats'), 
           PROFILE_DROPDOWN_KEYS.STATICTEAM: (
                                            False, 'getRated7x7Stats'), 
           PROFILE_DROPDOWN_KEYS.HISTORICAL: (
                                            False, 'getHistoricalStats'), 
           PROFILE_DROPDOWN_KEYS.FORTIFICATIONS: (
                                                True, '_receiveFortDossier'), 
           PROFILE_DROPDOWN_KEYS.FORTIFICATIONS_SORTIES: (
                                                        False, 'getFortSortiesStats'), 
           PROFILE_DROPDOWN_KEYS.FORTIFICATIONS_BATTLES: (
                                                        False, 'getFortBattlesStats'), 
           PROFILE_DROPDOWN_KEYS.COMPANY: (
                                         False, 'getCompanyStats'), 
           PROFILE_DROPDOWN_KEYS.CLAN: (
                                      False, 'getGlobalMapStats'), 
           PROFILE_DROPDOWN_KEYS.FALLOUT: (
                                         False, 'getFalloutStats'), 
           PROFILE_DROPDOWN_KEYS.RANKED: (
                                        False, 'getRankedStats'), 
           PROFILE_DROPDOWN_KEYS.RANKED_10X10: (
                                              False, 'getRanked10x10Stats'), 
           PROFILE_DROPDOWN_KEYS.EPIC_RANDOM: (
                                             False, 'getEpicRandomStats'), 
           ...
           PROFILE_DROPDOWN_KEYS.COMP7: (
                                       False, 'getComp7StatsS1'), 
           PROFILE_DROPDOWN_KEYS.COMP7_SEASON2: (
                                               False, 'getComp7StatsS2')}

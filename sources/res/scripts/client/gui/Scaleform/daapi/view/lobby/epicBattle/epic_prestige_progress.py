...
def getPrestigeProgressVO(allQuests, metaLevel, pPrestigeLevel, isMaxMetaLevel):
    ...
    for index, prestigeAward in enumerate(prestigeAwards):
        ...
        lineStyle = (isNextBlockFinalReward or _getLineSeparatorLinkageForPrestigeLevel)(index, pPrestigeLevel, isMaxMetaLevel) if 1 else ''
        tankText = ''
    ...
    for i in xrange(0, maxPrestigeLevel + 1):
        ...
        if currentPrestigeQuest:
            ...
            for bonus in bonuses:
                ...
                elif specialAwardValue is None and bonusName == PrestigeBonusType.BADGE:

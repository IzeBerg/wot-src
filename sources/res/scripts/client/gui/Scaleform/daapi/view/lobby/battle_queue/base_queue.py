import datetime, logging, weakref, BigWorld, MusicControllerWWISE, constants
...
class _RTSQueueProvider(_RandomQueueProvider):
    ...
    def _getModesToProcess(self):
        ...
        if queueType in [constants.QUEUE_TYPE.RTS_1x1, constants.QUEUE_TYPE.RTS_BOOTCAMP]:
            return [constants.RTSQueueModes.COMMANDERS]
        return constants.RTSQueueModes.ALL
    ...
    def additionalInfo(self):
        ...
        if self.__additionalInfoType == self.AdditionalInfoType.SPG_TANKER:
            return text_styles.main(backport.text(strPath.longSpgQueueTime()))
        return ''

...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.BOOTCAMP_OUTRO_VIDEO, BCOutroVideoPage, 'BCOutroVideo.swf', WindowLayer.TOP_WINDOW, VIEW_ALIAS.BOOTCAMP_OUTRO_VIDEO, ScopeTemplates.TOP_WINDOW_SCOPE, canClose=False, canDrag=True),
...
class BootcampPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __queueDialogShow(self, _):
        ctx = {'backgroundImage': '../maps/login/back_25_without_sparks.png', 'lessonNumber': g_bootcamp.getLessonNum(), 'timeout': g_bootcamp.getContextIntParameter('lessonQueueTimeout', 15)}

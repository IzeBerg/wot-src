...
_ALL_NATIONS = -1
_EXCLUDED_VEHICLE_CRITERIA = (~REQ_CRITERIA.IN_OWNERSHIP, ~REQ_CRITERIA.VEHICLE.IS_PREMIUM_IGR,
 ~REQ_CRITERIA.VEHICLE.PREMIUM, ~REQ_CRITERIA.VEHICLE.EVENT,
 ~REQ_CRITERIA.VEHICLE.SECRET, ~REQ_CRITERIA.COLLECTIBLE)
...
class LinkedSetVehicleListPopup(VehicleListPopupMeta):
    ...
    def onSelectVehicles(self, vehicleCD):
        ...
        ctx = {'vehicleCD': vehicleCD, 'shortUserName': vehicleVO['shortUserName']}

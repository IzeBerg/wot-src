...
class _DamageRibbonClassFactory(_RibbonClassFactory):
    __slots__ = ('__damageCls', '__fireCls', '__ramCls', '__wcCls', '__artDmgCls',
                 ...
                 '__damagedBySmoke', '__phaseChangeCls')
...
_RIBBON_TYPES_EXCLUDED_IN_POSTMORTEM = (
 BATTLE_EFFICIENCY_TYPES.RECEIVED_CRITS,)
_NOT_CACHED_RIBBON_TYPES = (
 BATTLE_EFFICIENCY_TYPES.DETECTION, BATTLE_EFFICIENCY_TYPES.DEFENCE, BATTLE_EFFICIENCY_TYPES.STUN) + tuple(BATTLE_EFFICIENCY_TYPES.BUFFS_SET)
_ACCUMULATED_RIBBON_TYPES = (
 BATTLE_EFFICIENCY_TYPES.CAPTURE, BATTLE_EFFICIENCY_TYPES.BASE_CAPTURE_BLOCKED) + tuple(BATTLE_EFFICIENCY_TYPES.BUFFS_SET)

...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.EPIC_BATTLE_PAGE, page.EpicBattlePage, 'epicBattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
...
class EpicBattlePageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        super(EpicBattlePageBusinessHandler, self).__init__((
         (
          BATTLE_VIEW_ALIASES.BATTLE_TANK_CAROUSEL_FILTER_POPOVER, self.loadViewByCtxEvent),), APP_NAME_SPACE.SF_BATTLE, EVENT_BUS_SCOPE.BATTLE)

...
class BCMessageWindow(BCMessageWindowMeta):
    ...
    def __setCameraDisabled(self, disabled):
        self.fireEvent(CameraRelatedEvents(CameraRelatedEvents.FORCE_DISABLE_IDLE_PARALAX_MOVEMENT, ctx={'isDisable': disabled, 'setIdle': True, 'setParallax': True}), EVENT_BUS_SCOPE.LOBBY)

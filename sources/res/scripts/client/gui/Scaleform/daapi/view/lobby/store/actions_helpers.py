...
_gold_bonus_list = (
 'slotsPrices', 'berthsPrices', 'premiumPacket1Cost',
...
class VehPriceActionInfo(ActionInfo):
    ...
    def __getCommonStatsBlock(self, vehicle):
        _params = {VEHICLE_CLASS_NAME.LIGHT_TANK: (
                                         ...
                                         'chassisRotationSpeed', 'circularVisionRadius',
           ...
           VEHICLE_CLASS_NAME.MEDIUM_TANK: (
                                          ...
                                          'chassisRotationSpeed', TURBOSHAFT_SPEED_MODE_SPEED,
...
def getEconomicalStatsDict():
    ...
    return {'exchangeRate': shop.exchangeRate, 'slotsPrices': shop.slotsPrices[1][0], 

...
class _RestoreVehiclesDataProvider(StorageCarouselDataProvider):
    ...
    def _addCriteria(self):
        self._addVehicleItemsByCriteria(self._baseCriteria | ~REQ_CRITERIA.VEHICLE.WOT_PLUS_VEHICLE | REQ_CRITERIA.VEHICLE.ACTIVE_IN_NATION_GROUP | ~REQ_CRITERIA.VEHICLE.HIDDEN_IN_HANGAR)

...
class BattleSessionWindow(BattleSessionWindowMeta):
    ...
    def __updateCommonRequirements(self, teamLimits, rosters):
        ...
        self.as_setPlayersCountTextS(makeHtmlString('html_templates:lobby/prebattle', 'specBattlePlayersCount', {'membersCount': playersCount, 'maxMembersCount': playersMaxCount}))

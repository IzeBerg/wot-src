...
_ENABLE_CONTROL_MODE = {
 ...
 PageStates.RADIAL,
 PageStates.LOADING}
_PAGE_STATE_TO_CONTROL_PARAMS = {PageStates.TABSCREEN: (BATTLE_VIEW_ALIASES.FULL_STATS, True, True), PageStates.RESPAWN: (
...
_STATE_TO_UI = {PageStates.GAME: _GAME_UI, 
   PageStates.LOADING: {
                      BATTLE_VIEW_ALIASES.BATTLE_LOADING, BATTLE_VIEW_ALIASES.EPIC_DEPLOYMENT_MAP}, 
   PageStates.TABSCREEN: {
                        BATTLE_VIEW_ALIASES.FULL_STATS, BATTLE_VIEW_ALIASES.DEBUG_PANEL,
                        BATTLE_VIEW_ALIASES.GAME_MESSAGES_PANEL}, 
   ...
   PageStates.COUNTDOWN: _GAME_UI.difference({BATTLE_VIEW_ALIASES.EPIC_REINFORCEMENT_PANEL,
                        BATTLE_VIEW_ALIASES.EPIC_MISSIONS_PANEL,
                        BATTLE_VIEW_ALIASES.GAME_MESSAGES_PANEL}).union({BATTLE_VIEW_ALIASES.PREBATTLE_TIMER}), 

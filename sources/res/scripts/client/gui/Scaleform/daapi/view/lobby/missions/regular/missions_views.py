...
from gui.server_events.events_helpers import isMarathon, isDailyQuest, isPremium, isCosmicQuest
...
class MissionsCategoriesView(_GroupedMissionsView):
    ...
    def getViewQuestFilter():
        return lambda q: not (isMarathon(q.getGroupID()) or isPremium(q.getGroupID()) or isDailyQuest(q.getID()) or isCosmicQuest(q.getID()))

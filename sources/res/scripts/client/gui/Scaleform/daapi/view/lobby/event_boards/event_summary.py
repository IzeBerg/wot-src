...
class _Summary(object):
    ...
    def getHeader(self):
        ...
        status = (self._event.isFinished() or formatUpdateTime)(recalculationTS) if 1 else ''
        ...
        return {'title': title, 
           ...
           'statusTooltip': (self._event.isFinished() or self._getStatusTooltip)() if 1 else ''}
...
class _SummaryTable(_Summary):
    ...
    def _getTableHeaderData(self):
        result = [
         {'tooltip': makeTooltip(TOOLTIPS.ELEN_SUMMARY_TABLE_PLATOON_HEADER, TOOLTIPS.ELEN_SUMMARY_TABLE_PLATOON_BODY), 

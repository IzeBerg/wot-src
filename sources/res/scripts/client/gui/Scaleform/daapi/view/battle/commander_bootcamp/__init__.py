...
def getContextMenuHandlers():
    ...
    return (
     ...
     (
      BATTLE_CONTEXT_MENU_HANDLER_TYPE.COMMANDER_VEHICLES_PANEL, vehicles_panel.VehiclesPanelContextMenuHandler))
...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.COMMANDER_BOOTCAMP_BATTLE_PAGE, BCCommanderBattlePage, 'BCCommanderBattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
...
def getBusinessHandlers():
    return (
     _RTSBootcamBattlePackageBusinessHandler(),)
...
class _RTSBootcamBattlePackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        ...
        listeners = (
         (
          VIEW_ALIAS.COMMANDER_BOOTCAMP_BATTLE_PAGE, self._loadPage),
         (

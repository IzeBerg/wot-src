import BigWorld, BattleReplay, aih_constants, WWISE
...
_COMMANDER_EXTERNAL_COMPONENTS = (
 crosshair.CrosshairPanelContainer, markers2d.CommanderMarkersManager)
_CAMERA_RELATED_CMPS = (
 BATTLE_VIEW_ALIASES.VEHICLE_MESSAGES, BATTLE_VIEW_ALIASES.SIXTH_SENSE)
_TANKMAN_RELATED_COMPONENTS = (
 BATTLE_VIEW_ALIASES.BATTLE_MESSENGER, BATTLE_VIEW_ALIASES.DAMAGE_PANEL,
 BATTLE_VIEW_ALIASES.RIBBONS_PANEL, BATTLE_VIEW_ALIASES.BATTLE_DAMAGE_LOG_PANEL,
 BATTLE_VIEW_ALIASES.TIMERS_PANEL, BATTLE_VIEW_ALIASES.CONSUMABLES_PANEL)
_TANKMAN_HIDDEN_COMPONENTS = (
 BATTLE_VIEW_ALIASES.COMMANDER_VEHICLE_SELECTION, BATTLE_VIEW_ALIASES.COMMANDER_VEHICLES_PANEL)
_COMMANDER_RELATED_COMPONENTS = (
 BATTLE_VIEW_ALIASES.COMMANDER_VEHICLE_SELECTION, BATTLE_VIEW_ALIASES.COMMANDER_VEHICLES_PANEL,
 BATTLE_VIEW_ALIASES.BATTLE_DAMAGE_LOG_PANEL)
_COMMANDER_HIDDEN_COMPONENTS = (
 BATTLE_VIEW_ALIASES.BATTLE_MESSENGER, BATTLE_VIEW_ALIASES.DAMAGE_PANEL, BATTLE_VIEW_ALIASES.RIBBONS_PANEL,
 BATTLE_VIEW_ALIASES.TIMERS_PANEL, BATTLE_VIEW_ALIASES.CONSUMABLES_PANEL, BATTLE_VIEW_ALIASES.COMMANDER_HELP)
...
class CommonRTSComponentsConfig(ComponentsConfig):
    ...
    def __init__(self):
        super(CommonRTSComponentsConfig, self).__init__((
         (
         ...
         (
          ...
          (
           BATTLE_VIEW_ALIASES.COMMANDER_SPAWN_MENU,)),
         (
          BATTLE_CTRL_ID.TEAM_SIXTH_SENSE,
          (
           BATTLE_VIEW_ALIASES.SIXTH_SENSE,
           _DynamicAliases.SIXTH_SENSE_SOUND,
           _DynamicAliases.COMMANDER_VEHICLES_MGR_PROXY))), viewsConfig=(
         (
          DynamicAliases.PREBATTLE_TIMER_SOUND_PLAYER, StartCountdownSoundPlayer),
         (
          _DynamicAliases.SIXTH_SENSE_SOUND, SixthSenseSound),
         (
...
BASE_COMMANDER_EXTENDED_CMPNTS = ComponentsConfig(config=(
 ...
 (
  'r4FinishSoundPlayer', finish_sound_player.R4FinishSoundPlayer)))

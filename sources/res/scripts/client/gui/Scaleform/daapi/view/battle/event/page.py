...
class EventBattlePage(EventBattlePageMeta, GameEventGetterMixin):
    ...
    def _onCollectorProgressStop(self, _):
        panels = {
         BATTLE_VIEW_ALIASES.RIBBONS_PANEL, BATTLE_VIEW_ALIASES.EVENT_BUFFS_PANEL}
    ...
    def _onRespawnBaseMoving(self):
        ...
        self._setComponentsVisibilityDependingStats(visible={BATTLE_VIEW_ALIASES.CONSUMABLES_PANEL,
         BATTLE_VIEW_ALIASES.RIBBONS_PANEL}, hidden={

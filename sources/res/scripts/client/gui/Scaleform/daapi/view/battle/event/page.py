...
_HUNTER_VIEW_COMPONENTS = (
 BATTLE_VIEW_ALIASES.EVENT_REINFORCEMENT_PANEL, BATTLE_VIEW_ALIASES.BATTLE_MESSENGER)
...
class EventBattlePage(ClassicPage, ISpawnListener):
    ...
    def showSpawnPoints(self):
        ...
        visibleComponents = {
         ...
         BATTLE_VIEW_ALIASES.MINIMAP} | self._spawnVisibleComponents
    ...
    def _onBattleLoadingFinish(self):
        ...
        if self.__isBoss():
            self._blToggling -= {BATTLE_VIEW_ALIASES.BATTLE_MESSENGER,
             BATTLE_VIEW_ALIASES.EVENT_REINFORCEMENT_PANEL}

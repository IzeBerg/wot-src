...
_EVENT_EXTERNAL_COMPONENTS = (
 EventMarkersManager, KillCamMarkersManager, EventCrosshairPanelContainer)
...
class EventBattlePage(ClassicPage, ISpawnListener):
    ...
    def __onRoundFinished(self, winningTeam, reason):
        hiddenComponents = {BATTLE_VIEW_ALIASES.EVENT_BOSS_WIDGET, BATTLE_VIEW_ALIASES.EVENT_MINI_BOSS_WIDGET,
         BATTLE_VIEW_ALIASES.BATTLE_HINT}
    ...
    def __setVisibilityInitBattlePeriod(self):
        visibleComponents = {
         BATTLE_VIEW_ALIASES.PLAYERS_PANEL_EVENT,
         BATTLE_VIEW_ALIASES.EVENT_BOSS_WIDGET, BATTLE_VIEW_ALIASES.EVENT_MINI_BOSS_WIDGET}

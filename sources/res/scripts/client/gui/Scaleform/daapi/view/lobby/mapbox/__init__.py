...
def getViewSettings():
    ...
    return (
     ViewSettings(MAPBOX_ALIASES.MAPBOX_PRIME_TIME, MapboxPrimeTimeView, HANGAR_ALIASES.RANKED_PRIME_TIME, WindowLayer.SUB_VIEW, MAPBOX_ALIASES.MAPBOX_PRIME_TIME, ScopeTemplates.LOBBY_TOP_SUB_SCOPE, True),)

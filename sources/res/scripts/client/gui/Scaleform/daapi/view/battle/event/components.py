...
class EventGoalUpdateComponent(IEventPluginComponent, GameEventComponent):
    ...
    def _getCollectorMarker(self, collectorID=None):
        ...
        if collectorID != INVALID_MARKER_ID:
            return self._getMarkerFromTargetID(collectorID, MarkerType.BASE_MARKER_TYPE)
        else:
            return
    ...
    def _getCurrentCollectorSoulsInfo(self):
        ...
        if battleGoals:
            return battleGoals.getCurrentCollectorSoulsInfo()
        return (0, 0)

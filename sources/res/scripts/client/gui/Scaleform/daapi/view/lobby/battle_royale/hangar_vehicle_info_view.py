...
def _getTabData():
    return (
     {'viewId': BATTLEROYALE_ALIASES.VEH_MODULES_CONFIGURATOR_CMP, 
        ...
        'tooltipSpecialId': TOOLTIPS_CONSTANTS.BATTLE_ROYALE_BATTLE_PROGRESSION},
     {'viewId': BATTLEROYALE_ALIASES.VEHICLE_WEAK_ZONES_CMP, 
...
class HangarVehicleInfo(BattleRoyaleVehicleInfoMeta, IGlobalListener):
    ...
    def __showIntroPage(self):
        self.__introPage = _HangarVehicleInfoIntroWindow(ctx={'vehicle': self.__vehicle, 'firstView': self.__isFirstEnter})

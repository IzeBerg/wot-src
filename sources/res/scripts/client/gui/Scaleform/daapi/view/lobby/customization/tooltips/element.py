...
class SimpleCustomizationTooltip(BlocksTooltipData):
    ...
    def _packNonHistoricBlock(topPadding):
        ...
        blocks = [
         formatters.packImageTextBlockData(title=text_styles.middleTitle(backport.text(nonHistoricTitle())), img=backport.image(img()), imgPadding={'left': -3, 'top': -4}, padding={'top': topPadding}),

...
class NYResourcesFormatter(OldStyleBonusFormatter):
    ...
    def accumulateBonuses(self, bonus, event=None):
        ...
        block = formatters.packSingleLineBonusesBlock([
         text_styles.main(label)], specialTooltip=tooltipData.tooltip, isWulfTooltip=tooltipData.isWulfTooltip, tooltipArgs=tooltipData.specialArgs)
...
class NYCoinFormatter(OldStyleBonusFormatter):
    ...
    def accumulateBonuses(self, bonus, event=None):
        ...
        tooltipData = bonus.getTooltipData()
        block = formatters.packSingleLineBonusesBlock([
         text_styles.main(label)], specialTooltip=tooltipData.tooltip if tooltipData else None, isWulfTooltip=tooltipData.isWulfTooltip if tooltipData else None, tooltipArgs=tooltipData.specialArgs if tooltipData else None)
        self._result.append(block)
        return
...
class OldStyleAwardsPacker(AwardsPacker):
    ...
    def format(self, bonuses, event=None):
        ...
        fmts = [
         self.__ny23RandomResourcesFormatter, self.__lootBoxFormatter, self.__defaultFormatter,
         self.__newStyleFormatter, self.__nyResourcesFormatter,

...
class NYResourcesFormatter(OldStyleBonusFormatter):
    ...
    def accumulateBonuses(self, bonus, event=None):
        ...
        block = formatters.packSingleLineBonusesBlock([
         text_styles.main(label)], specialTooltip=tooltipData.tooltip, tooltipArgs=tooltipData.specialArgs, isWulfTooltip=True)
...
class NYCoinFormatter(OldStyleBonusFormatter):
    ...
    def accumulateBonuses(self, bonus, event=None):
        ...
        tooltipData = bonus.getTooltipData()
        block = formatters.packSingleLineBonusesBlock([
         text_styles.main(label)], specialTooltip=tooltipData.tooltip if tooltipData else None, tooltipArgs=tooltipData.specialArgs if tooltipData else None, isWulfTooltip=True)
        self._result.append(block)
        return

...
def getBusinessHandlers():
    return (
     _ExchangeDialogBusinessHandler(), _ExchangeViewsBusinessHandler(), _ExchangeDialogModalBusinessHandler())
...
class _ExchangeDialogBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          ShowDialogEvent.SHOW_EXCHANGE_DIALOG, self.__exchangeDialogHandler),)
...
class _ExchangeDialogModalBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          ShowDialogEvent.SHOW_EXCHANGE_DIALOG_MODAL, self.__exchangeDialogHandler),)

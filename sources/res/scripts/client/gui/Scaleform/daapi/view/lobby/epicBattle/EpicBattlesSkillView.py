...
_SKILL_LEVEL_TEXTS = [
 ...
 'IV',
 'V']
EpicBattlesSkillViewVO = namedtuple('EpicBattlesSkillViewVO', ('skillPoints', 'skills',
                                                               'skillsLabel', 'header',
                                                               'headerBig', 'showBackButton',
                                                               'showSkillPoints',
                                                               'skillInfo', 'backgroundImageSrc'))
EpicBattleSkillVO = namedtuple('EpicBattleSkillVO', ('skillID', 'level', 'maxLevel',
                                                     'title', 'smallTitle', 'desc',
                                                     'label', 'skillLevelLabels',
                                                     'iconUrl'))
...
class EpicBattlesSkillView(LobbySubView, EpicBattlesSkillViewMeta):
    ...
    def __getUnspentPointsStr(self, showSkillPoint):
        if showSkillPoint:
            return text_styles.highlightText(EPIC_BATTLE.METAABILITYSCREEN_UNSPENT_POINTS)
        return text_styles.tutorial(EPIC_BATTLE.METAABILITYSCREEN_GET_SKILL_POINTS)

...
class ArenasCache(object):
    ...
    def __getArenaTypeName(self, arena):
        ...
        if i18n.doesTextExist(arenaGameplayName):
            return i18n.makeString(arenaGameplayName)
        return i18n.makeString('#arenas:type/%s/name' % arena.gameplayName)
...
class TrainingSettingsWindow(TrainingWindowMeta):
    ...
    __INFLUENCING_CONFIG_KEYS = {
     Configs.PRE_MODERATION_CONFIG.value, Configs.COMP7_CONFIG.value}

...
import typing, BigWorld, SoundGroups, aih_constants
...
_CommanderHelpButtonData = namedtuple('CommanderHelpButtonData', ['index', 'key', 'behaviour', 'commandIcon'])
...
class CommanderHelp(CommanderHelpMeta):
    ...
    _MODIFIER_ORDER = (
     _MODIFIER_RETREAT_ORDER,
     _MODIFIER_APPEND_ORDER,
     _MODIFIER_FORCE_ORDER)
    _ORDERS_LIST = [
     _CommanderHelpButtonData(index=0, key=MappedKeys.KEY_CONTROL_VEHICLE, behaviour=_DIRECT_ORDER, commandIcon='controlVehicle'),

import operator, BigWorld, SoundGroups, constants
...
class PersonalCaseDataProvider(object):
    ...
    def getTabsButtons(self, showDocumentTab):
        tabs = [
         {'index': TABS.STATS_TAB_INDEX, 
            'label': MENU.TANKMANPERSONALCASE_TABBATTLEINFO, 
            'linkage': TABS.PERSONAL_CASE_STATS},
         {'index': TABS.TRAINING_TAB_INDEX, 
            'label': MENU.TANKMANPERSONALCASE_TABTRAINING, 
            'linkage': TABS.PERSONAL_CASE_RETRAINING},
         {'index': TABS.SKILLS_TAB_INDEX, 

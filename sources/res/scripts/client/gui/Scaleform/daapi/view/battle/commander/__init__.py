...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.COMMANDER_BATTLE_PAGE, CommanderBattlePage, 'commanderBattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
...
def getBusinessHandlers():
    return (
     _RTSBattlePackageBusinessHandler(),)
...
class _RTSBattlePackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          VIEW_ALIAS.COMMANDER_BATTLE_PAGE, self._loadPage),)

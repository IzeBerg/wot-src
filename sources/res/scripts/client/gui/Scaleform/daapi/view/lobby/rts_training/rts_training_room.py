...
class RtsTrainingRoom(TrainingRoomBase):
    ...
    def showTrainingSettings(self):
        ...
        self.fireEvent(events.LoadViewEvent(SFViewLoadParams(PREBATTLE_ALIASES.RTS_TRAINING_SETTINGS_WINDOW_PY), ctx={'isCreateRequest': False, 'settings': settings}), scope=EVENT_BUS_SCOPE.LOBBY)

...
def getViewSettings():
    ...
    return (
     ...
     GroupedViewSettings(HANGAR_ALIASES.COMP7_PUNISHMENT_DIALOG, PunishmentDialog, 'comp7PunishmentDialog.swf', WindowLayer.TOP_WINDOW, '', None, ScopeTemplates.DYNAMIC_SCOPE, isModal=True, canDrag=False),

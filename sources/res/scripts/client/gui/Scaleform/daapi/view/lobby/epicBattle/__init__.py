...
def getViewSettings():
    ...
    return (
     ViewSettings(EPICBATTLES_ALIASES.EPIC_BATTLES_SKILL_ALIAS, EpicBattlesSkillView, EPICBATTLES_ALIASES.EPIC_BATTLES_SKILL_VIEW_UI, WindowLayer.SUB_VIEW, EPICBATTLES_ALIASES.EPIC_BATTLES_SKILL_ALIAS, ScopeTemplates.LOBBY_SUB_SCOPE, True),
...
class EpicMetaGamePackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          EPICBATTLES_ALIASES.EPIC_BATTLES_SKILL_ALIAS, self.loadViewByCtxEvent),
         (

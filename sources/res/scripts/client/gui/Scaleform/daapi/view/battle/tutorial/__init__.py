...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.TUTORIAL_BATTLE_PAGE, TutorialPage, 'tutorialPage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
...
def getBusinessHandlers():
    return (
     _TutorialPackageBusinessHandler(),)
...
class _TutorialPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          VIEW_ALIAS.TUTORIAL_BATTLE_PAGE, self.loadViewBySharedEvent),)

import logging, BigWorld, nations
...
class HangarHeader(HangarHeaderMeta, IGlobalListener, IEventBoardsListener):
    ...
    def __updateBattlePassSmallWidget(self):
        ...
        secondaryPointCanBeAvailable = currentArenaBonusType not in (
         ARENA_BONUS_TYPE.REGULAR, ARENA_BONUS_TYPE.UNKNOWN, ARENA_BONUS_TYPE.MAPBOX,
         ARENA_BONUS_TYPE.RTS, ARENA_BONUS_TYPE.RTS_1x1, ARENA_BONUS_TYPE.RTS_BOOTCAMP)

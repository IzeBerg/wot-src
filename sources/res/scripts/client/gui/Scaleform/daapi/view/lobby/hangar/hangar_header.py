...
class HangarHeader(HangarHeaderMeta, IGlobalListener, IEventBoardsListener):
    ...
    def __getBattleQuestsVO(self, vehicle):
        ...
        quests = [
         self._headerQuestFormaterVo(enable=totalCount > 0, icon=commonQuestsIcon, label=label, questType=questType, flag=festivityFlagData.flagBackground, tooltip=TOOLTIPS_CONSTANTS.QUESTS_PREVIEW, isTooltipSpecial=True)]

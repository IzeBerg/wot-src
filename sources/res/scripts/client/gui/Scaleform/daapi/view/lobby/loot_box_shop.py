...
_WEB_API_MG_COLLECTION = (
 ...
 LootBoxWebApi,
 PlatformWebApi)
_WEB_SETTINGS_MAP = {ToySettings.NEW_YEAR: 'ny/', ToySettings.CHRISTMAS: 'christmas/', ToySettings.FAIRYTALE: 'magic/', 
...
class LootBoxShopOverlay(WebView):
    ...
    def __onServerSettingsChanged(self, diff):
        if not self.__lobbyContext.getServerSettings().isLootBoxesEnabled():
            ...
            if diff.get(NY_CONFIG_NAME, {}).get(NYLootBoxConsts.CONFIG_NAME) is None:
                return

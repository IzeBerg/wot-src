...
REGULAR_UPPER_STATIC_SHORTCUTS = (
 Shortcut(title=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, action=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, icon=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, groups=[
  ...
  RADIAL_MENU_CONSTS.TARGET_STATE_EVENT_CAMP, RADIAL_MENU_CONSTS.TARGET_STATE_EVENT_COLLECTOR,
 ...
 Shortcut(title=INGAME_HELP.EVENTRADIALMENU_COLLECTOR, action=BATTLE_CHAT_COMMAND_NAMES.DEFENDING_BASE, icon=RADIAL_MENU_CONSTS.EVENT_COLLECTOR, groups=[
  RADIAL_MENU_CONSTS.TARGET_STATE_EVENT_COLLECTOR], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIRST),
 Shortcut(title=INGAME_HELP.EVENTRADIALMENU_CAMP, action=BATTLE_CHAT_COMMAND_NAMES.ATTACKING_BASE, icon=RADIAL_MENU_CONSTS.EVENT_CAMP, groups=[
  RADIAL_MENU_CONSTS.TARGET_STATE_EVENT_CAMP], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIRST))
...
def getKeyFromAction(action):
    if action in (BATTLE_CHAT_COMMAND_NAMES.DEFEND_BASE, BATTLE_CHAT_COMMAND_NAMES.ATTACK_BASE,
    ...
    elif action in (BATTLE_CHAT_COMMAND_NAMES.DEFENDING_BASE, BATTLE_CHAT_COMMAND_NAMES.ATTACKING_BASE,

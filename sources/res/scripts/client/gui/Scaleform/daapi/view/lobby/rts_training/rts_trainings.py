...
class RtsTrainings(TrainingsListBase):
    ...
    def createTrainingRequest(self):
        ...
        self.fireEvent(events.LoadViewEvent(SFViewLoadParams(PREBATTLE_ALIASES.RTS_TRAINING_SETTINGS_WINDOW_PY), ctx={'isCreateRequest': True, 'settings': settings}), scope=EVENT_BUS_SCOPE.LOBBY)
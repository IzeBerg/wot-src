...
class EventStatisticsDataController(ClassicStatisticsDataController):
    ...
    def _createExchangeBroker(self, exchangeCtx):
        ...
        exchangeBroker.setVehiclesInfoExchange(vehicle.VehiclesExchangeBlock(EventVehicleInfoComponent(), positionComposer=broker.BiDirectionComposer(), idsComposers=(
         vehicle.TeamsSortedIDsComposer(EventVehicleInfoSortKey),
         vehicle.TeamsCorrelationIDsComposer()), statsComposers=None))
        exchangeBroker.setVehiclesStatsExchange(vehicle.VehiclesExchangeBlock(EventVehicleStatsComponent(), positionComposer=broker.BiDirectionComposer(), idsComposers=None, statsComposers=(
         vehicle.TotalStatsComposer(),)))
        exchangeBroker.setVehicleStatusExchange(EventVehicleStatusComponent(idsComposers=(
         vehicle.TeamsSortedIDsComposer(EventVehicleInfoSortKey),

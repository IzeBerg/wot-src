...
class EventStatisticsDataController(BattleStatisticsDataController):
    ...
    def _createExchangeBroker(self, exchangeCtx):
        ...
        exchangeBroker.setVehiclesStatsExchange(vehicle.VehiclesExchangeBlock(VehicleWinPointsComponent(), positionComposer=broker.BiDirectionComposer(), idsComposers=None, statsComposers=(
         vehicle.TotalStatsComposer(),)))
        exchangeBroker.setVehicleStatusExchange(vehicle.VehicleStatusComponent(idsComposers=None, statsComposers=(
         vehicle.TotalStatsComposer(),)))

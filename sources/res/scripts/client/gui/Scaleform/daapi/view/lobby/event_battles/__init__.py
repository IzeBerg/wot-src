...
def getViewSettings():
    ...
    return (
     ViewSettings(EVENT_BATTLES_ALIASES.EVENT_PRIME_TIME_VIEW, WTEventPrimeTimeView, HANGAR_ALIASES.WT_EVENT_PRIME_TIME, WindowLayer.TOP_SUB_VIEW, EVENT_BATTLES_ALIASES.EVENT_PRIME_TIME_VIEW, ScopeTemplates.LOBBY_TOP_SUB_SCOPE, True),)


def getBusinessHandlers():
    return (
     EventPackageBusinessHandler(),)
...
class EventPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          EVENT_BATTLES_ALIASES.EVENT_PRIME_TIME_VIEW, self.loadViewByCtxEvent),)

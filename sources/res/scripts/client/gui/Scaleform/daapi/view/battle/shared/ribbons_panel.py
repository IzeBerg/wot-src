...
_BATTLE_EVENTS_SETTINGS_TO_BATTLE_EFFICIENCY_TYPES = {BATTLE_EVENTS.ENEMY_HP_DAMAGE: (
   ...
   BATTLE_EVENTS.RECEIVED_DAMAGE: (
                                 ...
                                 _BET.RECEIVED_BY_MINEFIELD, _BET.RECEIVED_BY_SMOKE, _BET.EVENT_DEATH_ON_PHASE_CHANGE), 
    ...
    def __setupView(self):
        ribbons = [
         ...
         [
          ...
          backport.text(R.strings.ingame_gui.efficiencyRibbons.eventDeathOnPhaseChange())],
         [
          _BET.STUN,
        ...
        if self.sessionProvider.arenaVisitor.gui.isEventBattle():
            ribbons.extend([
             [
              _BET.BUFFS_RATION,
              backport.text(R.strings.event.efficiencyRibbons.ration.title())],
             [
              _BET.BUFFS_FUEL,
              backport.text(R.strings.event.efficiencyRibbons.fuel.title())],
             [
              _BET.BUFFS_RATE_FIRE,
              backport.text(R.strings.event.efficiencyRibbons.multiplyGunReloadTime.title())],
             [
              _BET.BUFFS_CONVERSION_SPEED,
              backport.text(R.strings.event.efficiencyRibbons.multiplyShotDispersion.title())],
             [
              _BET.BUFFS_INCREASED_MAXIMUM_DAMAGE,
              backport.text(R.strings.event.efficiencyRibbons.multiplyDamageBy10.title())],
             [
              _BET.BUFFS_DOUBLE_DAMAGE,
              backport.text(R.strings.event.efficiencyRibbons.damageOnceOnShot.title())],
             [
              _BET.BUFFS_INCENDIARY_SHOT,
              backport.text(R.strings.event.efficiencyRibbons.igniteOnShot.title())],
             [
              _BET.BUFFS_VAMPIRIC_SHOT,
              backport.text(R.strings.event.efficiencyRibbons.healOnceOnShot.title())],
             [
              _BET.BUFFS_CONSTANT_HP_REGENERATION,
              backport.text(R.strings.event.efficiencyRibbons.regenerationHP.title())],
             [
              _BET.BUFFS_ARMOR,
              backport.text(R.strings.event.efficiencyRibbons.armor.title())],
             [
              _BET.EVENT_HEAL_UP,
              backport.text(R.strings.event.efficiencyRibbons.eventHealUp.title())],
             [
              _BET.EVENT_ADD_AMMO,
              backport.text(R.strings.event.efficiencyRibbons.eventAddAmmo.title())]])

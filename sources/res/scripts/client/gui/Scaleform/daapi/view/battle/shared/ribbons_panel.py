    ...
    def __setupView(self):
        self.as_setupS([
         ...
         [
          ...
          backport.text(R.strings.ingame_gui.efficiencyRibbons.receivedBySmoke())]], self.__isExtendedAnim, self.__enabled, self.__isWithRibbonName, self.__isWithVehName, [

...
EpicBattlesWidgetVO = namedtuple('EpicBattlesWidgetVO', ('calendarStatus', 'showAlert',
...
class EpicBattlesWidget(EpicBattlesWidgetMeta):
    ...
    def __getQuestsVO(self):
        ...
        quests = [
         self._headerQuestFormatterVo(totalCount > 0, backport.image(commonQuestsIcon), label, HANGAR_HEADER_QUESTS.QUEST_TYPE_COMMON, flag=backport.image(self.__eventProgression.flagIconId), tooltip=TOOLTIPS_CONSTANTS.EPIC_QUESTS_PREVIEW, isTooltipSpecial=True)]
        return [
         self.__wrapQuestGroup(HANGAR_HEADER_QUESTS.QUEST_GROUP_COMMON, '', quests)]

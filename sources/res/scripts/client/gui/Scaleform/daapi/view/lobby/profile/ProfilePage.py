    ...
    def __getSectionsData(self, resetSelectedAlias=False):
        ...
        if self.__collectionsSystem.isEnabled():
            sectionsData.append((
             ...
             True,
             'statsCollections'))
        return {'sectionsData': [ {'label': makeString(label), 'tooltip': tooltip, 'alias': alias, 'enabled': isEnabled, 'id': uiId} for label, tooltip, alias, isEnabled, uiId in sectionsData
                         ], 

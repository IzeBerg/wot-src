...
class BATTLE_EFFICIENCY_TYPES(object):
    ...
    BUFFS_SET = [BUFFS_RATION, BUFFS_FUEL, BUFFS_RATE_FIRE, BUFFS_CONVERSION_SPEED, BUFFS_INCREASED_MAXIMUM_DAMAGE, BUFFS_DOUBLE_DAMAGE, BUFFS_INCENDIARY_SHOT, BUFFS_VAMPIRIC_SHOT, BUFFS_CONSTANT_HP_REGENERATION, BUFFS_ARMOR]
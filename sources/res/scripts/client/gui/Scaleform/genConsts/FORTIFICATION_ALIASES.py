...
class FORTIFICATION_ALIASES(object):
    ...
    FLASH_ALIASES = [FORT_BATTLE_ROOM_LIST_VIEW_UI, FORT_BATTLE_ROOM_VIEW_UI, FORT_CLAN_BATTLE_LIST_VIEW_UI, STRONGHOLD_BATTLE_ROOM_VIEW_UI, FORT_CLAN_BATTLE_ROOM_VIEW_UI, STRONGHOLD_BATTLE_ROOM_LIST_VIEW_UI]
    PYTHON_ALIASES = [FORT_BATTLE_ROOM_LIST_VIEW_PY, FORT_BATTLE_ROOM_VIEW_PY, FORT_CLAN_BATTLE_LIST_VIEW_PY, STRONGHOLD_BATTLE_ROOM_VIEW_PY, FORT_CLAN_BATTLE_ROOM_VIEW_PY, STRONGHOLD_BATTLE_ROOM_LIST_VIEW_PY]
    STATE_TROWEL = 0
    STATE_FOUNDATION = 1

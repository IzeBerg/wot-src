...
class TOOLTIPS_CONSTANTS(object):
    ...
    ACHIEVEMENTS_SET = [BATTLE_STATS_ACHIEVS, BATTLE_STATS_MARKS_ON_GUN_ACHIEVEMENT, ACHIEVEMENT, MARKS_ON_GUN_ACHIEVEMENT, GLOBAL_RATING, MARK_OF_MASTERY, ACHIEVEMENT_ATTR, SHOP_ACHIEVEMENT, SHOP_BADGE, REFERRAL_BADGE, LUNAR_NY_PROGRESSION_ACHIEVS]
    BOOSTERS_SET = [INVENTORY_BATTLE_BOOSTER, AWARD_BATTLE_BOOSTER, EPIC_AWARD_BATTLE_BOOSTER, BATTLE_BOOSTER_BLOCK, DEFAULT_BATTLE_BOOSTER, SHOP_BATTLE_BOOSTER, BATTLE_BOOSTER_COMPARE, BOOSTERS_BOOSTER_INFO, CLAN_RESERVE_INFO, BOOSTER, SHOP_BOOSTER, BOOSTERS_QUESTS, NATION_CHANGE_BATTLE_BOOSTER]
    ...
    CUSTOMIZATION_SET = [TECH_CUSTOMIZATION_ITEM, TECH_CUSTOMIZATION_NONHISTORIC_ITEM, TECH_CUSTOMIZATION_FANTASTICAL_ITEM, TECH_CUSTOMIZATION_POPOVER_ITEM, TECH_CUSTOMIZATION_ITEM_ICON, TECH_CUSTOMIZATION_ITEM_AWARD, TECH_CUSTOMIZATION_ITEM_PURCHASE, SHOP_CUSTOMIZATION_ITEM, TECH_CUSTOMIZATION_CHAINED_ITEM, COLLAPSE_CUSTOMIZATION_ITEM_AWARD]
    ...
    EPIC_BATTLE_SET = [EPIC_SKILL_INFO, EPIC_SKILL_SLOT_INFO, EPIC_SKILL_SLOT_SETUP_INFO, EPIC_QUESTS_PREVIEW, EPIC_BATTLE_COMPLETED_QUESTS_INFO, EPIC_BATTLE_SELECTOR_INFO, EPIC_BATTLE_CALENDAR_INFO, EPIC_BATTLE_WIDGET_INFO]
    EPIC_IN_BATTE_SET = [EPIC_RANK_UNLOCK_INFO]
    PERSONAL_MISSION_SET = [PERSONAL_QUESTS_PREVIEW, PERSONAL_MISSIONS_TANKWOMAN, PERSONAL_MISSIONS_TANKMODULE, FREE_SHEET, FREE_SHEET_RETURN, FREE_SHEET_NOT_ENOUGH, FREE_SHEET_USED, BADGE, BADGE_LOYAL_SERVICE, OPERATION, PERSONAL_MISSION_INFO, PERSONAL_MISSIONS_MAP_REGION, OPERATIONS_CHAIN_DETAILS, OPERATION_POSTPONED]
    ...
    TANKMAN_SET = [TANKMAN, TANKMAN_SKILL, TANKMAN_NEW_SKILL, TANKMAN_SKILL_EXTENDED, TANKMAN_NOT_RECRUITED, PREVIEW_CREW_SKILL, BATTLE_ROYALE_TANKMAN]
    ...
    SETTINGS_SET = [SETTINGS_CONTROL, SETTINGS_BUTTON, SETTINGS_MINIMAP_CIRCLES, SETTINGS_KEY_SWITCH_MODE, SETTINGS_KEY_HIGHLIGHTLOCATION, SETTINGS_KEY_HIGHLIGHTTARGET, SETTINGS_KEY_SHOWRADIALMENU, SETTINGS_SHOW_LOCATION_MARKERS, SETTINGS_KEY_CHARGE_FIRE, SETTINGS_SWITCH_EQUIPMENT]
    TUTORIAL_SET = [HANGAR_TUTORIAL_CUSTOMIZATION_TYPES, HANGAR_TUTORIAL_PERSONAL_CASE_SKILLS, HANGAR_TUTORIAL_PERSONAL_CASE_PERKS, HANGAR_TUTORIAL_PERSONAL_CASE_ADDITIONAL, HANGAR_TUTORIAL_AMMUNITION, HANGAR_TUTORIAL_EQUPMENT]
    ...
    CREW_SKIN_SET = [CREW_SKIN, CREW_SKIN_RESTRICTED, CREW_SKIN_NO_AVAILABLE_SKINS, CREW_SKIN_SOUND]
    ...
    TRADE_IN_SET = [TRADE_IN_INFO, TRADE_IN_INFO_NOT_AVAILABLE, TRADE_IN_STATE_NOT_AVAILABLE, PERSONAL_TRADE_IN_INFO]
    ...
    SHOP_SALES_EVENT_SET = [CURRENT_DISCOUNT_INFO, SHOP_SALES_FREE_SHUFFLE_INFO, SHOP_SALES_PAID_SHUFFLE_INFO, SHOP_SALES_VOTE_FOR_DISCOUNT]
    ...
    ROYALE_LOBBY_SET = [BATTLE_ROYALE_VEHICLE, BATTLE_ROYALE_MODULES_HANGAR, BATTLE_ROYALE_BATTLE_PROGRESSION, BATTLE_ROYALE_EQUIPMENT, BATTLE_ROYALE_PERF_SIMPLE, BATTLE_ROYALE_PERF_ADVANCED, BATTLE_ROYALE_SELECTOR_INFO, BATTLE_ROYALE_WIDGET_INFO, BATTLE_ROYALE_COMPLETED_QUESTS_INFO]
    MAPBOX_LOBBY_SET = [MAPBOX_SELECTOR_INFO, MAPBOX_PROGRESSION_PREVIEW, SELECTABLE_CREWBOOK, RANDOM_CREWBOOK, MAPBOX_CALENDAR]
    ACCOUNT_COMPLETION_SET = [ACCOUNT_COMPLETION, DEMO_ACCOUNT_RENAME_PROCESSING]
    REFERRAL_PROGRAM_SET = [REFERRAL_AWARDS]
    LUNAR_NY_SET = [LUNAR_NY_CHARM, LUNAR_NY_ENVELOPE, SHOP_LUNAR_NY_ENVELOPE, SHOP_LUNAR_NY_PREREQUISITE]
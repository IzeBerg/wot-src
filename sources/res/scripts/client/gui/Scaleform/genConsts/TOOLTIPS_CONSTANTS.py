...
class TOOLTIPS_CONSTANTS(object):
    ...
    EVENT_SET = [EVENT_COST, EVENT_INTERROGATION, EVENT_KEY_INFO, EVENT_EFFICIENT_INFO, EVENT_DAILY_INFO, EVENT_CAROUSEL_VEHICLE, EVENT_SELECTOR_INFO, EVENT_BAN_INFO, HALLOWEEN_QUESTS_PREVIEW, HALLOWEEN_NO_SUITABLE_VEHICLE_FOR_QUEST, TECH_MAIN_SHELL_EVENT, GF_BANNER_TOOLTIP, EVENT_SELECTOR_PERF_INFO]
...
class TOOLTIPS_CONSTANTS(object):
    ...
    TANKMAN_SET = [TANKMAN, TANKMAN_NEW_SKILL, TANKMAN_NOT_RECRUITED, BATTLE_ROYALE_TANKMAN, CREW_PERK_GF]
    ...
    COMP7_LOBBY_SET = [COMP7_SELECTOR_INFO, COMP7_SELECTOR_UNAVAILABLE_INFO, COMP7_CALENDAR_DAY_INFO, COMP7_CALENDAR_DAY_EXTENDED_INFO, COMP7_ROLE_SKILL_LOBBY_TOOLTIP, COMP7_BATTLE_RESULTS_PRESTIGE_POINTS]

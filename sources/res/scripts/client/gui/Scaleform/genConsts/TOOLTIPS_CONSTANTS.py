...
class TOOLTIPS_CONSTANTS(object):
    ...
    LB_LOBBY_SET = [LOOT_BOXES_VEHICLE_BLUEPRINT_FRAGMENT, LOOT_BOX_TOOLTIP, LOOT_BOX_KEY_TOOLTIP, LOOT_BOX_GUARANTEED_REWARD_TOOLTIP]
    ARMORY_YARD_LOBBY_SET = [ARMORY_YARD_AWARD_VEHICLE]
    WOT_PLUS_SET = [WOT_PLUS]
    EARLY_ACCESS_LOBBY_SET = [EARLY_ACCESS_COMMON_INFO, EARLY_ACCESS_VEHICLE_LOCKED, EARLY_ACCESS_PAUSED, EARLY_ACCESS_CAROUSEL_VEHICLE_POST_PROGRESSION, EARLY_ACCESS_CURRENCY]
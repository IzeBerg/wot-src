...
class TOOLTIPS_CONSTANTS(object):
    ...
    TANKMAN_SET = [TANKMAN, TANKMAN_NOT_RECRUITED, BATTLE_ROYALE_TANKMAN, CREW_PERK_GF, CREW_PERK_ALT_GF, CREW_SKILL_UNTRAINED, COMMANDER_BONUS, SKILLS_EFFICIENCY, SPECIAL_TANKMAN, EMPTY_SKILL_GF]
    ...
    EVENT_BATTLES_SET = [EVENT_BATTLES_SELECTOR_INFO, EVENT_BATTLES_SERVER_PRIMETIME, EVENT_BATTLES_CALENDAR, EVENT_LOOTBOX, EVENT_BATTLES_QUESTS_PREVIEW, EVENT_BATTLES_TICKET, EVENT_STAMP, EVENT_CAROUSEL_VEHICLE, EVENT_BUY_LOOTBOX, EVENT_GIFT_TOKEN]
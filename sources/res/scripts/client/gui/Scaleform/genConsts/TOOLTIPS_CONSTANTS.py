...
class TOOLTIPS_CONSTANTS(object):
    ...
    EVENT_BATTLES_SET = [EVENT_BATTLES_SELECTOR_INFO, EVENT_BATTLES_SERVER_PRIMETIME, EVENT_BATTLES_CALENDAR, EVENT_LOOTBOX, EVENT_BATTLES_QUESTS_PREVIEW, EVENT_BATTLES_TICKET, EVENT_STAMP, EVENT_CAROUSEL_VEHICLE, EVENT_BUY_LOOTBOX]
...
class TOOLTIPS_CONSTANTS(object):
    ...
    RTS_SET = [RTS_SELECTOR_INFO, RTS_CALENDAR_DAY_INFO, RTS_VEHICLE_RESTRICTIONS, RTS_ROSTER_MODULE, RTS_ROSTER_TANKMAN, RTS_CAROUSEL_VEHICLE, RTS_VEHICLE_PARAMETERS, RTS_ROSTER_SHELL, RTS_SPECIAL_CURRENCY]

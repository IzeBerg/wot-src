...
class TOOLTIPS_CONSTANTS(object):
    ...
    CUSTOMIZATION_SET = [TECH_CUSTOMIZATION_ITEM, TECH_CUSTOMIZATION_NONHISTORIC_ITEM, TECH_CUSTOMIZATION_POPOVER_ITEM, TECH_CUSTOMIZATION_ITEM_ICON, TECH_CUSTOMIZATION_ITEM_AWARD, TECH_CUSTOMIZATION_ITEM_PURCHASE, SHOP_CUSTOMIZATION_ITEM, TECH_CUSTOMIZATION_CHAINED_ITEM]
    ...
    EPIC_BATTLE_SET = [EPIC_SKILL_INFO, EPIC_SKILL_SLOT_INFO, EPIC_PRESTIGE_PROGRESS_BLOCK_INFO, EPIC_QUESTS_PREVIEW, EVENT_PROGRESSION_COMPLETED_QUESTS_INFO]
    ...
    SETTINGS_SET = [SETTINGS_CONTROL, SETTINGS_BUTTON, SETTINGS_MINIMAP_CIRCLES, SETTINGS_KEY_SWITCH_MODE, SETTINGS_KEY_HIGHLIGHTLOCATION, SETTINGS_KEY_HIGHLIGHTTARGET, SETTINGS_KEY_SHOWRADIALMENU, SETTINGS_SHOW_LOCATION_MARKERS, SETTINGS_KEY_CHARGE_FIRE]

...
class PREBATTLE_ALIASES(object):
    ...
    PYTHON_ALIASES = [BATTLE_SESSION_LIST_WINDOW_PY, BATTLE_SESSION_ROOM_WINDOW_PY, TRAINING_SETTINGS_WINDOW_PY, SEND_INVITES_WINDOW_PY, AUTO_INVITE_WINDOW_PY, TRAINING_LIST_VIEW_PY, TRAINING_ROOM_VIEW_PY, EPICBATTLE_LIST_VIEW_PY, EPIC_TRAINING_ROOM_VIEW_PY]
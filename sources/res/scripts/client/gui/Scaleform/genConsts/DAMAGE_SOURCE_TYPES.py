...
class DAMAGE_SOURCE_TYPES(object):
    ...
    DAMAGE_SOURCES = [HEAVY_TANK, MEDIUM_TANK, LIGHT_TANK, AT_SPG, SPG, ARTILLERY, AIRSTRIKE, SUPPLY_BARRICADES, SUPPLY_BUNKER, SUPPLY_ATGUN, SUPPLY_WATCHTOWER, SUPPLY_PILLBOX, SUPPLY_MORTAR, SUPPLY_FLAMER]
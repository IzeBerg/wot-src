...
class DAMAGE_SOURCE_TYPES(object):
    ...
    SPG_ELITE = 'SPG_elite'
    BOSS = 'boss'
    DAMAGE_SOURCES = [HEAVY_TANK, MEDIUM_TANK, LIGHT_TANK, AT_SPG, SPG, ARTILLERY, AIRSTRIKE, FORT_ARTILLERY, HEAVY_TANK_ELITE, MEDIUM_TANK_ELITE, LIGHT_TANK_ELITE, AT_SPG_ELITE, SPG_ELITE, BOSS]
...
class BARRACKS_CONSTANTS(object):
    ...
    LOCATION_FILTERS = [LOCATION_FILTER_TANKS, LOCATION_FILTER_BARRACKS, LOCATION_FILTER_BARRACKS_AND_TANKS, LOCATION_FILTER_DISMISSED, LOCATION_FILTER_NOT_RECRUITED]
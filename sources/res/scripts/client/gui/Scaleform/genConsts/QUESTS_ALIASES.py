...
class QUESTS_ALIASES(object):
    ...
    MISSIONS_VIEW_PY_ALIASES = [MISSIONS_MARATHON_VIEW_PY_ALIAS, MISSIONS_DRAGON_BOAT_VIEW_PY_ALIAS, MISSIONS_GROUPED_VIEW_PY_ALIAS, MISSIONS_EVENT_BOARDS_VIEW_PY_ALIAS, MISSIONS_CATEGORIES_VIEW_PY_ALIAS, CURRENT_VEHICLE_MISSIONS_VIEW_PY_ALIAS]
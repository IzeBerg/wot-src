...
class EVENT(object):
    ...
    WTEVENTPORTALS_DESCRIPTION_TANK = '#event:WtEventPortals/description/tank'
    ...
    WTEVENTPORTALS_STARTERS_COUNT = '#event:WtEventPortals/starters/count'
    WTEVENTPORTALS_TANK_DISCOUNT = '#event:WtEventPortals/tank/discount'
    WTEVENTPORTALS_TANK_DISCOUNTDESC = '#event:WtEventPortals/tank/discountDesc'
    WTEVENTPORTALS_TANK_DISCOUNTHOVERDESC = '#event:WtEventPortals/tank/discountHoverDesc'
    WTEVENTPORTALS_TANK_DISCOUNTHOVERCOUNTER = '#event:WtEventPortals/tank/discountHoverCounter'
    WTEVENTPORTALS_TANK_DISCOUNTHOVERSTARTER = '#event:WtEventPortals/tank/discountHoverStarter'
    ...
    WTEVENTPORTALS_INSIDE_BUTTONGETTANK = '#event:WtEventPortals/inside/buttonGetTank'
    ...
    ALL_ENUM = (
     ...
     WTEVENTPORTALS_DESCRIPTION_TANK,
     WTEVENTPORTALS_TEXT_TANKBOUGHT,
     WTEVENTPORTALS_TEXT_DISCOUNT,
     WTEVENTPORTALS_STARTERS_COUNT,
     WTEVENTPORTALS_TANK_DISCOUNT,
     WTEVENTPORTALS_TANK_DISCOUNTDESC,
     WTEVENTPORTALS_TANK_DISCOUNTHOVERDESC,
     WTEVENTPORTALS_TANK_DISCOUNTHOVERCOUNTER,
     WTEVENTPORTALS_TANK_DISCOUNTHOVERSTARTER,
     ...
     WTEVENTPORTALS_INSIDE_BUTTONGETTANK,

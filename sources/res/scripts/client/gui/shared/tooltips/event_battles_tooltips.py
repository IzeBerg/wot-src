    ...
    def _packBlocks(self, *args, **kwargs):
        ...
        if self.__gameEventController.isModeActive():
            blocks.append(formatters.packBuildUpBlockData([
             self.__packHeader(),
             packTimeTableHeaderBlock(SELECTOR_BATTLE_TYPES.EVENT),
             formatters.packBuildUpBlockData(packCalendarBlock(self.__gameEventController, time_utils.getCurrentTimestamp(), SELECTOR_BATTLE_TYPES.EVENT))]))
        return blocks
...
class EventGiftTokenTooltipData(BlocksTooltipData):
    ...
    def _packBlocks(self, tokenID, isReceived=False, **kwargs):
        ...
        items = [
         ...
         self.__packGiftNameBlocks(shortName)]
        return items
    ...
    def __packGiftNameBlocks(cls, shortName):
        ...
        blocks = [
         ...
         formatters.packBuildUpBlockData([
          formatters.packTextBlockData(text=text_styles.standard(backport.text(R.strings.tooltips.eventOffer.footer.dyn(shortName)())))])]

        ...
        if available:
            ...
            return [
             formatters.packBuildUpBlockData(blocks=[
              titleBlock], blockWidth=BLOCK_WIDTH, padding=formatters.packPadding(bottom=-10)),
             formatters.packBuildUpBlockData(blocks=[
              maximumFreeBlock], blockWidth=BLOCK_WIDTH - 20, padding=formatters.packPadding(bottom=-28))]

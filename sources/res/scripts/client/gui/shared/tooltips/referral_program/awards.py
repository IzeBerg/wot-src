...
class AwardsTooltipData(BlocksTooltipData):
    ...
    def __getItemData(self, itemType, itemId):
        if itemType == ItemPackType.ACHIEVEMENT:
            ...
            if self.__isCamouflage(itemType):
                return self.__getCamouflage(itemType, itemId)
            if itemType in (ItemPackType.BADGE, ItemPackType.REFERRAL_BADGE):
    ...
    def __isCamouflage(self, itemType):
        return itemType in (ItemPackType.CAMOUFLAGE_SUMMER, ItemPackType.CAMOUFLAGE_WINTER,
         ItemPackType.CAMOUFLAGE_DESERT, ItemPackType.CAMOUFLAGE_ALL)
    ...
    def __getBadge(self, itemId):
        ...
        if badge is None:
            ...
            return (
             badge.getSmallIcon(), badge.getUserName())

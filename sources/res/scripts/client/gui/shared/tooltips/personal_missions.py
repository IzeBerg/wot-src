...
class BadgeTooltipData(BlocksTooltipData):
    ...
    def _packBlocks(self, badgeID):
        ...
        tooltipData = [
         ...
         formatters.packImageBlockData(badge.getAwardBadgeIcon(ICONS_SIZES.X220), BLOCKS_TOOLTIP_TYPES.ALIGN_CENTER, padding=formatters.packPadding(top=-5, bottom=11))]

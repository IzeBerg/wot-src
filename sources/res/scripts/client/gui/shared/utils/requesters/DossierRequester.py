...
class UserDossier(object):
    ...
    def __requestPlayerInfo(self, callback):
        ...
        self.__queue.append(lambda : BigWorld.player().requestPlayerInfo(self.__cache['databaseID'], partial(lambda c, code, databaseID, dossier, clanID, clanInfo, gRating, eSportSeasons, ranked, dogTag, br: self.__processValueResponse(c, code, (databaseID, dossier, (clanID, clanInfo), gRating,
         eSportSeasons, ranked, dogTag, br)), proxyCallback)))
        self.__processQueue()

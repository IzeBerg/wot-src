...
class BuyAndInstallConfirmator(ModuleBuyerConfirmator):
    ...
    def _gfMakeMeta(self):
        ...
        if self.item.itemTypeID == GUI_ITEM_TYPE.OPTIONALDEVICE:
            return partial(showOptionalDeviceBuyAndInstall, self.item.intCD)
        else:
            return
...
class BuyAndStorageConfirmator(ModuleBuyerConfirmator):
    ...
    def _gfMakeMeta(self):
        ...
        if self.item.itemTypeID == GUI_ITEM_TYPE.OPTIONALDEVICE:
            return partial(showOptionalDeviceBuyAndStorage, self.item.intCD)
        else:
            return

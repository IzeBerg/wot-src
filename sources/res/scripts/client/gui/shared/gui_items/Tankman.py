...
class TankmanSkill(GUIItem):
    __slots__ = ('_name', '_level', '_roleType', '_isEnable', '_isFemale', '_isZero',
                 '_customName', '_tankmanRole', '_isLearnedAsMajor', '_isLearnedAsBonus',
                 '_packer', '_typeName', '_isSkillActive')
    CUSTOM_NAME_EXT = ''

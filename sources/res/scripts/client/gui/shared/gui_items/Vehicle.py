...
_ALL_ACTION_GROUPS_ORDER = [
 constants.ACTIONS_GROUP_TYPE.LT_TRACKED,
...
VEHICLE_ACTION_GROUPS_LABELS_BY_CLASS = {VEHICLE_CLASS_NAME.LIGHT_TANK: [ constants.ACTIONS_GROUP_TYPE_TO_LABEL.get(group) for group in _LIGHT_GROUPS ], VEHICLE_CLASS_NAME.MEDIUM_TANK: [ constants.ACTIONS_GROUP_TYPE_TO_LABEL.get(group) for group in _MEDIUM_GROUPS ], VEHICLE_CLASS_NAME.HEAVY_TANK: [ constants.ACTIONS_GROUP_TYPE_TO_LABEL.get(group) for group in _HEAVY_GROUPS ], VEHICLE_CLASS_NAME.AT_SPG: [ constants.ACTIONS_GROUP_TYPE_TO_LABEL.get(group) for group in _AT_SPG_GROUPS ], VEHICLE_CLASS_NAME.SPG: [ constants.ACTIONS_GROUP_TYPE_TO_LABEL.get(group) for group in _SPG_GROUPS ]}
...
class Vehicle(FittingItem):
    __slots__ = ('__customState', '_inventoryID', '_xp', '_dailyXPFactor', '_isElite',
                 ...
                 '_outfits', '_isStyleInstalled', '_slotsAnchors', '_unlockedBy',

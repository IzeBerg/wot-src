...
class MarkerParamsFactory(object):
    ...
    MARKER_DATA = {MarkerItem.DEFAULT: {'visible': True, 
                            ...
                            FLAG.DIRECTION_INDICATOR: [
                                                     {'dIndicatorShapes': ('green', 'green'), 
                                                        'swf': _DIRECT_INDICATOR_SWF, 
                                                        'mcName': _DIRECT_INDICATOR_MC_NAME}], 
                            FLAG.MINIMAP_MARKER: [
                                                {'symbol': ENTRY_SYMBOL_NAME.ARTY_MARKER, 
                                                   'container': CONTAINER_NAME.PERSONAL, 
                                                   'onlyTranslation': False},
                                                {'symbol': ENTRY_SYMBOL_NAME.BOMBER_ENTRY, 
                                                   'container': CONTAINER_NAME.EQUIPMENTS, 
                                                   'onlyTranslation': True}], 
                            FLAG.ANIM_SEQUENCE_MARKER: [
                                                      {'path': 'content/Interface/Arrow/animations/bootcamp_arrow.seq'}], 
                            FLAG.TERRAIN_MARKER: [
                                                {'path': 'content/Interface/TargetPoint/TargetPoint_red.visual', 
                                                   'size': (50.0, 20.0), 
       ...
       MarkerItem.POLYGONAL_ZONE: {'visible': True, 
                                   FLAG.MINIMAP_MARKER: [
                                                       {'symbol': 'CustomDeathZoneMinimapEntryUI', 
       ...
       MarkerItem.GEN_ON: {FLAG.MARKER_2D: [
                                          {'symbol': settings.MARKER_SYMBOL_NAME.EVENT_GENERATOR_MARKER, 
                                             'clazz': EventMarkers.World2DGeneratorMarkerComponentOn, 
                                             'alpha': 1, 
                                             'isSticky': True}], 
                           FLAG.MINIMAP_MARKER: [
                                               {'clazz': EventMarkers.MinimapGeneratorMarkerComponentOn, 
       ...
       MarkerItem.GEN_OFF: {FLAG.MARKER_2D: [
                                           {'symbol': settings.MARKER_SYMBOL_NAME.EVENT_GENERATOR_MARKER, 
                                              ...
                                              'isSticky': True}], 
                            FLAG.MINIMAP_MARKER: [
                                                {'clazz': EventMarkers.MinimapGeneratorMarkerComponentOff, 
                                                   'symbol': 'EventGeneratorMinimapEntryUI', 
                                                   'container': CONTAINER_NAME.ICONS, 
                                                   'onlyTranslation': True, 
                                                   'alpha': 0.5}]}}

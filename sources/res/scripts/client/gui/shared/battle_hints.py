...
class BattleHintData(namedtuple('_HintData', ('name', 'componentAlias', 'iconPath', 'blindIconPath', 'duration',
                         'maxWaitTime', 'priority', 'soundFx', 'soundNotification',
                         'htmlTemplate', 'rawMessage', 'dynamicFields'))):

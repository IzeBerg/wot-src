...
RELATIVE_POWER_PARAMS = (
 ...
 CONTINUOUS_SHOTS_PER_MINUTE, AUTO_RELOAD_PROP_NAME, 'reloadTimeSecs', 'clipFireRate', AUTO_SHOOT_CLIP_FIRE_RATE,
...
RELATIVE_MOBILITY_PARAMS = (
 ...
 'speedLimits', WHEELED_SPEED_MODE_SPEED, TURBOSHAFT_SPEED_MODE_SPEED, ROCKET_ACCELERATION_SPEED_LIMITS,
 'chassisRotationSpeed', ROCKET_ACCELERATION_REUSE_AND_DURATION, MAX_STEERING_LOCK_ANGLE,
 'switchOnTime', 'switchOffTime', TURBOSHAFT_SWITCH_TIME)

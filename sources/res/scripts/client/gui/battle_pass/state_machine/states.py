...
class RewardStyleState(State):
    ...
    def _onEntered(self):
        ...
        if machine is None:
            ...
            data = {'reason': BattlePassRewardReason.SELECT_STYLE, 'prevLevel': prevLevel, 
    ...
    def _onEntered(self):
        ...
        if machine is None:
            ...
            if rewards is None:
                ...
                return
            if data is None:
                data = {'reason': BattlePassRewardReason.PURCHASE_BATTLE_PASS_LEVELS, 'prevLevel': self.__battlePass.getCurrentLevel()}

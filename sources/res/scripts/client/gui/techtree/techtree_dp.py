...
class TechTreeDataProvider(object):
    __slots__ = ('__loaded', '__availableNations', '__displayInfo', '__topLevels',
                 '__topItems', '__nextLevels', '__settings', '__unlockPrices', '__announcements',
                 '__announcementCDToName', '__nextAnnouncements', '__nodes', '__nextTypeIDs',
                 '__source')

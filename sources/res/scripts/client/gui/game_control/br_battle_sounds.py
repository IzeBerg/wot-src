...
class BREvents(object):
    ...
    ENEMIES_AMOUNT = {10: 'BR_enemy_remained_10', 5: 'BR_enemy_remained_05', 
    ...
    EQUIPMENT_ACTIVATED = {SteelHunterEquipmentNames.LARGE_REPAIRKIT: 'BR_perk_repair_activation', SteelHunterEquipmentNames.REGENERATION_KIT: 'BR_perk_hp_restore_activation', 
    ...
    EQUIPMENT_DEACTIVATED = {SteelHunterEquipmentNames.REGENERATION_KIT: 'BR_perk_hp_restore_deactivation', SteelHunterEquipmentNames.SELF_BUFF: 'BR_perk_selfbuff_deactivation'}

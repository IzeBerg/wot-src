import typing, BigWorld, constants
...
class SteamCompletionController(ISteamCompletionController):
    ...
    def getSteamShadeConfigs(self):
        ...
        if self.abTestGroup and serverSettings.abFeatureTestConfig.steamShade:
            return serverSettings.abFeatureTestConfig.getSteamShadeProperties(self.abTestGroup)
        return serverSettings.steamShadeConfig

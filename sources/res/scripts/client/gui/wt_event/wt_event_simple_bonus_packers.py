...
NO_SPLITTED_BONUSES = frozenset((
 _RANDOM_CREWBOOK, _RANDOM_DECAL, _RANDOM_STYLE_2D, _RANDOM_STYLE_3D, _EMBLEM))
...
class SimpleEventRandomCrewBookPacker(BaseBonusUIPacker):
    ...
    def _getToolTip(cls, bonus):
        return [
         createTooltipData(tooltip=makeTooltip(backport.text(R.strings.event.bonusTooltip.crewBooks.header()), backport.text(R.strings.event.bonusTooltip.crewBooks.body(), exp=bonus.getXP())))]

import BigWorld, CGF, WWISE, GenericComponents, Health, Projectiles, random, logging
...
class WTBattleCountManager(object):
    _BATTLE_COUNT_SETTINGS = {False: WT_BATTLES_DONE_HUNTER, True: WT_BATTLES_DONE_BOSS}
...
class GeneratorCaptureSoundManager(CGF.ComponentManager):
    ...
    _PLAYER_HUNTER_LAST_GENERATOR_DESTROYED = ('wt23_hunters_vo_last_generator_destroyed',
                                               'wt_hunters_vo_destruction_last_generator')
    _PLAYER_BOSS_GENERATOR_DESTROYED = ('wt23_w_vo_shield_destroyed', 'wt_w_vo_destruction_generator')
    _PLAYER_BOSS_LAST_GENERATOR_DESTROYED = ('ev_wt23_w_vo_last_generator_destroyed',
                                             'wt_w_vo_destruction_last_generator')

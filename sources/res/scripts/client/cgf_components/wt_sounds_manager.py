import BigWorld, CGF, WWISE, GenericComponents, Health, Projectiles, logging
...
class BossAbilitySoundManager(CGF.ComponentManager):
    ...
    def __isBossImpulse(self):
        ...
        if bossVehicle is None:
            ...
            if impulseEquip is None:
                return False
            return impulseEquip.equipmentStatePublic['stage'] == EQUIPMENT_STAGES.COOLDOWN

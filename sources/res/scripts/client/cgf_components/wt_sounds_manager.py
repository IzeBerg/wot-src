import BigWorld, CGF, WWISE, GenericComponents, Statuses, InstantStatuses, logging
...
class GeneratorCaptureSoundManager(CGF.ComponentManager, CallbackDelayer):
    ...
    _PLAYER_BOSS_GENERATOR_DESTROYED = {False: 'wt23_w_vo_shield_destroyed', True: 'wt23_w_vo_shield_destroyed_eos_one'}

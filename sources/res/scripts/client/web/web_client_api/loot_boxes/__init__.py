...
class RandomCrewBooksWrapper(BonusAggregateWrapper):
    ...
    def getWrappedBonus(cls, bonus):
        return {'id': 0, 
           ...
           'icon': {AWARDS_SIZES.SMALL: sanitizeResPath(backport.image(cls._R_IMAGE.small.brochure_random())), AWARDS_SIZES.BIG: sanitizeResPath(backport.image(cls._R_IMAGE.big.brochure_random()))}, 
           'name': '', 
           'description': ''}

...
class RandomNationalBlueprintWrapper(BonusAggregateWrapper):
    ...
    def getWrappedBonus(cls, bonus):
        return {'id': 0, 
           ...
           'value': bonus.get('value', 0), 
           'icon': {AWARDS_SIZES.SMALL: sanitizeResPath(backport.image(cls._R_IMAGE.small.random())), AWARDS_SIZES.BIG: sanitizeResPath(backport.image(cls._R_IMAGE.big.random()))}, 
           'name': '', 
           'description': ''}

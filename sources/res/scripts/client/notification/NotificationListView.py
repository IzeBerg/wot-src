    ...
    def __setInitData(self):
        ...
        self.as_setInitDataS({'scrollStepFactor': LIST_SCROLL_STEP_FACTOR, 
           ...
           'tabsData': {'tabs': [
                               ...
                               self.__makeTabItemVO(NOTIFICATIONS_CONSTANTS.TAB_INVITES, icons.makeImageTag(RES_ICONS.MAPS_ICONS_LIBRARY_NOTIF_FILTERS_INVITATIONS_24X16, 24, 16, -5, 0), invitesTooltip),

...
registerNotificationsListeners((
 ...
 PersonalReservesConversionListener, SeniorityAwardsQuestListener, SeniorityAwardsTokenListener,
 NyDogReminderListener, NyMarketplaceAvailableListener, LootBoxConfigListener))

...
class _GroupCounter(object):
    ...
    def addNotification(self, typeID, entityID, count, resetCounter):
        self._notifications.update({(typeID, entityID): {'count': count, 'resetCounter': resetCounter}})
    ...
    def reset(self):
        self._notifications = {notificationID:notificationData for notificationID, notificationData in self._notifications.iteritems() if not notificationData['resetCounter'] if not notificationData['resetCounter']}

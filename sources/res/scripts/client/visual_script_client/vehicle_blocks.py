import random, weakref, BigWorld, GenericComponents
...
class GetGameObjectOfVehicle(Block, VehicleMeta):
    components = {'EntityGameObject': 'EntityGO', 'TankRootGameObject': tankStructure.CgfTankNodes.TANK_ROOT, 
    ...
    def initParams(cls):
        return [
         InitParam('GO to get', SLOT_TYPE.STR, buildStrKeysValue(*cls.components.keys()), EDITOR_TYPE.STR_KEY_SELECTOR)]

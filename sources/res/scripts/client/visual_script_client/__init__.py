...
def registerForGeneral():
    ...
    g_blockRegistrar.regContext(CGFGameObjectContext)
    registerContext()
    import arena_blocks, vehicle_blocks, scene_blocks, event_platform_blocks, triggers_blocks, animated_hints_blocks, player_blocks, sound_blocks, game_settings_blocks, camera_blocks, battle_hud_block, cgf_blocks, bitmask_blocks, web_blocks, armory_yard_blocks

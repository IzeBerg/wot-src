import logging, BigWorld, Math, Event
...
class BRDeathZoneComponent(ClientArenaComponent):
    ...
    ZONE_WAITING = 1
    ZONE_ACTIVE = 2
    __slots__ = ('__cornerPosition', '__zoneSizeX', '__zoneSizeY', '__zonePositionOffset',
                 '__zoneScale__visualizersId', 'onDeathZoneUpdate', '__updatedZones__zoneStates',
                 '__callbackID', '__currentZoneState', '__observedvehicleID')
    ...
    def getDeathZoneCount(self):
        return (
         death_zones_mapping.ZONES_X, death_zones_mapping.ZONES_Y)

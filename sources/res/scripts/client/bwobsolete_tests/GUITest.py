...
def mode_conv():
    ...
    add_conv_test_child(w, GUI.Simple.eHAnchor.LEFT, GUI.Simple.eVAnchor.TOP, (-1,
                                                                               1))
    add_conv_test_child(w, GUI.Simple.eHAnchor.RIGHT, GUI.Simple.eVAnchor.TOP, (1,
                                                                                1))
    add_conv_test_child(w, GUI.Simple.eHAnchor.LEFT, GUI.Simple.eVAnchor.BOTTOM, (-1,
                                                                                  -1))
    add_conv_test_child(w, GUI.Simple.eHAnchor.RIGHT, GUI.Simple.eVAnchor.BOTTOM, (1,
                                                                                   -1))
    add_conv_test_child(w, GUI.Simple.eHAnchor.CENTER, GUI.Simple.eVAnchor.CENTER, (0,
                                                                                    0))
    GUI.addRoot(w)
...
class _ParentAnchorWindow(object):
    ...
    def create(hAnchor, vAnchor, pos, colour):
        ...
        c.moveFocus = True
        c.focus = True
        c.addChild(_Child.create(GUI.Simple.eHAnchor.LEFT, GUI.Simple.eVAnchor.TOP, (-1,
                                                                                     1)).component)
        c.addChild(_Child.create(GUI.Simple.eHAnchor.CENTER, GUI.Simple.eVAnchor.TOP, (0,
                                                                                       1)).component)
        c.addChild(_Child.create(GUI.Simple.eHAnchor.RIGHT, GUI.Simple.eVAnchor.TOP, (1,
                                                                                      1)).component)
        c.addChild(_Child.create(GUI.Simple.eHAnchor.LEFT, GUI.Simple.eVAnchor.CENTER, (-1,
                                                                                        0)).component)
        c.addChild(_Child.create(GUI.Simple.eHAnchor.CENTER, GUI.Simple.eVAnchor.CENTER, (0,
                                                                                          0)).component)
        c.addChild(_Child.create(GUI.Simple.eHAnchor.RIGHT, GUI.Simple.eVAnchor.CENTER, (1,
                                                                                         0)).component)
        c.addChild(_Child.create(GUI.Simple.eHAnchor.LEFT, GUI.Simple.eVAnchor.BOTTOM, (-1,
                                                                                        -1)).component)
        c.addChild(_Child.create(GUI.Simple.eHAnchor.CENTER, GUI.Simple.eVAnchor.BOTTOM, (0,
                                                                                          -1)).component)
        c.addChild(_Child.create(GUI.Simple.eHAnchor.RIGHT, GUI.Simple.eVAnchor.BOTTOM, (1,
                                                                                         -1)).component)
...
def anchors():
    clear()
    GUI.addRoot(_ParentAnchorWindow.create(GUI.Simple.eHAnchor.LEFT, GUI.Simple.eVAnchor.TOP, (-1,
                                                                                               1), (0,
                                                                                                    0,
                                                                                                    0,
                                                                                                    255)).component)
    GUI.addRoot(_ParentAnchorWindow.create(GUI.Simple.eHAnchor.CENTER, GUI.Simple.eVAnchor.TOP, (0,
                                                                                                 1), (0,
                                                                                                      0,
                                                                                                      128,
                                                                                                      255)).component)
    GUI.addRoot(_ParentAnchorWindow.create(GUI.Simple.eHAnchor.RIGHT, GUI.Simple.eVAnchor.TOP, (1,
                                                                                                1), (0,
                                                                                                     255,
                                                                                                     0,
                                                                                                     255)).component)
    GUI.addRoot(_ParentAnchorWindow.create(GUI.Simple.eHAnchor.LEFT, GUI.Simple.eVAnchor.CENTER, (-1,
                                                                                                  0), (0,
                                                                                                       255,
                                                                                                       255,
                                                                                                       255)).component)
    GUI.addRoot(_ParentAnchorWindow.create(GUI.Simple.eHAnchor.CENTER, GUI.Simple.eVAnchor.CENTER, (0,
                                                                                                    0), (255,
                                                                                                         0,
                                                                                                         0,
                                                                                                         255)).component)
    GUI.addRoot(_ParentAnchorWindow.create(GUI.Simple.eHAnchor.RIGHT, GUI.Simple.eVAnchor.CENTER, (1,
                                                                                                   0), (255,
                                                                                                        0,
                                                                                                        255,
                                                                                                        255)).component)
    GUI.addRoot(_ParentAnchorWindow.create(GUI.Simple.eHAnchor.LEFT, GUI.Simple.eVAnchor.BOTTOM, (-1,
                                                                                                  -1), (255,
                                                                                                        255,
                                                                                                        0,
                                                                                                        255)).component)
    GUI.addRoot(_ParentAnchorWindow.create(GUI.Simple.eHAnchor.CENTER, GUI.Simple.eVAnchor.BOTTOM, (0,
                                                                                                    -1), (255,
                                                                                                          255,
                                                                                                          255,
                                                                                                          255)).component)
    GUI.addRoot(_ParentAnchorWindow.create(GUI.Simple.eHAnchor.RIGHT, GUI.Simple.eVAnchor.BOTTOM, (1,
                                                                                                   -1), (128,
                                                                                                         128,
                                                                                                         128,
                                                                                                         255)).component)

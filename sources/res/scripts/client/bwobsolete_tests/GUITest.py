...
def anchors():
    ...
    GUI.addRoot(_ParentAnchorWindow.create('LEFT', 'CENTER', (-1, 0), (0, 255, 255,
                                                                       255)).component)
    GUI.addRoot(_ParentAnchorWindow.create('CENTER', 'CENTER', (0, 0), (255, 0, 0,
                                                                        255)).component)
    GUI.addRoot(_ParentAnchorWindow.create('RIGHT', 'CENTER', (1, 0), (255, 0, 255,
                                                                       255)).component)
    GUI.addRoot(_ParentAnchorWindow.create('LEFT', 'BOTTOM', (-1, -1), (255, 255, 0,
                                                                        255)).component)
    GUI.addRoot(_ParentAnchorWindow.create('CENTER', 'BOTTOM', (0, -1), (255, 255,
                                                                         255, 255)).component)
    GUI.addRoot(_ParentAnchorWindow.create('RIGHT', 'BOTTOM', (1, -1), (128, 128, 128,
                                                                        255)).component)

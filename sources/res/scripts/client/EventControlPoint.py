import logging, BigWorld, AnimationSequence
...
class EventControlPoint(BigWorld.Entity):
    ...
    def prerequisites(self):
        ...
        rv = [_g_eventControlPointSettings.flagModel, _g_eventControlPointSettings.radiusModel, loader, loaderModel]
        mProv = Matrix()
            ...
            if switch:
                ...
                if _g_eventControlPointSettings.flagAnim is not None:
                    try:
                        ...
                        LOG_WARNING('Unable to start "%s" animation action for model "%s"' % (
                         _g_eventControlPointSettings.flagAnim, _g_eventControlPointSettings.flagModel))

...
_alternativeSoundNotifications = {'enemy_hp_damaged_by_projectile_and_gun_damaged_by_player': [
                                                              'wt23_hunters_vo_shooting_at_wt_shield',
                                                              'enemy_no_hp_damage_at_attempt_by_player_wt'], 

...
import BigWorld, Keys, Math, ResMgr, WWISE, WoT, CGF, Account, AccountCommands, AreaDestructibles, AvatarInputHandler, AvatarPositionControl, BattleReplay, ClientArena, CommandMapping, Event, FlockManager, MusicControllerWWISE, ProjectileMover, SoundGroups, TriggersManager, Vehicle, Weather, constants
...
class PlayerAvatar(BigWorld.Entity, ClientChat, CombatEquipmentManager, AvatarObserver, TeamHealthbarMechanic, AvatarEpicData, AvatarRecoveryMechanic, AvatarRespawnMechanic, VehiclesSpawnListStorage, VehicleRemovalController, VehicleHealthBroadcastListenerComponent, AvatarChatKeyHandling, TriggersController):
        ...
        if self.vehicle is not None:
            ...
            if self.vehicle.typeDescriptor.hasSiegeMode:
                ...
                if siegeState == VEHICLE_SIEGE_STATE.ENABLED:
                    ...
                    switchingTime = 0.0
                self.updateVehicleMiscStatus(self.vehicle.id, VEHICLE_MISC_STATUS.SIEGE_MODE_STATE_CHANGED, siegeState, [
                 switchingTime])
            ...
            if cmdMap.isFired(CommandMapping.CMD_SHOW_HELP, key) and isDown and mods == 0:
                ...
                if vehicle is not None:
                    ...
                    if vTypeDesc.isWheeledVehicle or isRanked or vTypeDesc.isDualgunVehicle or vTypeDesc.hasTurboshaftEngine:
                        ctx = {'vehName': vehicle.typeDescriptor.type.userString, 'isWheeled': vTypeDesc.isWheeledVehicle, 
    ...
    def updateVehicleMiscStatus(self, vehicleID, code, intArg, floatArgs):
        ...
        if code == STATUS.DESTROYED_DEVICE_IS_REPAIRING:
            ...
            LOG_DEBUG_DEV('DESTROYED_DEVICE_IS_REPAIRING (%s): %s%%, %s sec' % (
             typeDescr.extras[extraIndex].name, progress, floatArg))
            ...
            if intArg in (constants.VEHICLE_SIEGE_STATE.SWITCHING_ON,
    ...
    __damageInfoFire = (
     'FIRE', 'DEVICE_STARTED_FIRE_AT_SHOT', 'DEVICE_STARTED_FIRE_AT_RAMMING', 'FIRE_STOPPED')

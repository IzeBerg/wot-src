...
class CrewViewLogger(CrewMetricsLogger):
    __slots__ = ('_currentView', '_parentViewKey', '_currentViewKey', '_overlappingWindowsCount',
                 '_isPaused')
...
class CrewTooltipLogger(CrewMetricsLogger):
    __slots__ = ('_parentViewKey', '_currentTooltip', '_previousTooltipId', '_tooltipIdMapping',
                 '_openedTooltipId', '_openedTooltipArgs')

...
__all__ = ('ACTIONS_HINTS_TO_LOG_ONCE', 'ACTION_SEQUENCES', 'BC_AWARDS_MAP', 'BATTLE_HINTS_TO_LOG_ON_ANIMATION_FINISH',
           'BATTLE_HINTS_TO_LOG_ON_COMPLETE', 'BATTLE_HINTS_TO_LOG_ON_HIDE', 'BC_LOG_ACTIONS',
           'BC_LOG_KEYS', 'CHECK', 'HANGAR_MENU_ITEMS', 'HANGAR_HINTS_TO_LOG_ON_COMPLETE',
           'LIMITS', 'SNIPER_MODE', 'SNIPER_MODE_SEQUENCE')

...
class TeamBaseRecapturable(BigWorld.Entity):
    ...
    def __init__(self):
        ...
        if not _settings.inited:
            ...
            TeamBaseRecapturable._TEAM_PARAMS = {_TeamIds.NEUTRAL: (
                                4294967295, 4294967295, True), 
               _TeamIds.ENEMY: (
                              4294851840, 4290484735, False), 
               _TeamIds.PLAYER: (
                               4289396480, 4289396480, True)}
    ...
    def prerequisites(self):
        ...
        return [
         assembler, AnimationSequence.Loader(_settings.flagAnim, self.spaceID)]
    ...
    def _getTeamId(self):
        ...
        if self.team == BigWorld.player().team:
            return _TeamIds.PLAYER
        return _TeamIds.ENEMY

...
_InsigniaParams = namedtuple('InsigniaParams', ('textureName', 'emissionTextureName',
                                                'emissionPatternName', 'emissionAnimationSpeed',
                                                'emissionHDRBrightness', 'emissionLDRBrightness'))
_StickerSlotPair = namedtuple('_StickerSlotPair', ('componentSlot', 'stickerParams'))
_PersonalNumberTexParams = namedtuple('PersonalNumberTexParams', ('textureName', 'textureMap',
                                                                  'text', 'fontMask',
                                                                  'digitsCount'))
_INSIGNIA_LETTER = '*'

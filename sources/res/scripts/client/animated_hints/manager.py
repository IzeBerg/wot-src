...
class HintManager(object):
    ...
    def setPenetration(self, penetrationType, isColorBlind):
        g_eventBus.handleEvent(HintActionEvent(EventAction.SetPenetration, ctx={'penetrationType': penetrationType, 'isColorBlind': isColorBlind}), scope=EVENT_BUS_SCOPE.BATTLE)
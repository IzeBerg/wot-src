...
class ClientHintModel(CommonHintModel[(HMCPropsType, HMCContextType)], typing.Generic[(HMCPropsType, HMCContextType, CHMTextType, CHMVisualType, CHMSoundType, CHMLifecycleType,
 CHMHistoryType)]):

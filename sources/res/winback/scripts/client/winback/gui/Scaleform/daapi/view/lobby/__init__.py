...
def getViewSettings():
    ...
    return (
     ViewSettings(WINBACK_ALIASES.WINBACK_BROWSER_VIEW, WinbackBrowserView, 'browserScreen.swf', WindowLayer.TOP_SUB_VIEW, WINBACK_ALIASES.WINBACK_BROWSER_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE),

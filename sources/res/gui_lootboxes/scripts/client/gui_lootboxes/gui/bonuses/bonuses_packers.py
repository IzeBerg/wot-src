...
class LootBoxCrewBookBonusUIPacker(CrewBookBonusUIPacker):
    ...
    def _getToolTip(cls, bonus):
        ...
        return [
         TooltipData(tooltip=None, isSpecial=True, specialAlias=specialAlias, specialArgs=specialArgs)]
...
class LootBoxTokensBonusUIPacker(TokenBonusUIPacker):
    ...
    def __getCompReasonBonus(cls, item, itemID):
        if item == 'cllc':
            return AnyCollectionItemBonus('anyCollectionItem', itemID, False)
        else:
            return
...
class LootBoxCollectionItemBonusUIPacker(SimpleBonusUIPacker):
    ...
    def _getToolTip(cls, bonus):
        if cls._isValidBonus(bonus):
            return [TooltipData(tooltip=None, isSpecial=True, specialAlias=None, specialArgs=[bonus.getItemId(), bonus.getCollectionId()])]
        else:
            return []

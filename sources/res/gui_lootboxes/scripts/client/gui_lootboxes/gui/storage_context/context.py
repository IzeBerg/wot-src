...
def _handlerOpenningFinished(eventData):
    ...
    if uniqueRewardsHandler:
        return StringEvent(LootBoxesStorageEventEnum.GOTO_UNIQUE_REWARDING, uniqueRewardsHandler=uniqueRewardsHandler, rewards=rewards)
    return StringEvent(LootBoxesStorageEventEnum.GOTO_REWARDING, rewards=rewards)

...
class FunRandomPersonalEfficiency(PersonalEfficiency, FunSubModesWatcher):
    ...
    _PARAMETERS = {VEHICLE_CLASS_NAME.SPG: (
                              EfficiencyParameter.KILLS, EfficiencyParameter.DAMAGEDEALT,
                              EfficiencyParameter.DAMAGEASSISTED, EfficiencyParameter.STUN)}
    _DEFAULT_PARAMS = (
     EfficiencyParameter.KILLS, EfficiencyParameter.DAMAGEDEALT,
     EfficiencyParameter.DAMAGEASSISTED, EfficiencyParameter.DAMAGEBLOCKEDBYARMOR)
...
class FunRandomTeamStats(TeamStats):
    ...
    _SORTING_PRIORITIES = (
     (
      ColumnType.XP.value, SortingOrder.DESC),
     (
      ColumnType.DAMAGE.value, SortingOrder.DESC),
     (
      ColumnType.PLAYER.value, SortingOrder.ASC))

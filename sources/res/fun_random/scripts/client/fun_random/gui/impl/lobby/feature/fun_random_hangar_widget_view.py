...
class FunRandomHangarWidgetView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if contentID == R.views.fun_random.lobby.tooltips.FunRandomWidgetTooltipView():
            return FunRandomWidgetTooltipView()
    ...
    def _getEvents(self):
        return (
         (
          self.__funRandomCtrl.onGameModeStatusUpdated, self.__invalidateAll),)

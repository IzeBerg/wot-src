...
class EquipmentSoundPlayer(_SoundsPlayer):
    ...
    def __onEquipmentUpdated(self, _, item):
        ...
        if equipment:
            ...
            currentStageIsActive = curStage in (EQUIPMENT_STAGES.ACTIVE, EQUIPMENT_STAGES.COOLDOWN,
            ...
            if prevStageIsReady and currentStageIsActive:
                ...
                currentStageIsCooldown = curStage in (EQUIPMENT_STAGES.COOLDOWN, EQUIPMENT_STAGES.READY,

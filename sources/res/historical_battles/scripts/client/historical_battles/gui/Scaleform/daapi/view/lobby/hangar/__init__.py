...
def getViewSettings():
    return (
     ComponentSettings(HANGAR_ALIASES.SE22_EVENT_ENTRY_POINT, EntryPoint, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(VIEW_ALIAS.LOBBY_HEADER, HBLobbyHeader, ScopeTemplates.DEFAULT_SCOPE))

...
HB_TOTAL_VO_META = base.DictMeta({'common': {}, 'details': {}, 'isWin': False, 
   'battleResultType': '', 
   'finishReason': '', 
   'deathReason': '', 
   'duration': 0, 
   ...
   'isHeroVehicle': False, 
   'tankType': '', 
   'frontman': {}, 'frontCoupon': '', 
   'earnings': {}, 'frontName': '', 
   'arenaPhases': {}, 'roleAbility': {}})
...
_HB_ROLE_ABILITY_VO_META = base.DictMeta({'obtained': False, 
   ...
   'icon': '', 
   'id': 0})
_HB_PLAYER_INFO_VO_META_TUPLE = regular.TEAM_ITEM_VO_META_TUPLE + (
 ('damageBlocked', 0, 'damageBlockedByArmor'),

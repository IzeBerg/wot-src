...
class FrontmanValidator(FrontmanValidatorBase):
    ...
    def _validate(self):
        ...
        if currentFrontman.isInBattle():
            return ValidationResult(False, self.RESTRICTION)
        return super(FrontmanValidator, self)._validate()
...
class HistoricalBattleSquadActionsValidator(SquadActionsValidator):
    ...
    def _createVehiclesValidator(self, entity):
        return ActionsValidatorComposite(entity, [
         HistoricalBattleVehiclesValidator(entity),
         FrontmanValidator(entity),
         FrontValidator(entity)])
    ...
    def _createSlotsValidator(self, entity):
        ...
        return ActionsValidatorComposite(entity, validators=[
         baseValidator,
         HistoricalSquadSlotsValidator(entity)])
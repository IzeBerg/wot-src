...
import SoundGroups, WWISE, HBAccountSettings
...
class HangarView(SelectableViewImpl, HangarSelectableView, BaseEventView):
    ...
    def createToolTipContent(self, event, contentID):
        if not self.__tooltipEnabled:
            ...
            if contentID == R.views.historical_battles.lobby.tooltips.NotProfiledVehicleTooltip():
            ...
            if contentID == R.views.historical_battles.lobby.tooltips.BattleModeInfoTooltip():
            ...
            if contentID == R.views.historical_battles.lobby.tooltips.FrontmanTooltip():
    ...
    def __onFrontmanLockChanged(self):
        with self.viewModel.transaction() as (tx):
            for frontman in tx.getFrontmen():
                ...
                elif frontmanItem and frontmanItem.isInUnit():

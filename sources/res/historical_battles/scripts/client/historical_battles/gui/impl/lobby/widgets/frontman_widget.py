import typing, HBAccountSettings
...
FrontmanRoleIDToRole = {FrontmanRoleID.AVIATION: FrontmanRole.AVIATION, FrontmanRoleID.ARTILLERY: FrontmanRole.ARTILLERY, 
...
class FrontmanWidget(object):
    ...
    def __getFrontmanState(frontman):
        ...
        if frontman.isInUnit():
            return FrontmanState.INPLATOON
        return FrontmanState.DEFAULT
...
class BoosterBuyDialogView(DialogTemplateView):
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        if layout == BundleLayout.NEWBIE:
            self.setSubView(Placeholder.ICON, IconSet(rIcons.order.c_220x220.x10(), backgroundResIDList=[
             rIcons.bundlesWindow.lightRed_huge()], isBottomPushingDown=False, tooltip=DialogTemplateTooltip(self._orderTooltipFactory)))
    ...
    def _getTitle(self):
        ...
        if layout == BundleLayout.SPECIALIST:
            return backport.text(rTitle.specialist())

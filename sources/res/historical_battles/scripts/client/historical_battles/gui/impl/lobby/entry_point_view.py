...
class EntryPointView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.historical_battles.lobby.tooltips.EntryPointTooltip():
            return EntryPointTooltip()
        return super(EntryPointView, self).createToolTipContent(event, contentID)
    ...
    def __getEventTimes(self):
        return (
         ...
         self._gameEventController.getEventStartTime(),
         self._gameEventController.getEventFinishTime())

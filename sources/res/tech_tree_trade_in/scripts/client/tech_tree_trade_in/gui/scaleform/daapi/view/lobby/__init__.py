...
def getViewSettings():
    return (
     ViewSettings(TECH_TREE_TRADE_IN_HANGAR_ALIASES.TECH_TREE_TRADE_IN_BROWSER_OVERLAY, WebView, 'browserScreen.swf', WindowLayer.TOP_WINDOW, TECH_TREE_TRADE_IN_HANGAR_ALIASES.TECH_TREE_TRADE_IN_BROWSER_OVERLAY, ScopeTemplates.LOBBY_TOP_SUB_SCOPE),
     ComponentSettings(HANGAR_ALIASES.TECH_TREE_TRADE_IN_BANNER, TechTreeTradeInBannerComponent, ScopeTemplates.DEFAULT_SCOPE))


def getBusinessHandlers():
    return (
     TechTreeTradeInPackageBusinessHandler(),)
...
class TechTreeTradeInPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          TECH_TREE_TRADE_IN_HANGAR_ALIASES.TECH_TREE_TRADE_IN_BROWSER_OVERLAY, self.loadViewByCtxEvent),)

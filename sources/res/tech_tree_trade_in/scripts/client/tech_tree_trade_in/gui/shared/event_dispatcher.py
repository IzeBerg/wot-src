...
def pushTradeInDetailsNotification(data, systemMessages=None):
    ...
    msg = {'postProgressionCompensation': {'currency': {'credits': postProgressionCompensation}}, 'crew': {'recruits': numRecruits, 'sentToBarracks': numSentToBarracks}, 'xpTransferredVehCD': xpTransferredVehCD}

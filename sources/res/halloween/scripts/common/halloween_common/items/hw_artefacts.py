...
class EventEquipment(Equipment):
    __slots__ = ('durationSeconds', 'cooldownSeconds', 'reuseCount', 'activationWWSoundFeedback',
                 'deactivationWWSoundFeedback', 'soundNotificationActive', 'isHeroic',
                 'isReward')
...
class HWArtefact(Equipment):
    __slots__ = ('shortDescription', 'longDescription', 'shortFilterAlert', 'longFilterAlert',
                 ...
                 'activationWWSoundFeedback', 'deactivationWWSoundFeedback', 'isHeroic',
                 'isReward', 'hasBoost', 'defaultParams', 'boostParams', 'effects',
                 'cooldownSeconds', 'durationSeconds', 'activeSeconds', 'reuseCount')

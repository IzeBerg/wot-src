...
import CGF
LOBBY_EXT_PACKAGES = ('halloween.gui.Scaleform.daapi.view.lobby', 'halloween.gui.Scaleform.daapi.view.lobby.hangar',
                      'halloween.gui.Scaleform.daapi.view.lobby.tank_setup')
BATTLE_EXT_PACKAGES = ('halloween.gui.Scaleform.daapi.view.battle', )
TOOLTIP_PACKAGES = [
 (
  'halloween.gui.Scaleform.daapi.view.tooltips.halloween_lobby_builders', HWTooltips.HW_LOBBY_SET)]
HW_AWARD_HANDLERS = [
 HWBattleQuestsRewardHandler, HWInvoiceCrewBonusHandler]
...
class ClientHalloweenBattleMode(halloween_constants.HalloweenBattleMode):
    ...
    def _client_gameControllers(self):
        ...
        return (
         ...
         (
          IHalloweenVisibilityLayerController, VisibilityLayerController, False),
         (
          IHWSoundController, HWSoundController, False))
...
def preInit():
    ...
    data = {halloween_gui_constants.PREBATTLE_ACTION_NAME.HALLOWEEN_BATTLE: (
                                                                      ModeSelectorColumns.COLUMN_1, 40)}

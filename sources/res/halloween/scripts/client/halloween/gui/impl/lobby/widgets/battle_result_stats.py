...
from halloween_common.halloween_constants import PREBATTLE_TYPE, HALLOWEEN_DEFENCE_ARENA_BONUS_TYPES
...
class BattleResultStats(ViewImpl, IGlobalListener, CallbackDelayer):
    ...
    def __fillViewModel(self, model):
        ...
        model.setIsDefenseMode(totalVO['common']['bonusType'] in HALLOWEEN_DEFENCE_ARENA_BONUS_TYPES)

...
class CloseEventConfirmator(CloseConfirmatorsHelper):
    ...
    def getRestrictedEvents(self):
        return [
         RestrictedEvent(ViewEventType.LOAD_VIEW, EVENT_BUS_SCOPE.LOBBY),
         RestrictedEvent(ViewEventType.LOAD_GUI_IMPL_VIEW, EVENT_BUS_SCOPE.LOBBY),
         RestrictedEvent(BrowserEvent.BROWSER_CREATED, EVENT_BUS_SCOPE.GLOBAL)]

...
_HW_EXTERNAL_COMPONENTS = (
 HalloweenCrosshairPanelContainer, HWMarkersManager)
_HW_CONFIG = ComponentsConfig(config=(
 (
  BATTLE_CTRL_ID.BATTLE_HINTS,
  (
   BATTLE_VIEW_ALIASES.BATTLE_HINT, BATTLE_VIEW_ALIASES.BATTLE_BUFF_HINT,
   BATTLE_VIEW_ALIASES.BATTLE_PICKUP_HINT, BATTLE_VIEW_ALIASES.BATTLE_BASE_HINT)),), viewsConfig=()) + COMMON_CLASSIC_CONFIG
...
class HalloweenPage(ClassicPage):
    ...
    def reload(self):
        hintAliases = [
         BATTLE_VIEW_ALIASES.BATTLE_HINT, BATTLE_VIEW_ALIASES.BATTLE_BUFF_HINT,
         BATTLE_VIEW_ALIASES.BATTLE_PICKUP_HINT, BATTLE_VIEW_ALIASES.BATTLE_BASE_HINT]
    ...
    def _onRoundFinished(self, *args):
        self._setComponentsVisibility(hidden={BATTLE_VIEW_ALIASES.FRAG_CORRELATION_BAR,
         BATTLE_VIEW_ALIASES.EVENT_BASE_PANEL})
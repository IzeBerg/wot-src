...
def getViewSettings():
    return (
     ComponentSettings(HANGAR_ALIASES.HW22_EVENT_ENTRY_POINT, HW22EntryPoint, ScopeTemplates.DEFAULT_SCOPE),
...
def getBusinessHandlers():
    return (
     HW22HangarPackageBusinessHandler(),)
...
class HW22HangarPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          VIEW_ALIAS.HW22_CAROUSEL_FILTER_POPOVER, self.loadViewByCtxEvent),)

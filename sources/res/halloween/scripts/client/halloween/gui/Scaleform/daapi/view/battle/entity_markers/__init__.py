...
HW_MARKERS = {MarkerItem.HW_PICKUP_PLACEMENT: {ComponentBitMask.MARKER_2D: [
   ...
   MarkerItem.HW_TEAM_BASE: {'offset': settings.MARKER_POSITION_ADJUSTMENT, 
                             ...
                             ComponentBitMask.MINIMAP_MARKER: [
                                                             {'symbol': 'HWSectorBaseMinimapAllyEntryUI', 

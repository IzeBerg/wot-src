...
HW_TOTAL_RESULTS_BLOCK.addNextComponent(ex.HwDefPersonalBestTimeItem('hwDefBestTime', _RECORD.PERSONAL))
HW_TOTAL_RESULTS_BLOCK.addNextComponent(ex.HwDefTimeItem('hwDefTime', _RECORD.COMMON, 'duration'))

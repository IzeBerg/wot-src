...
class HWExtendedDamageActionVOBuilder(_DamageActionImgVOBuilder):
    ...
    def _getIcon(cls, reasonID):
        return cls.HW_ATTACK_REASON_TO_ICON.get(ATTACK_REASON.getValue(reasonID), None)
...
_ATTACK_REASON_CODE.update({ATTACK_REASON.getIndex(ATTACK_REASON.HALLOWEEN_ABILITY_VAMPIRE): 'DEATH_FROM_SHOT', 

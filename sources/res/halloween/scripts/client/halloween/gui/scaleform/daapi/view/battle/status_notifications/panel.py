...
class HWStatusNotificationTimerPanel(StatusNotificationTimerPanel):
    ...
    def _generateNotificationTimerSettings(self):
        ...
        link = _LINKS.BATTLE_ROYALE_DESTROY_TIMER_UI
        ...
        self._addNotificationTimerSetting(data, _HWTYPES.MAGNUS_FILL, _HWLINKS.ICON_VOLOT_FILL_IN, _HWLINKS.FILL_TIMER_UI, iconSmallName=_HWLINKS.ICON_VOLOT_FILL_IN_SMALL, color=_HWCOLORS.VIOLET, descriptionOffsetY=-1)

...
class HWPostmortemPanel(PostmortemPanelMeta):
    ...
    TICK_RATE = 1
    RESPAWN_TITLE = R.strings.halloween_battle.postmortemPanel.doNotLeaveGame.title()
    RESPAWN_INFO = R.strings.halloween_battle.postmortemPanel.doNotLeaveGame.desc()
    ...
    def __onSoulCollectorProgress(self, collected, capacity, isFull):

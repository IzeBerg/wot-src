...
ACCOUNT_DEFAULT_SETTINGS = {AccountSettingsKeys.EVENT_KEY: {AccountSettingsKeys.META_INTRO_VIEW_SHOWED: False, 
                                   ...
                                   AccountSettingsKeys.VIEWED_WITHES_INTRO: [], AccountSettingsKeys.VIEWED_WITHES_OUTRO: []}}
...
class HWBonusesType(object):
    ...
    ORDERED_LIST = (
     TANKMAN, STYLE, DECAL, BADGE, MEDAL, CRYSTAL, CREDITS, EQUIPMENT, BATTLE_BOOSTER)
    EQUIPMENT_LIST = ('autoExtinguishers', 'largeRepairkit', 'largeMedkit', 'rammerBattleBooster',
                      'improvedVentilationBattleBooster', 'fireFightingBattleBooster',
                      'improvedSightsBattleBooster', 'additInvisibilityDeviceBattleBooster')

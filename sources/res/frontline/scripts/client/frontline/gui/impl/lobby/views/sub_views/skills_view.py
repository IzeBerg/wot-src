...
class SkillsView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return super(SkillsView, self).createToolTipContent(event, contentID)

    def _getEvents(self):
        return (
         (
          self.viewModel.onSkillSelect, self.__onSkillSelect),
         (
          self.viewModel.onSkillActivate, self.__onSkillActivate),
         (

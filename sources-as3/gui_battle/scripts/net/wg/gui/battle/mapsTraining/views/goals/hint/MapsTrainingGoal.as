package net.wg.gui.battle.mapsTraining.views.goals.hint
{
   ...
   public class MapsTrainingGoal extends Sprite implements IDisposable
   {
      ...
      private var _destroyedItems:Vector.<MovieClip>;
      ...
      public function MapsTrainingGoal()
      {
         ...
         this._destroyedItems = new Vector.<MovieClip>();
      ...
      public function createGoals(param1:Vector.<MapsTrainingGoalVO>) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            while(_loc4_ < _loc3_)
            {
               _loc5_ = App.utils.classFactory.getObject(GOAL_LINKAGE) as MovieClip;
      ...
      private function markDestroyed(param1:MovieClip) : void
      {

package net.wg.gui.battle.historicalBattles.consumablesPanel
{
   ...
   public class HBEquipmentButtonBase extends BattleToolTipButton implements IConsumablesButton, ICoolDownCompleteHandler
   {
      ...
      public var glow:HBGlowBase = null;
      ...
      public function HBEquipmentButtonBase()
      {

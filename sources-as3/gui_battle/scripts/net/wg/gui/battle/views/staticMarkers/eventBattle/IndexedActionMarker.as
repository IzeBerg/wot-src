package net.wg.gui.battle.views.staticMarkers.eventBattle
{
   ...
   public class IndexedActionMarker extends LocationActionMarker
   {
      ...
      public function setAlpha(param1:Number, param2:Number) : void
      {
         var _loc3_:IndexedContent = this.getContent();
         if(_loc3_)
         {
            _loc3_.setAlpha(param1);
            locationLineElement.alpha = param2;
         }
      }

package net.wg.gui.battle.views.FDPostmortemPanel
{
   ...
   public class FDPostmortemTimer extends FrameAnimationTimer
   {
      ...
      public var graphicsSpr:FDPostmortemTimerContainer = null;
      
      public function FDPostmortemTimer()
      {
         super();
         init(true,true);
      }
      ...
      {
         return this.graphicsSpr.progressBar.circle;
      }

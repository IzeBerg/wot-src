package net.wg.gui.battle.eventBattle.views
{
   ...
   public class EventBattlePage extends BaseBattlePage
   {
      ...
      private static const MESSENGER_Y_OFFSET:int = 65;
      
      private static const MINIMAP_OFFSET:int = 18;
      
      private static const EVENT_MESSAGE_OFFSET_Y_WITH_TEAM_BASES_PANEL:int = 30;
      ...
      private var _initialEventMessageY:int = 0;
      ...
      public function EventBattlePage()
      {
         ...
         this._initialEventMessageY = this.eventMessage.y;
      ...
      override protected function configUI() : void
      {
         ...
         this.statusNotificationsPanel.snapToRibbonsPanel(ribbonsPanel);
         super.configUI();
      }
      ...
      {
         this.bossWidget.x = _width - this.bossWidget.initedWidth >> 1;
         this.bossWidgetShadow.x = _width - this.bossWidgetShadow.width >> 1;
      }
      
      private function onTeamBasesPanelChanged(param1:Event) : void
      {
         var _loc2_:int = this.teamBasesPanelUI.panelHeight > 0 ? int(this.teamBasesPanelUI.panelHeight + EVENT_MESSAGE_OFFSET_Y_WITH_TEAM_BASES_PANEL | 0) : int(0);
         this.clearMessageTween();
         this._messageTween = new Tween(MESSAGE_TWEEN_TIME,this.eventMessage,{"y":this._initialEventMessageY + _loc2_},{"ease":Cubic.easeInOut});
      }
   }
}

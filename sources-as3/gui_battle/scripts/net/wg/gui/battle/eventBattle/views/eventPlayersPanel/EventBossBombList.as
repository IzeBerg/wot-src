package net.wg.gui.battle.eventBattle.views.eventPlayersPanel
{
   ...
   public class EventBossBombList extends BattleUIComponent
   {
      ...
      private var _listItems:Vector.<EventBossBombListItem> = null;
      
      private var _rendererContainer:Sprite = null;
      
      public function EventBossBombList()
      {
         super();
         this._listItems = new Vector.<EventBossBombListItem>();
      ...
      {
         var _loc6_:EventBossBombListItem = null;
         ...
         if(_loc5_ < 0)
         {
            if(param2 > 0)
            {
               ...
               _loc6_ = App.utils.classFactory.getComponent(_loc7_,EventBossBombListItem);
               _loc6_.id = param1;
      ...
      {
         var _loc1_:EventBossBombListItem = null;
      ...
      {
         var _loc2_:EventBossBombListItem = null;
      ...
      private function compare(param1:EventBossBombListItem, param2:EventBossBombListItem) : int
      {

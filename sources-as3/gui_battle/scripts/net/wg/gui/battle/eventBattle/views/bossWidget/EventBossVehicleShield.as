package net.wg.gui.battle.eventBattle.views.bossWidget
{
   ...
   public class EventBossVehicleShield extends BattleUIComponent
   {
      ...
      public function EventBossVehicleShield()
      {
      ...
      public function showRevealAnimation() : void
      {
         ...
         EventBossWidget.playSound(SoundTypes.WT_EVENT_BOSS_SHIELD_SHOW);
      }
      ...
      private function showShieldIcon() : void
      {
         ...
         EventBossWidget.playSound(SoundTypes.WT_EVENT_BOSS_TANK_ICON_SHOW);
      }
      
      private function showBossIcon() : void
      {
         this._scheduler.cancelTask(this.showBossIcon);
         dispatchEvent(new EventBossWidgetEvent(EventBossWidgetEvent.SHOW_BOSS_ICON_ANIMATION));
      }
      ...
      public function set isIdleAnimationVisible(param1:Boolean) : void
      {
         ...
         if(this._isIdleAnimationVisible != param1)
         {
            ...
            _loc2_ = !!this._isIdleAnimationVisible ? EventBossWidgetEvent.SHOW_SHIELD_IDLE_ANIMATION : EventBossWidgetEvent.HIDE_SHIELD_IDLE_ANIMATION;
            dispatchEvent(new EventBossWidgetEvent(_loc2_));
         }
      }
   }
}

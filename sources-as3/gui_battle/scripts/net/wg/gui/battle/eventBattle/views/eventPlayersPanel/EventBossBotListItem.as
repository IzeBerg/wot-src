package net.wg.gui.battle.eventBattle.views.eventPlayersPanel
{
   ...
   public class EventBossBotListItem extends BattleUIComponent
   {
      ...
      private static const HP_COLOR_LIVE:uint = 15921911;
      
      private static const HP_COLOR_DEAD:uint = 8553090;
      ...
      public function EventBossBotListItem()
      {
         super();
      }
      ...
      public function setHp(param1:int, param2:int) : void
      {
         ...
         this.healthTF.text = param2 + SEPARATOR + param1;
      ...
      public function setData(param1:DAAPIEventBossBotInfoVO) : void
      {
      ...
      public function set isDead(param1:Boolean) : void
      {
         if(this._isDead != param1)
         {
            ...
            this.healthTF.textColor = !!this._isDead ? uint(HP_COLOR_DEAD) : uint(HP_COLOR_LIVE);
         }
      }
   }
}

package net.wg.gui.battle.eventBattle.views.bossWidget
{
   ...
   public class EventBossVehicleDebuff extends BattleUIComponent
   {
      ...
      public var debuffProgress:EventProgressBar = null;
      ...
      public function EventBossVehicleDebuff()
      {
         super();
      }
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(INVALIDATE_DEBUFF_TIME))
         {
            ...
            if(this.visible)
            {
               ...
               this.debuffProgress.value = PROGRESS_MULTIPLIER * EventProgressBar.getProgress(this._debuffTotalTime,this._debuffRemainingTime);

package net.wg.gui.battle.eventBattle.views.eventPlayersPanel.comps
{
   ...
   public class EventTimerAnimHelper implements IDisposable
   {
       
      
      private var _animation:IEventTimerAnimation = null;
      ...
      public function EventTimerAnimHelper(param1:IEventTimerAnimation)
      {
         super();

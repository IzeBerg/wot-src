package net.wg.gui.battle.eventBattle.views.eventPlayersPanel
{
   ...
   public class EventHunterPanelList extends BasePlayersPanelList
   {
      ...
      public function EventHunterPanelList()
      {
         super();
      }
      ...
      override protected function onPlayersListItemRightClick(param1:PlayersPanelItemEvent) : void
      {
         ...
         var _loc3_:PlayersPanelDynamicSquad = IPlayersPanelListItem(param1.playersListItem).getDynamicSquad();
         _loc3_.onItemOut();
      ...
      {
         return EventHunterPanelListItemHolder;
      }

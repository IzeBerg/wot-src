package net.wg.gui.battle.eventBattle.views.bossWidget
{
   ...
   public class EventGenerators extends BattleUIComponent
   {
      ...
      public var batteryProgress:EventProgressBar = null;
      ...
      public function EventGenerators()
      {
      ...
      override protected function draw() : void
      {
         ...
         if(_loc3_ && this._isBatteryVisible)
         {
            ...
            this.batteryProgress.value = GENERATOR_PROGRESS_MULTIPLIER * (GENERATOR_MAX_PROGRESS - EventProgressBar.getProgress(this._chargingTotalTime,this._chargingRemainingTime));
            if(!_loc4_)
            {
      ...
      public function updateCharging(param1:int, param2:int) : void
      {
         ...
         {
            EventBossWidget.playSound(SoundTypes.WT_EVENT_BOSS_GENERATORS_ACTIVE_SHOW);
         }
      ...
      private function startShowAnimation() : void
      {
         ...
         EventBossWidget.playSound(SoundTypes.WT_EVENT_BOSS_GENERATORS_SHOW);
      ...
      private function showGenerator() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            EventBossWidget.playSound(SoundTypes.WT_EVENT_BOSS_GENERATOR_SHOW);
         }
      ...
      private function showBattery() : void
      {
         if(this._isBatteryVisible)
         {
            ...
            EventBossWidget.playSound(SoundTypes.WT_EVENT_BOSS_TIME_SHOW);
         }
         else
         {
      ...
      {
         EventBossWidget.playSound(SoundTypes.WT_EVENT_BOSS_TIME_TICK_SHOW);
      }

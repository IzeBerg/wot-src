package net.wg.gui.battle.eventBattle.views.eventTeleportView
{
   ...
   import net.wg.infrastructure.base.meta.impl.EventBossTeleportViewMeta;
   import net.wg.infrastructure.events.LifeCycleEvent;
   
   public class EventBossTeleportView extends EventBossTeleportViewMeta implements IEventBossTeleportViewMeta
   {
      ...
      public function EventBossTeleportView()
      {
         super();
      }

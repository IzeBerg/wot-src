package net.wg.gui.battle.eventBattle.views.eventPlayersPanel
{
   ...
   public class EventPlayersPanel extends EventPlayersPanelMeta implements IEventPlayersPanelMeta
   {
      ...
      public function as_updateBossBombTimer(param1:int, param2:Number, param3:Number, param4:Number) : void
      {
         this.bossPanelList.updateBombTimer(param1,param2,param3,param4);
      }

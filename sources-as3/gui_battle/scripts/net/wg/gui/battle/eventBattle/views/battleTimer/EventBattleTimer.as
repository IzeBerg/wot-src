package net.wg.gui.battle.eventBattle.views.battleTimer
{
   ...
   public class EventBattleTimer extends EventBattleTimerMeta implements IEventBattleTimerMeta
   {
      ...
      public var messageContainer:EventTextFieldContainer = null;
      ...
      public function EventBattleTimer()
      {

package net.wg.gui.battle.eventBattle.views.eventStats
{
   ...
   public class EventStatsTableCtrl extends StatsTableControllerBase implements ITabbedFullStatsTableController, ISquadHandler
   {
      ...
      private var _table:EventStatsTable = null;
      ...
      public function EventStatsTableCtrl(param1:EventStatsTable, param2:StatsBaseMeta)
      {
         this._table = param1;
         super(param1);
      ...
      override public function setSpeaking(param1:Number, param2:Boolean) : void
      {
      ...
      override public function setVehiclesStats(param1:Vector.<DAAPIVehicleStatsVO>, param2:Vector.<DAAPIVehicleStatsVO>) : void
      {
         ...
         if(isFDEvent && _loc3_.updateDamages(param1))
         {
            _loc3_.invalidate();
         }
         _loc3_ = _enemyDP;
         ...
         if(isFDEvent && _loc3_.updateDamages(param2))
         {
            _loc3_.invalidate();
         }
      }
      
      override public function updateInvitationsStatuses(param1:Boolean, param2:Vector.<DAAPIInvitationStatusVO>) : void
      {
      ...
      override public function setDogTagToShow(param1:Number, param2:DogTagVO) : void
      {
         var _loc3_:StatsTableItemHolderBase = null;
         _dogTagsToShow[param1] = param2;
         for each(_loc3_ in enemyRenderers)
         {
      ...
      override public function setFDEvent(param1:Boolean) : void
      {
         ...
         this._table.setFDEvent(isFDEvent);
      }

package net.wg.gui.battle.eventBattle.views.bossWidget
{
   ...
   public class EventBossVehicle extends BattleUIComponent
   {
      ...
      public var shield:EventBossVehicleShield = null;
      
      public var debuff:EventBossVehicleDebuff = null;
      
      private var powerTF:TextFieldContainer = null;
      
      private var powerBg:Sprite = null;
      ...
      public function EventBossVehicle()
      {
         this._powersList = [];
         super();
      ...
      {
         super.configUI();
         this.powerTF = this.generatorPower.powerTF;
         this.powerBg = this.generatorPower.bg;
         ...
         this.shield.addEventListener(EventBossWidgetEvent.SHOW_BOSS_ICON_ANIMATION,this.onShowBossIcon);
         this.shield.addEventListener(EventBossWidgetEvent.SHOW_SHIELD_IDLE_ANIMATION,this.onShowIdleAnimation);
         this.shield.addEventListener(EventBossWidgetEvent.HIDE_SHIELD_IDLE_ANIMATION,this.onHideIdleAnimation);
      }
      ...
      override protected function onDispose() : void
      {
         ...
         this.debuff.dispose();
         this.debuff = null;
         this.shield.removeEventListener(EventBossWidgetEvent.SHOW_BOSS_ICON_ANIMATION,this.onShowBossIcon);
         this.shield.removeEventListener(EventBossWidgetEvent.SHOW_SHIELD_IDLE_ANIMATION,this.onShowIdleAnimation);
         this.shield.removeEventListener(EventBossWidgetEvent.HIDE_SHIELD_IDLE_ANIMATION,this.onHideIdleAnimation);
         this.shield.dispose();
         this.shield = null;
         this.powerTF.dispose();
         this.powerTF = null;
         this.powerBg = null;
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(INVALIDATE_AVAILABLE_GENERATORS))
         {
            ...
            {
               this.powerTF.label = this._powersList[this._availableGenerators - 1];
            }
      ...
      private function onShowBossIcon(param1:EventBossWidgetEvent) : void
      {
         gotoAndPlay(STATE_SHOW_REVEAL);
      }
      
      private function onShowIdleAnimation(param1:EventBossWidgetEvent) : void
      {
         this.isIdleAnimationVisible = true;
      }
      
      private function onHideIdleAnimation(param1:EventBossWidgetEvent) : void
      {

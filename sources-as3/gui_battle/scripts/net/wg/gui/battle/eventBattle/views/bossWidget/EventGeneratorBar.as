package net.wg.gui.battle.eventBattle.views.bossWidget
{
   ...
   public class EventGeneratorBar extends BattleUIComponent
   {
      ...
      public function lockGenerator(param1:Number, param2:Boolean) : void
      {
         if(currentFrameLabel != FRAME_LABEL_SHIELD_ONLINE)
         {
            return;
         ...
         {
            case 1:
               this.generatorOne.setGeneratorLocked(param2);
               break;
            case 2:
               this.generatorTwo.setGeneratorLocked(param2);
               break;
            case 3:
               this.generatorThree.setGeneratorLocked(param2);
         }
      }

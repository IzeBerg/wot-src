package net.wg.gui.battle.eventBattle.views.bossWidget
{
   ...
   public class EventBossWidgetMainProgressBar extends EventProgressBar
   {
      ...
      public function EventBossWidgetMainProgressBar()
      {
         super();
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(INVALIDATE_DEBUFF) && this._isInited)
         {
            ...
            if(this._isDebuff)
            {
               ...
               EventBossWidget.playSound(SoundTypes.WT_EVENT_BOSS_PROGRESS_DEBUFF);
            }
            else
            {
               this._debuffAnimationActive = true;
               ...
               this.hpProgress.addFrameScript(this._curAnimationFrame - 1,this.onHideDebuffProgressBar);

package net.wg.gui.battle.eventBattle.views.eventStats
{
   ...
   public class EventStatsTableItemHolder extends StatsTableItemHolder
   {
      ...
      {
         return super.isSelected && (this._data == null || this._data.bombTimeLeft == 0);
      }
      ...
      override protected function vehicleDataSync() : void
      {
         ...
         if(this._data != null)
         {
            this._statsItem.isCarrier = this._data.bombTimeLeft > 0;
      ...
      {
         this._statsItem.setBombTimer(this._data.bombIndex,this._data.bombTimeLeft,this._data.bombTimeTotal,this._data.replaySpeed);

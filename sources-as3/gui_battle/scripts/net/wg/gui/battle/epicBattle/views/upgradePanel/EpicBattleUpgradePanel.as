package net.wg.gui.battle.epicBattle.views.upgradePanel
{
   ...
   import net.wg.infrastructure.base.meta.impl.EpicBattleUpgradePanelMeta;
   import scaleform.clik.events.ComponentEvent;
   import scaleform.clik.motion.Tween;
   
   public class EpicBattleUpgradePanel extends EpicBattleUpgradePanelMeta implements IBattleUpgradePanelMeta
   {
      ...
      public var choicePanel:EpicChoiceInfoPanel = null;
      ...
      private var _data:EpicUpgradePanelVO = null;
      ...
      public function EpicBattleUpgradePanel()
      {
         super();
      }
      ...
      {
         super.configUI();
         this.choicePanel.addEventListener(EpicChoiceInfoPanel.SELECT_ANIM_COMPLETE,this.onChoiceInfoPanelAnimCompleteHandler);
      ...
      override protected function setData(param1:EpicUpgradePanelVO) : void
      {
         this._data = param1;
      ...
      override protected function onDispose() : void
      {
         ...
         this.choicePanel.removeEventListener(EpicChoiceInfoPanel.SELECT_ANIM_COMPLETE,this.onChoiceInfoPanelAnimCompleteHandler);

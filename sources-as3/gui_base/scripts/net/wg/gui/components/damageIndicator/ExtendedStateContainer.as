package net.wg.gui.components.damageIndicator
{
   ...
   public class ExtendedStateContainer extends StandardStateContainer
   {
      ...
      private static const TANK_TYPE_ICONS:Vector.<String> = new <String>[DAMAGEINDICATOR.HEAVY_TANK,DAMAGEINDICATOR.MEDIUM_TANK,DAMAGEINDICATOR.LIGHT_TANK,DAMAGEINDICATOR.AT_SPG,DAMAGEINDICATOR.SPG,DAMAGEINDICATOR.ALLY_HEAVY_TANK,DAMAGEINDICATOR.ALLY_MEDIUM_TANK,DAMAGEINDICATOR.ALLY_LIGHT_TANK,DAMAGEINDICATOR.ALLY_AT_SPG,DAMAGEINDICATOR.ALLY_SPG,DAMAGEINDICATOR.SUPPLY_A_TGUN,DAMAGEINDICATOR.SUPPLY_BARRICADES,DAMAGEINDICATOR.SUPPLY_BUNKER,DAMAGEINDICATOR.SUPPLY_FLAMER,DAMAGEINDICATOR.SUPPLY_MORTAR,DAMAGEINDICATOR.SUPPLY_PILLBOX,DAMAGEINDICATOR.SUPPLY_WATCH_TOWER,DAMAGEINDICATOR.ALLY_SUPPLY_A_TGUN,DAMAGEINDICATOR.ALLY_SUPPLY_BARRICADES,DAMAGEINDICATOR.ALLY_SUPPLY_BUNKER,DAMAGEINDICATOR.ALLY_SUPPLY_FLAMER,DAMAGEINDICATOR.ALLY_SUPPLY_MORTAR,DAMAGEINDICATOR.ALLY_SUPPLY_PILLBOX,DAMAGEINDICATOR.ALLY_SUPPLY_WATCH_TOWER];

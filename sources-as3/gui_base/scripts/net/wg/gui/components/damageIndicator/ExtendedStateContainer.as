package net.wg.gui.components.damageIndicator
{
   ...
   public class ExtendedStateContainer extends StandardStateContainer
   {
      ...
      private static const TANK_TYPE_ICONS:Vector.<String> = new <String>[DAMAGEINDICATOR.HEAVY_TANK,DAMAGEINDICATOR.MEDIUM_TANK,DAMAGEINDICATOR.LIGHT_TANK,DAMAGEINDICATOR.AT_SPG,DAMAGEINDICATOR.SPG,DAMAGEINDICATOR.HEAVY_TANK_ELITE,DAMAGEINDICATOR.MEDIUM_TANK_ELITE,DAMAGEINDICATOR.LIGHT_TANK_ELITE,DAMAGEINDICATOR.AT_SPG_ELITE,DAMAGEINDICATOR.SPG_ELITE,DAMAGEINDICATOR.BOSS,DAMAGEINDICATOR.RUNNER,DAMAGEINDICATOR.AIMER,DAMAGEINDICATOR.ALLY_HEAVY_TANK,DAMAGEINDICATOR.ALLY_MEDIUM_TANK,DAMAGEINDICATOR.ALLY_LIGHT_TANK,DAMAGEINDICATOR.ALLY_AT_SPG,DAMAGEINDICATOR.ALLY_SPG];

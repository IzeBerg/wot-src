package net.wg.gui.components.ribbon.data
{
   ...
   public class RibbonSettings implements IDisposable
   {
      ...
      protected function atlasInit() : void
      {
         ...
         RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.SUPPLY_DESTRUCTION] = new RibbonSettingByType(_loc1_,BATTLEATLAS.RIBBONS_SUPPLY_DESTROYED,_loc1_,BATTLEATLAS.RIBBONS_SUPPLY_DESTROYED,2);
         ...
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.SUPPLY_BARRICADES] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_BARRICADES16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.SUPPLY_BUNKER] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_GUN16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.SUPPLY_ATGUN] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_A_TGUN16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.SUPPLY_WATCHTOWER] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_TOWER16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.SUPPLY_PILLBOX] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_PILLBOX16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.SUPPLY_MORTAR] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_MORTAR16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.SUPPLY_FLAMER] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_FLAMER16X16);
      ...
      private function init() : void
      {
         if(!_isInit)
         {
            ...
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_BARRICADES] = 0;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_BUNKER] = 0;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_ATGUN] = 0;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_WATCHTOWER] = 0;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_PILLBOX] = 0;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_MORTAR] = 0;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_FLAMER] = 0;
            ...
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_BARRICADES] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_BUNKER] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_ATGUN] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_WATCHTOWER] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_PILLBOX] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_MORTAR] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.SUPPLY_FLAMER] = 11;
         }
      }

package net.wg.gui.components.ribbon.data
{
   ...
   public class RibbonSettings implements IDisposable
   {
      ...
      protected function atlasInit() : void
      {
         ...
         RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.EVENT_HEAL_UP] = new RibbonSettingByType(_loc1_,BATTLEATLAS.RIBBONS_HEALTH_REGENERATION,_loc1_,BATTLEATLAS.RIBBONS_HEALTH_REGENERATION,1);
         RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.EVENT_ADD_AMMO] = new RibbonSettingByType(_loc4_,BATTLEATLAS.RIBBONS_ADD_AMMO,_loc4_,BATTLEATLAS.RIBBONS_ADD_AMMO,1);

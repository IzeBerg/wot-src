package net.wg.infrastructure.base.meta.impl
{
   ...
   public class BattleQueueMeta extends AbstractView
   {
      ...
      public final function as_setTypeInfo(param1:Object) : void
      {
         ...
         this._battleQueueTypeInfoVO = this.getBattleQueueTypeInfoVOForData(param1);
      ...
      protected function getBattleQueueTypeInfoVOForData(param1:Object) : BattleQueueTypeInfoVO
      {
         var _loc2_:String = "getBattleQueueTypeInfoVOForData" + Errors.ABSTRACT_INVOKE;

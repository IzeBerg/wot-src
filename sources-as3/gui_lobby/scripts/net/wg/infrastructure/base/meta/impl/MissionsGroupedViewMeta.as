package net.wg.infrastructure.base.meta.impl
{
   ...
   public class MissionsGroupedViewMeta extends MissionsListViewBase
   {
      ...
      public var onGotoRtsQuestsClick:Function;
      ...
      public function onGotoRtsQuestsClickS() : void
      {
         App.utils.asserter.assertNotNull(this.onGotoRtsQuestsClick,"onGotoRtsQuestsClick" + Errors.CANT_NULL);
         this.onGotoRtsQuestsClick();
      }
   }
}

...
{
   public class NYMessageSettings
   {
      ...
      public function NYMessageSettings(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int, param9:int, param10:int, param11:int, param12:String, param13:String)
      {
         super();
         this._iconX = param1;
         this._iconY = param2;
         ...
         this._textY = param4;
         this._textW = param5;
         this._bgIconOffset = param6;
         this._counterX = param7;
         this._counterY = param8;
         this._btnPadding = param9;
         this._bottomOffset = param10;
         this._rightOffset = param11;
         this._bgLinkage = param12;
         this._counterLinkage = param13;
      }

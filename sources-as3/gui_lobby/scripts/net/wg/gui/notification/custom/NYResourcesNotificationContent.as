package net.wg.gui.notification.custom
{
   ...
   public class NYResourcesNotificationContent extends ServiceMessageContent
   {
      ...
      override protected function updateBgHeight() : void
      {
         var _loc1_:int = buttonsGroup.y + buttonsGroup.height + buttonsGroupPaddingTop + messageBottomOffset - background.y;

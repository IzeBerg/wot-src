package net.wg.gui.components.advanced
{
   ...
   public class CounterEx extends UIComponentEx
   {
      ...
      private function setLinesPosition(param1:Number) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc3_ = param1 < Math.abs(this.number) ? Boolean(this.lines[_loc4_].currentFrame >= this.checkTruePosition[_loc4_].num) : Boolean(this.lines[_loc4_].currentFrame <= this.checkTruePosition[_loc4_].num);

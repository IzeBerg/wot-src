   ...
   public class TechniqueRenderer extends SoundListItemRenderer
   {
      ...
      private function updateScale() : void
      {
         ...
         if(data)
         {
            ...
            this.levelMC.scaleX = this.levelMC.scaleY = _loc1_ && !data.isOtherPlayer ? Number(LEVEL_SCALE) : Number(1);
         }
      }
      ...
      {
         if(this._compareModeAvailable && this._commons.isRightButton(param1))
         {

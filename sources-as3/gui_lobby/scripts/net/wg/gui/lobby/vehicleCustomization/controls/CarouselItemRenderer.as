package net.wg.gui.lobby.vehicleCustomization.controls
{
   ...
   public class CarouselItemRenderer extends UIComponentEx implements IScrollerItemRenderer, IDropItem
   {
      ...
      private function applyData() : void
      {
         ...
         var _loc5_:Boolean = this._data.typeId == GUI_ITEM_TYPES.STYLE;
         this.progressionStylesLevelIcon.visible = _loc5_;
         this.progressionLevelIcon.visible = !_loc5_;
         var _loc6_:MovieClip = !!_loc5_ ? this.progressionStylesLevelIcon : this.progressionLevelIcon;
         var _loc7_:String = this._data.progressionLevel.toString().concat(!!_loc2_ ? PROGRESSION_ICON_SMALL_LABEL_POSTFIX : PROGRESSION_ICON_BIG_LABEL_POSTFIX);
         _loc6_.gotoAndStop(_loc7_);
         _loc6_.visible = this._data.progressionLevel > 0 && !_loc4_;
         var _loc8_:int = 0;
         if(_loc6_.visible)
         {
            _loc8_ = _loc6_.x + _loc6_.width + PROGRESSION_LEVEL_GAP;
         }
         ...
         if(_loc4_)
         {
            ...
            _loc8_ = this.progressionRewindIcon.x + this.progressionRewindIcon.width + PROGRESSION_LEVEL_GAP;
         }
         if(this.editableSlotHint.visible)
         {
            this.editableSlotHint.x = _loc8_ + EDITABLE_BG_X;
         }
         if(this.editableImg.visible)
         {
            this.editableImg.x = _loc8_ + EDITABLE_IMG_X;
            _loc8_ = this.editableImg.x + EDITABLE_IMG_WIDTH + EDITABLE_IMG_GAP;
         }
         if(this.limitedIcon.visible)
         {
            this.limitedIcon.x = _loc8_;
            _loc8_ = this.limitedIcon.x + this.limitedIcon.width + LIMITED_ICON_GAP;
         }
         if(this.alertIcon.visible)
         {
            this.alertIcon.x = _loc8_ + ALERT_ICON_X;
         }
         ...
         if(this._data.buyPrice)
         {
            ...
            {
               _loc9_ = this._data.buyPrice.action != null;
               _loc10_ = !!_loc2_ ? int(0) : int(-ICON_PADDING_RIGHT);
               _loc11_ = !!_loc9_ ? int(ACTION_ICON_PADDING_RIGHT) : int(0);
               _loc12_ = _loc9_ && _loc2_ ? int(ACTION_MIN_RES_OFFSET) : int(0);
               this.compoundPrice.x = this._customWidth + _loc10_ + _loc11_ + _loc12_;
         ...
         if(this._data.isRental)
         {
            if(StringUtils.isNotEmpty(this._data.quantity))
            {
               ...
               _loc13_ = this._customWidth - this.rentalTF.textWidth - RENTAL_TF_PADDING_RIGHT;
               this.rentalTF.x = _loc13_;
               this.rentalTF.y = this._customHeight - this.rentalTF.height ^ 0;
               this.rentalIcon.x = _loc13_ - RENTAL_ICON_SIZE + RENTAL_ICON_OFFSET_X;

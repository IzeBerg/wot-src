package net.wg.gui.lobby.browser
{
   ...
   public class Browser extends BrowserMeta implements IBrowserMeta
   {
      ...
      private function onBgLoaderCompleteHandler(param1:Event) : void
      {
         ...
         this._bgImg.alpha = this.bgImageAlpha;
         this.resizeBgImg(width,height,false);
      ...
      private function resizeBgImg(param1:Number, param2:Number, param3:Boolean = true) : void
      {
         if(param3 && this._bgImg.width != param1 && this._bgImg.height != param2)
         {
            this.reloadBitmap();
         }
         setBrowserSizeS(param1 * this._appScale,param2 * this._appScale,this._appScale);
         this._bgImg.width = param1;
         this._bgImg.height = param2;
         this._bgImg.scaleY = -Math.abs(this._bgImg.scaleY);
         this._bgImg.y = param2;
      }

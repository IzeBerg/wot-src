package net.wg.gui.lobby.vehiclePreview.buyingPanel
{
   ...
   import net.wg.infrastructure.base.meta.impl.VehiclePreviewWotPlusPanelMeta;
   import scaleform.clik.constants.InvalidationType;
   import scaleform.clik.events.ButtonEvent;
   
   public class VPWotPlusPanel extends VehiclePreviewWotPlusPanelMeta implements IVPBottomPanel
   {
      ...
      public function VPWotPlusPanel()
      {
         super();
      }

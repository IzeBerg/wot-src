package net.wg.gui.lobby.eventBattleQueue
{
   ...
   public class EventBattleQueue extends EventBattleQueueMeta implements IEventBattleQueueMeta
   {
      ...
      override protected function getQuickStartPanelVOForData(param1:Object) : QuickStartPanelVO
      {
         ...
         App.utils.asserter.assert(EVENT_BATTLES_CONSTS.QUICK_START_PANEL_TYPES.indexOf(_loc2_) >= 0,"type " + _loc2_ + Errors.WASNT_FOUND);
         if(_loc2_ == EVENT_BATTLES_CONSTS.BOSS_QUICK_START_PANEL)
         {
            return new BossQuickStartPanelVO(param1);
         }
         if(_loc2_ == EVENT_BATTLES_CONSTS.HUNTER_QUICK_START_PANEL)
         {
      ...
      override protected function showQuickStartPanel(param1:QuickStartPanelVO) : void
      {
         ...
         if(param1.type == EVENT_BATTLES_CONSTS.BOSS_QUICK_START_PANEL)
         {
         ...
         else if(param1.type == EVENT_BATTLES_CONSTS.HUNTER_QUICK_START_PANEL)
         {

package net.wg.gui.lobby.header.headerButtonBar
{
   ...
   public class HBC_Squad extends HeaderButtonContentItem
   {
      ...
      private static const HIGHLIGHT_OFFSET_X:int = 108;
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(UPDATE_SQUAD_STATE_ID))
         {
            ...
            if(StringUtils.isNotEmpty(this._squadDataVo.eventBgLinkage))
            {
               this.highlight.visible = true;
               this.highlight.setAnimLinkage(this._squadDataVo.eventBgLinkage);
      ...
      override protected function updateSize() : void
      {
         ...
         this.highlight.x = bounds.x + bounds.width + HIGHLIGHT_OFFSET_X | 0;

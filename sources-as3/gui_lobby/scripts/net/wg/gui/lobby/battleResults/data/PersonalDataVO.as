package net.wg.gui.lobby.battleResults.data
{
   ...
   public class PersonalDataVO extends DAAPIDataClass
   {
      ...
      public static const RTS_1X1_CURRENCY_NAME:String = "rts1x1currency";
      
      public static const RTS_1X7_CURRENCY_NAME:String = "rts1x7currency";
      
      private static const FIELD_EFFICIENCY_HEADER:String = "efficiencyHeader";
      
      private static const FIELD_SUPPLY_EFFICIENCY_HEADER:String = "supplyEfficiencyHeader";
      ...
      private static const SPECIAL_CURRENCY_DATA:String = "specialCurrencyData";
      
      private static const RTS_1x7_CURRENCY_DETAILS:String = "rts1x7CurrencyDetails";
      
      private static const RTS_1x1_CURRENCY_DETAILS:String = "rts1x1CurrencyDetails";
      ...
      public var rts1x7CurrencyStr:String = "";
      
      public var rts1x1CurrencyStr:String = "";
      ...
      public var specialCurrencyData:Vector.<Vector.<DetailedStatsItemVO>> = null;
      ...
      public var rts1x7CurrencyDetails:Vector.<StatItemVO> = null;
      
      public var rts1x1CurrencyDetails:Vector.<StatItemVO> = null;
      
      public var efficiencyTitle:String = "";
      
      public var efficiencyHeader:EfficiencyHeaderVO = null;
      
      public var supplyEfficiencyHeader:EfficiencyHeaderVO = null;
      ...
      public var canBeFaded:Boolean = true;
      ...
      override protected function onDataWrite(param1:String, param2:Object) : Boolean
      {
         ...
         switch(param1)
         {
            ...
            case STAT_VALUES:
               ...
               return false;
            case RTS_1x7_CURRENCY_DETAILS:
               _loc3_ = param2 as Array;
               this._asserter.assertNotNull(_loc3_,Errors.CANT_NULL);
               this.fillRTS1x7CurrencyDetailedValues(_loc3_);
               return false;
            case RTS_1x1_CURRENCY_DETAILS:
               _loc3_ = param2 as Array;
               this._asserter.assertNotNull(_loc3_,Errors.CANT_NULL);
               this.fillRTS1x1CurrencyDetailedValues(_loc3_);
               return false;
            ...
            case FIELD_EFFICIENCY_HEADER:
               ...
               return false;
            case FIELD_SUPPLY_EFFICIENCY_HEADER:
               this.supplyEfficiencyHeader = new EfficiencyHeaderVO(param2);
               this.supplyEfficiencyHeader.isStunDataEnabled = this.isStunDataEnabled;
               return false;
            case FIELD_DETAILS:
               _loc3_ = param2 as Array;
      ...
      override protected function onDispose() : void
      {
         ...
         if(this.specialCurrencyData != null)
         {
            cleanVectorOfVectors(this.specialCurrencyData);
            this.specialCurrencyData = null;
         }
         if(this.xpData != null)
         {
         ...
         if(this.rts1x7CurrencyDetails != null)
         {
            for each(_loc1_ in this.rts1x7CurrencyDetails)
            {
               _loc1_.dispose();
            }
            this.rts1x7CurrencyDetails.splice(0,this.rts1x7CurrencyDetails.length);
            this.rts1x7CurrencyDetails = null;
         }
         if(this.rts1x1CurrencyDetails != null)
         {
            for each(_loc1_ in this.rts1x1CurrencyDetails)
            {
               _loc1_.dispose();
            }
            this.rts1x1CurrencyDetails.splice(0,this.rts1x1CurrencyDetails.length);
            this.rts1x1CurrencyDetails = null;
         }
         ...
         if(this.supplyEfficiencyHeader)
         {
            this.supplyEfficiencyHeader.dispose();
            this.supplyEfficiencyHeader = null;
         }
         if(this.statValues != null)
         {
            cleanVectorOfVectors(this.statValues);
      ...
      private function fillRTS1x7CurrencyDetailedValues(param1:Array) : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         if(param1)
         {
            _loc2_ = param1.length;
            this.rts1x7CurrencyDetails = new Vector.<StatItemVO>(_loc2_);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               this.rts1x7CurrencyDetails[_loc3_] = new StatItemVO(param1[_loc3_]);
               _loc3_++;
            }
         }
      }
      
      private function fillRTS1x1CurrencyDetailedValues(param1:Array) : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         if(param1)
         {
            _loc2_ = param1.length;
            this.rts1x1CurrencyDetails = new Vector.<StatItemVO>(_loc2_);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               this.rts1x1CurrencyDetails[_loc3_] = new StatItemVO(param1[_loc3_]);
               _loc3_++;
            }
         }
      }

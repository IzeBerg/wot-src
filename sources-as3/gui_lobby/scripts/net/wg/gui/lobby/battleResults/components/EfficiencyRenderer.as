package net.wg.gui.lobby.battleResults.components
{
   ...
   public class EfficiencyRenderer extends UIComponentEx implements IListItemRenderer
   {
      ...
      private static const RTS_X_VEHNAME:int = 79;
      
      private static const RTS_X_VEHICON:int = 25;
      ...
      private function setGroupLabelData() : void
      {
         ...
         var _loc1_:EfficiencyHeaderVO = this._data.efficiencyHeader;
         if(_loc1_ && _loc1_.hasEfficencyStats)
         {
            this.efficiencyHeader.visible = true;
            this.efficiencyHeader.setData(_loc1_);
         }
      ...
      {
         var _loc1_:Boolean = this._data.isUserNameHidden;
         this.groupLabelTF.visible = this.efficiencyHeader.visible = false;
         this.playerName.visible = !_loc1_;
         ...
         this.armorIcon.visible = !this._data.isFake && !this._data.isAlly && this._data.armorTotalItems != Values.DEFAULT_INT;
         this.damageIcon.visible = !this._data.isFake && !this._data.isAlly;
         this.critsIcon.visible = !this._data.isFake && !this._data.isAlly && this._data.critsCount != Values.DEFAULT_INT;
         ...
         {
            this.stunIcon.visible = !this._data.isFake && !this._data.isAlly && this._data.stunTotalItems != Values.DEFAULT_INT;
            if(_loc1_)
            {
               this.vehicleIcon.x = RTS_X_VEHICON;
               this.vehicleName.x = RTS_X_VEHNAME;
            }
            else
            {
         ...
         var _loc2_:TextFormat = this.playerName.textField.getTextFormat();
         if(this._data.isFake)
         {
            _loc2_.align = TextFormatAlign.LEFT;
            _loc2_.leftMargin = LEFT_MARGIN;
            this.playerName.textField.setTextFormat(_loc2_);
         }
         else
         {
            ...
            if(this._data.spotted > 0)
            {
               this.spottedIcon.enabled = true;
               this.spottedIcon.value = this._data.spotted;
            }

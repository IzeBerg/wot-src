package net.wg.gui.lobby.battleResults
{
   ...
   public class TeamStats extends UIComponentEx implements IViewStackContent
   {
      ...
      override protected function configUI() : void
      {
         ...
         this.enemyTitle.addEventListener(MouseEvent.CLICK,this.onEnemyTitleClickHandler);
      ...
      {
         this.enemyTitle.removeEventListener(MouseEvent.CLICK,this.onEnemyTitleClickHandler);
      ...
      private function createController(param1:CommonStatsVO) : void
      {
         switch(param1.bonusType)
         {
            ...
            case ArenaBonusTypes.EPIC_BATTLE:
               ...
               break;
            case ArenaBonusTypes.RTS:
            case ArenaBonusTypes.RTS_1x1:
            case ArenaBonusTypes.RTS_BOOTCAMP:
               this._controller = new RTSTeamStatsController(this);
               break;
            default:
               if(this._enableScrollbars)
               {
      ...
      {
         var _loc3_:SortableHeaderButtonBar = null;
         var _loc4_:Boolean = false;
         var _loc2_:Object = param1.target;
         if(_loc2_ is InteractiveSortingButton)
         {
            _loc3_ = SortableHeaderButtonBar(param1.currentTarget);
            _loc4_ = _loc3_ == this.header1;
            this._controller.onHeaderClick(InteractiveSortingButton(_loc2_),_loc3_,_loc4_);
         }
      }
      
      private function onEnemyTitleClickHandler(param1:MouseEvent) : void
      {
         var _loc4_:TeamMemberItemVO = null;
         var _loc5_:Object = null;
         var _loc2_:Number = this._data.common.bonusType;
         var _loc3_:Boolean = _loc2_ == ArenaBonusTypes.RTS || _loc2_ == ArenaBonusTypes.RTS_1x1;
         if(App.utils.commons.isRightButton(param1) && _loc3_)
         {
            _loc4_ = this._data.enemyCommander;
            if(_loc4_)
            {
               _loc5_ = {
                  "dbID":_loc4_.playerId,
                  "userName":_loc4_.userVO.userName,
                  "himself":_loc4_.isSelf,
                  "clanAbbrev":_loc4_.userVO.clanAbbrev,
                  "vehicleCD":_loc4_.vehicleCD,
                  "isAlly":_loc4_.isAlly,
                  "wasInBattle":this._data.common.wasInBattle,
                  "clientArenaIdx":this._data.common.clientArenaIdx,
                  "arenaType":this._data.common.arenaType,
                  "showClanProfile":true
               };
               App.contextMenuMgr.show(CONTEXT_MENU_HANDLER_TYPE.BATTLE_RESULTS_USER,this,_loc5_);
            }
            else
            {
               DebugUtils.LOG_ERROR("The enemy commander\'s data has not been provided in the RTS mode!");
            }
         }
      }
   }

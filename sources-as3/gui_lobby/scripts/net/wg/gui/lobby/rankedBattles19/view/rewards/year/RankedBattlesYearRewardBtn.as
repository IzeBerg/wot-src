package net.wg.gui.lobby.rankedBattles19.view.rewards.year
{
   ...
   public class RankedBattlesYearRewardBtn extends SoundButtonEx
   {
      ...
      private function updateData() : void
      {
         ...
         selected = _loc1_ == RANKEDBATTLES_CONSTS.YEAR_REWARD_STATUS_CURRENT || _loc1_ == RANKEDBATTLES_CONSTS.YEAR_REWARD_STATUS_CURRENT_FINAL;
         if(!selected)
         {
         ...
         _loc2_ = _loc1_ != RANKEDBATTLES_CONSTS.YEAR_REWARD_STATUS_CURRENT_FINAL;

package net.wg.gui.lobby.hangar.seniorityAwards
{
   ...
   public class SeniorityAwardsEntryPointHangar extends SeniorityAwardsEntryPoint implements IEventEntryPoint
   {
      ...
      {
         return EntryPointSize.isSmall(this._size) || EntryPointSize.isExtraSmall(this._size) ? SMALL_MARGINS : BIG_MARGINS;
      }
      ...
      public function set size(param1:int) : void
      {
         ...
         this._size = param1;
         if(EntryPointSize.isSmall(this._size) || EntryPointSize.isExtraSmall(this._size))
         {

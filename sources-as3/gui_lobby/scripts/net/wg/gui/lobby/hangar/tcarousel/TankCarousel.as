package net.wg.gui.lobby.hangar.tcarousel
{
   ...
   public class TankCarousel extends TankCarouselMeta implements ITankCarousel
   {
      ...
      {
         var _loc3_:Number = param2 + OUTSIDE_ARROW_OFFSET;
         ...
         var _loc5_:int = param1 - _loc3_ - OUTSIDE_ARROW_OFFSET - this._rightMargin;
         var _loc6_:int = _loc5_ + leftArrowOffset - rightArrowOffset;
         super.updateLayout(_loc5_,(_loc5_ - _loc6_ >> 1) + _loc3_);
         leftArrow.x = !!this.vehicleFilters.visible ? Number(param2 + _loc4_ + OUTSIDE_ARROW_OFFSET) : Number(OUTSIDE_ARROW_OFFSET);

package net.wg.gui.lobby.hangar.ammunitionPanel
{
   ...
   public class AmmunitionPanel extends AmmunitionPanelMeta implements IAmmunitionPanel
   {
      ...
      override protected function onBeforeDispose() : void
      {
         ...
         removeEventListener(AmmunitionPanelEvents.NY_BONUS_PANEL_CLICKED,this.onAmmunitionPanelNyBonusPanelCLickedHandler);
      ...
      override protected function configUI() : void
      {
         ...
         addEventListener(AmmunitionPanelEvents.NY_BONUS_PANEL_CLICKED,this.onAmmunitionPanelNyBonusPanelCLickedHandler);
      ...
      private function onAmmunitionPanelNyBonusPanelCLickedHandler(param1:AmmunitionPanelEvents) : void
      {

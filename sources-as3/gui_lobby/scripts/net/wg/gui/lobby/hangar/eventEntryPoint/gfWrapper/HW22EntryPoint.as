package net.wg.gui.lobby.hangar.eventEntryPoint.gfWrapper
{
   ...
   import net.wg.infrastructure.base.meta.impl.HW22EntryPointMeta;
   
   public class HW22EntryPoint extends HW22EntryPointMeta implements IHW22EntryPointMeta
   {
      ...
      private static const TOP_AREA:int = 64;
      ...
      private static const HEIGHT_SMALL:int = 112 + TOP_AREA + MARGIN;
      
      private static const HEIGHT_MEDIUM:int = 112 + TOP_AREA + MARGIN;
      
      private static const HEIGHT_BIG:int = 150 + TOP_AREA + MARGIN;
      ...
      public function HW22EntryPoint()
      {
         super();
      }

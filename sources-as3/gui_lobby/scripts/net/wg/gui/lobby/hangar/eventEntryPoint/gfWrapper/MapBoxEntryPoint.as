package net.wg.gui.lobby.hangar.eventEntryPoint.gfWrapper
{
   ...
   import net.wg.infrastructure.base.meta.impl.MapBoxEntryPointMeta;
   
   public class MapBoxEntryPoint extends MapBoxEntryPointMeta implements IMapBoxEntryPointMeta
   {

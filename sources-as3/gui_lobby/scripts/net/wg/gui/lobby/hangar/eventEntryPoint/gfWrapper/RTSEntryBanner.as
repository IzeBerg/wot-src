package net.wg.gui.lobby.hangar.eventEntryPoint.gfWrapper
{
   ...
   import net.wg.infrastructure.base.meta.impl.RTSEntryBannerMeta;
   
   public class RTSEntryBanner extends RTSEntryBannerMeta implements IRTSEntryBannerMeta
   {
      ...
      public function RTSEntryBanner()
      {
         super();
      }

...
{
   import net.wg.infrastructure.base.meta.ICarouselBannerInjectMeta;
   import net.wg.infrastructure.base.meta.impl.CarouselBannerInjectMeta;
   
   public class CarouselBannerInject extends CarouselBannerInjectMeta implements ICarouselBannerInjectMeta
   {
      ...
      public function CarouselBannerInject(param1:String)
      {
         super();
         this._alias = param1;
         setManageSize(true);

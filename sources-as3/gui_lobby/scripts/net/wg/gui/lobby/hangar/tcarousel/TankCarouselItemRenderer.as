package net.wg.gui.lobby.hangar.tcarousel
{
   ...
   public class TankCarouselItemRenderer extends SoundButtonEx implements IScrollerItemRenderer
   {
      ...
      private static const RTS_INFO:String = "rtsInfo";
      ...
      private static const LINKAGE_CAROUSEL_RTS_INFO:String = "CarouselRTSInfoUI";
      ...
      private var _rtsInfo:CarouselRTSInfo = null;
      ...
      protected function updateData() : void
      {
         ...
         this.updateRTSInfo(!!_loc1_ ? Number(this._dataVO.rtsRosterIndex) : Number(0));
      ...
      private function clearRTSInfo() : void
      {
         if(this._rtsInfo)
         {
            this._rtsInfo.dispose();
            removeChild(this._rtsInfo);
            this._rtsInfo = null;
         }
      }
      ...
      private function updateRTSInfo(param1:Number) : void
      {
         if(param1 > 0)
         {
            if(!this._rtsInfo)
            {
               this._rtsInfo = App.utils.classFactory.getComponent(LINKAGE_CAROUSEL_RTS_INFO,CarouselRTSInfo);
               this._rtsInfo.name = RTS_INFO;
               addChild(this._rtsInfo);
            }
            this._rtsInfo.setData(param1);
         }
         else
         {
            this.clearRTSInfo();

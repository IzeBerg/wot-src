package net.wg.gui.lobby.techtree.sub
{
   ...
   public class NationTree extends UIComponentEx implements INodesContainer, IDraggable, ITutorialCustomComponent
   {
      ...
      private static const SCROLLBAR_BOTTOM_OFFSET:int = 2;
      ...
      private var _hPositionByNation:Object;
      
      private var _vPositionByNation:Object;
      ...
      private var _tutorialMgr:ITutorialManager;
      ...
      public function closePremiumPanel(param1:Boolean = false) : void
      {
         if(param1 || this.premiumPanel.isOpened && this.premiumHitArea && this.premiumHitArea.mouseY <= 0 && !this._isDragging)
         {
            ...
            {
               this._soundMgr.playControlsSnd(SoundManagerStates.SND_OUT,SoundTypes.PREMIUM_PANEL,null);
            }
      ...
      public function invalidateNodesData(param1:String, param2:Object) : void
      {
         ...
         var _loc3_:String = this.dataProvider.nation;
         this._hPositionByNation[_loc3_] = this.scrollHPosition;
         this._vPositionByNation[_loc3_] = this.scrollVPosition;
      ...
      public function onEndDrag() : void
      {
         ...
         this.ntGraphics.mouseChildren = this.premiumPanel.mouseChildren = this.premiumPanel.mouseEnabled = this.premiumHitArea.mouseChildren = this.premiumPanelClickArea.mouseChildren = true;
      ...
      public function onStartDrag() : void
      {
         ...
         this.ntGraphics.mouseChildren = this.premiumPanel.mouseChildren = this.premiumPanel.mouseEnabled = this.premiumHitArea.mouseChildren = this.premiumHitArea.mouseEnabled = this.premiumPanelClickArea.mouseChildren = this.premiumPanelClickArea.mouseEnabled = false;
      }
      ...
      public function openPremiumPanel() : void
      {
         if(!this.premiumPanel.isOpened)
         {
            this._soundMgr.playControlsSnd(SoundManagerStates.SND_OVER,SoundTypes.PREMIUM_PANEL,null);
      ...
      public function setNodesStates(param1:Number, param2:Array, param3:String = null) : void
      {
         ...
         while(_loc9_ < _loc4_)
         {
            ...
            {
               _loc7_ = param3 == null ? Boolean(false) : Boolean(this._dataProvider.setItemField(param3,_loc5_,_loc6_[2]));

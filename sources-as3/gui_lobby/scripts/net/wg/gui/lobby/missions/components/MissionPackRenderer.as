package net.wg.gui.lobby.missions.components
{
   ...
   public class MissionPackRenderer extends SoundListItemRenderer implements IReusableListItemRenderer
   {
      ...
      protected var _header:IMissionPackHeader;
      
      protected var _body:IMissionPackBody;
      
      protected var _currentHeaderLinkage:String;
      
      protected var _currentBodyLinkage:String;
      
      protected var _missionPackVO:MissionsPackVO;
      ...
      protected function removeCmp(param1:IUIComponentEx) : void
      {
         if(param1)
         {
      ...
      protected function onHeaderCollapseHandler(param1:MissionHeaderEvent) : void
      {

package
{
   public class PO_FILES
   {
      ...
      public static const TEXT_RTS_BATTLES:String = "../text/rts_battles.po";
      
      public static const TEXT_RTS_TUTORIAL:String = "../text/rts_tutorial.po";

package
{
   public class MENU
   {
      ...
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSSUBMODENOTAVAILABLE_BODY:String = "#menu:headerButtons/fightBtn/tooltip/rtsSubmodeNotAvailable/body";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSSUBMODENOTELIGIBLE_BODY:String = "#menu:headerButtons/fightBtn/tooltip/rtsSubmodeNotEligible/body";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSNOTAVAILABLE_HEADER:String = "#menu:headerButtons/fightBtn/tooltip/rtsNotAvailable/header";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSNOTAVAILABLE_BODY:String = "#menu:headerButtons/fightBtn/tooltip/rtsNotAvailable/body";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSNOBATTLES_HEADER:String = "#menu:headerButtons/fightBtn/tooltip/rtsNoBattles/header";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSNOBATTLES_BODY:String = "#menu:headerButtons/fightBtn/tooltip/rtsNoBattles/body";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSNOTSET_HEADER:String = "#menu:headerButtons/fightBtn/tooltip/rtsNotSet/header";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSNOTSET_BODY:String = "#menu:headerButtons/fightBtn/tooltip/rtsNotSet/body";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSNOCURRENCY1X7_BODY:String = "#menu:headerButtons/fightBtn/tooltip/rtsNoCurrency1x7/body";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSNOCURRENCY1X1_BODY:String = "#menu:headerButtons/fightBtn/tooltip/rtsNoCurrency1x1/body";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_AIROSTERNOTSET_BODY:String = "#menu:headerButtons/fightBtn/tooltip/aiRosterNotSet/body";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSVEHICLENOTREADY_BODY:String = "#menu:headerButtons/fightBtn/tooltip/rtsVehicleNotReady/body";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSUNSUITABLEVEHICLELEVEL_BODY:String = "#menu:headerButtons/fightBtn/tooltip/rtsUnsuitableVehicleLevel/body";
      
      public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_RTSNOVEHICLEWITHLEVEL_BODY:String = "#menu:headerButtons/fightBtn/tooltip/rtsNoVehicleWithLevel/body";
      ...
      public static const BONUSTYPE_39:String = "#menu:bonusType/39";
      
      public static const BONUSTYPE_40:String = "#menu:bonusType/40";
      
      public static const BONUSTYPE_41:String = "#menu:bonusType/41";
      ...
      public static const CONTEXTMENU_WOTPLUSRENT:String = "#menu:contextMenu/wotPlusRent";
      ...
      public static const TANK_PARAMS_SUPPLY_AVGDAMAGE:String = "#menu:tank_params/supply_avgDamage";
      
      public static const TANK_PARAMS_SUPPLY_BARRICADESDAMAGE:String = "#menu:tank_params/supply_barricadesDamage";
      
      public static const TANK_PARAMS_SUPPLY_FLAMETHROWERDAMAGE:String = "#menu:tank_params/supply_flamethrowerDamage";
      
      public static const TANK_PARAMS_SUPPLY_AVGPIERCINGPOWER:String = "#menu:tank_params/supply_avgPiercingPower";
      
      public static const TANK_PARAMS_SUPPLY_RELOADTIMESECS:String = "#menu:tank_params/supply_reloadTimeSecs";
      
      public static const TANK_PARAMS_SUPPLY_PILLBOXCLIPFIRERATE:String = "#menu:tank_params/supply_pillboxClipFireRate";
      
      public static const TANK_PARAMS_SUPPLY_BUNKERCLIPFIRERATE:String = "#menu:tank_params/supply_bunkerClipFireRate";
      
      public static const TANK_PARAMS_SUPPLY_MORTARCLIPFIRERATE:String = "#menu:tank_params/supply_mortarClipFireRate";
      
      public static const TANK_PARAMS_SUPPLY_FLAMETHROWERCLIPFIRERATE:String = "#menu:tank_params/supply_flamethrowerClipFireRate";
      
      public static const TANK_PARAMS_SUPPLY_MAXHEALTH:String = "#menu:tank_params/supply_maxHealth";
      
      public static const TANK_PARAMS_SUPPLY_ARMOR:String = "#menu:tank_params/supply_armor";
      
      public static const TANK_PARAMS_SUPPLY_TURRETARMOR:String = "#menu:tank_params/supply_turretArmor";
      
      public static const TANK_PARAMS_SUPPLY_AIMINGTIME:String = "#menu:tank_params/supply_aimingTime";
      
      public static const TANK_PARAMS_SUPPLY_CIRCULARVISIONRADIUS:String = "#menu:tank_params/supply_circularVisionRadius";
      
      public static const TANK_PARAMS_SUPPLY_SHOTDISPERSIONANGLE:String = "#menu:tank_params/supply_shotDispersionAngle";
      
      public static const TANK_PARAMS_SUPPLY_STUNDURATION:String = "#menu:tank_params/supply_stunDuration";
      
      public static const CONTEXTMENU_ENUM:Array = [CONTEXTMENU_EXCHANGE,CONTEXTMENU_VEHICLEINFO,CONTEXTMENU_VEHICLEINFOEX,CONTEXTMENU_GOTONATIONTREE,CONTEXTMENU_GOTONEXTVEHICLE,CONTEXTMENU_VEHICLESELL,CONTEXTMENU_NATIONCHANGE,CONTEXTMENU_GOTOCOLLECTION,CONTEXTMENU_VEHICLERESEARCH,CONTEXTMENU_VEHICLECHECK,CONTEXTMENU_VEHICLEUNCHECK,CONTEXTMENU_VEHICLEBUY,CONTEXTMENU_VEHICLERESTORE,CONTEXTMENU_VEHICLEREMOVE,CONTEXTMENU_USERINFO,CONTEXTMENU_CLANINFO,CONTEXTMENU_SENDCLANINVITE,CONTEXTMENU_MONEYTRANSFER,CONTEXTMENU_CREATEPRIVATECHANNEL,CONTEXTMENU_ADDTOFRIENDS,CONTEXTMENU_ADDTOFRIENDSAGAIN,CONTEXTMENU_REJECTFRIENDSHIP,CONTEXTMENU_REMOVEFROMFRIENDS,CONTEXTMENU_ADDTOIGNORED,CONTEXTMENU_REMOVEFROMIGNORED,CONTEXTMENU_ENABLECOMMUNICATIONS,CONTEXTMENU_DISABLECOMMUNICATIONS,CONTEXTMENU_COPYTOCLIPBOARD,CONTEXTMENU_SETMUTED,CONTEXTMENU_UNSETMUTED,CONTEXTMENU_MODULEINFO,CONTEXTMENU_SELL,CONTEXTMENU_SELLFROMINVENTORY,CONTEXTMENU_SELECTVEHICLEINHANGAR,CONTEXTMENU_SHOWVEHICLESTATISTICS,CONTEXTMENU_SHOWVEHICLEPREVIEW,CONTEXTMENU_VEHICLEPREVIEW,CONTEXTMENU_BUY,CONTEXTMENU_BUYORTRADEIN,CONTEXTMENU_RESTORE,CONTEXTMENU_UNLOAD,CONTEXTMENU_CANCELBUY,CONTEXTMENU_UNEQUIP,CONTEXTMENU_BUYANDEQUIP,CONTEXTMENU_EQUIP,CONTEXTMENU_UNLOCK,CONTEXTMENU_KICKPLAYERFROMPREBATTLE,CONTEXTMENU_KICKPLAYERFROMUNIT,CONTEXTMENU_GIVELEADERSHIP,CONTEXTMENU_TAKEEQUIPMENTCOMMANDER,CONTEXTMENU_GIVEEQUIPMENTCOMMANDER,CONTEXTMENU_TAKELEADERSHIP,CONTEXTMENU_CREATESQUAD,CONTEXTMENU_CREATEEVENTSQUAD,CONTEXTMENU_CREATEBATTLEROYALESQUAD,CONTEXTMENU_CREATEMAPBOXSQUAD,CONTEXTMENU_INVITE,CONTEXTMENU_APPEAL,CONTEXTMENU_INCORRECTBEHAVIOR,CONTEXTMENU_NOTFAIRPLAY,CONTEXTMENU_FORBIDDENNICK,CONTEXTMENU_BOT,CONTEXTMENU_ASSIGNPRIVATE,CONTEXTMENU_ASSIGNOFFICER,CONTEXTMENU_PERSONALCASE,CONTEXTMENU_PERSONALCASE_STATSBLOCKTITLE,CONTEXTMENU_PERSONALCASE_STATS_FIRSTINFO,CONTEXTMENU_PERSONALCASE_STATS_SECONDINFO,CONTEXTMENU_PERSONALCASE_STATS_WOTPLUS,CONTEXTMENU_TANKMANUNLOAD,CONTEXTMENU_TANKMANUNLOADALL,CONTEXTMENU_DISMISS,CONTEXTMENU_LOCKSLOT,CONTEXTMENU_UNLOCKSLOT,CONTEXTMENU_MESSENGER_MINIMIZEALL,CONTEXTMENU_MESSENGER_CLOSECURRENT,CONTEXTMENU_MESSENGER_CLOSEALLEXCEPTCURRENT,CONTEXTMENU_CREATECONTACTNOTE,CONTEXTMENU_EDITCONTACTNOTE,CONTEXTMENU_REMOVECONTACTNOTE,CONTEXTMENU_BOTNOACTIONS,CONTEXTMENU_VEHICLEPOSTPROGRESSION,CONTEXTMENU_COMPARE,CONTEXTMENU_USERVEHICLECOMPARE,CONTEXTMENU_PROFILEVEHICLECOMPARE,CONTEXTMENU_INSQUAD,CONTEXTMENU_LEAVESQUAD,CONTEXTMENU_EXCLUDEDFROMSQUAD,CONTEXTMENU_SENDINVITATIONTOSQUAD,CONTEXTMENU_WITHDRAWINVITATIONTOSQUAD,CONTEXTMENU_ACCEPTINVITATIONTOSQUAD,CONTEXTMENU_REJECTINVITATIONTOSQUAD,CONTEXTMENU_GOTOBLUEPRINT,CONTEXTMENU_VIEWCLANPROFILE,CONTEXTMENU_COPYCLANNAME,CONTEXTMENU_WOTPLUSRENT];

package
{
   public class MENU
   {
      ...
      public static const CONTEXTMENU_WINBACKCALLSENDINVITE:String = "#menu:contextMenu/winBackCallSendInvite";
